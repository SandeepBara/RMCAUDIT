...
class model_level_pending_dtl extends Model
{
    ...
    public function insrtFinalEo_new($input){
		//print_r($input);
        $sql = "UPDATE ".$this->table." SET status = 0 , verification_status =1 WHERE status = 1 AND verification_status =0 AND saf_dtl_id = ".$input["saf_dtl_id"];
	...
	*/
    ...
    public function getAllLevelDtl2($saf_dtl_id)
    {
        ...
        JOIN view_user_type_mstr ON view_user_type_mstr.id = tbl_level_pending_dtl.sender_user_type_id
        LEFT JOIN view_emp_details ON view_emp_details.id=tbl_level_pending_dtl.sender_emp_details_id
        ORDER BY forward_date ASC, tbl_level_pending_dtl.created_on ASC, tbl_level_pending_dtl.id ASC";
        return $this->db->query($sql)->getResultArray();
    }
    ...
    public function levelwisecount($whereDateRange,$to_date){
        ...
        $dealingsql="SELECT COUNT(DISTINCT saf_dtl_id) AS pending_levelform FROM tbl_bugfix_level_pending_dtl
                     ...
                     AND tbl_saf_dtl.payment_status=1 AND tbl_bugfix_level_pending_dtl.receiver_user_type_id=6 
                   $whereDateRange";
        ...
        $dealingdonesql="SELECT COUNT(DISTINCT saf_dtl_id) AS done_levelform FROM tbl_bugfix_level_pending_dtl
                     JOIN view_user_type_mstr ON view_user_type_mstr.id=tbl_bugfix_level_pending_dtl.sender_user_type_id
                     JOIN tbl_saf_dtl ON tbl_saf_dtl.id=tbl_bugfix_level_pending_dtl.saf_dtl_id WHERE tbl_bugfix_level_pending_dtl.status IN (0,1) 
                     AND tbl_bugfix_level_pending_dtl.receiver_user_type_id NOT IN (11) AND tbl_bugfix_level_pending_dtl.verification_status IN (0,1) 
                     AND view_user_type_mstr.status=1 AND tbl_saf_dtl.payment_status=1 AND tbl_saf_dtl.status=1
                     AND sender_user_type_id=6 $whereDateRange";
...
$whereDateRange GROUP BY saf_dtl_id) as sidone";
    ...
    public function employeedetails($ward_mstr_id,$user_type_id,$ward_no){
        ...
        $u1="DEEPAK RAJAK";$u2="SHILPI SAHAY";$u3="GAUTAM KUMAR";$u4="NITESH KUMAR";$u5="PRASHANT KUMAR JAISWAL";
        $ulbdaward=['1'=>$u1,'2'=>$u1,'3'=>$u1,'4'=>$u1,'5'=>$u1,
        '6'=>$u2,'7'=>$u2,'8'=>$u2,'9'=>$u2,'10'=>$u2,'11'=>$u2,'12'=>$u2,'13'=>$u2,'14'=>$u2,'15'=>$u2,'16'=>$u2,'17'=>$u2,'18'=>$u2,'19'=>$u2,'20'=>$u2,
        '21'=>$u3,'22'=>$u3,'23'=>$u3,'24'=>$u3,'25'=>$u3,'26'=>$u3,'27'=>$u3,'28'=>$u3,'29'=>$u3,'30'=>$u3,
            '39'=>$u3,'41'=>$u3,'42'=>$u3,'43'=>$u3,'44'=>$u3,'45'=>$u3,'40'=>$u3,
        '31'=>$u4,'32'=>$u4,'33'=>$u4,'34'=>$u4,'35'=>$u4,'36'=>$u4,'37'=>$u4,'38'=>$u4,
            '48'=>$u4,'49'=>$u4,
        '46'=>$u5,'52'=>$u5,'47'=>$u5,'53'=>$u5,'54'=>$u5,'50'=>$u5,'51'=>$u5,'55'=>$u5
        ];
        if($user_type_id=="6"){
            if(isset($ulbdaward[$ward_no])){
                $data['emp_name']=$ulbdaward[$ward_no];
                return $data;
            }
            return $data;
        }
        if($user_type_id=="10"){
                $data['emp_name']="ANWAR HUSSIAN";
                return $data;
        }
        $ulbtc1="BHIM MAHLI";$ulbtc2="DEEPAK RAJAK";$ulbtc3="DHARAMRAJ KUMAR";
        $ulbtc4="DILIP SHARMA";$ulbtc5="GAUTAM KUMAR";$ulbtc6="LOKNATH TIRKEY";
        $ulbtc7="MARGUB ALAM";$ulbtc8="NAKUL TIRKEY";$ulbtc9="PAWAN KACHHAP";
        $ulbtc10="RAKESH MUNDA";$ulbtc11="SUBHASH KHALKHO";$ulbtc12="UDAY KUMAR THAKUR";

        $ulb_tc_ward=['7'=>$ulbtc1,'11'=>$ulbtc1,'12'=>$ulbtc1,'13'=>$ulbtc1,
            '14'=>$ulbtc1,'12A'=>$ulbtc1,
        '1'=>$ulbtc2,'2'=>$ulbtc2,'3'=>$ulbtc2,'4'=>$ulbtc2,'5'=>$ulbtc2,
        '32'=>$ulbtc3,'33'=>$ulbtc3,'34'=>$ulbtc3,
        '19'=>$ulbtc4,'20'=>$ulbtc4,'21'=>$ulbtc4,'22'=>$ulbtc4,'23'=>$ulbtc4,
        '15'=>$ulbtc5,'16'=>$ulbtc5,'17'=>$ulbtc5,'18'=>$ulbtc5,'28'=>$ulbtc5,
        '41'=>$ulbtc6,'42'=>$ulbtc6,'46'=>$ulbtc6,'54'=>$ulbtc6,'55'=>$ulbtc6,
        '6'=>$ulbtc7,'8'=>$ulbtc7,'9'=>$ulbtc7,'10'=>$ulbtc7,
        '43'=>$ulbtc8,'44'=>$ulbtc8,'48'=>$ulbtc8,'49'=>$ulbtc8,
        '25'=>$ulbtc9,'26'=>$ulbtc9,'27'=>$ulbtc9,'38'=>$ulbtc9,'24'=>$ulbtc9,
        '45'=>$ulbtc10,'47'=>$ulbtc10,'50'=>$ulbtc10,'51'=>$ulbtc10,'52'=>$ulbtc10,
            '53'=>$ulbtc10,
        '30'=>$ulbtc11,'31'=>$ulbtc11,'35'=>$ulbtc11,'36'=>$ulbtc11,
        '29'=>$ulbtc12,'37'=>$ulbtc12,'39'=>$ulbtc12,'40'=>$ulbtc12
        ];
        if($user_type_id=="7"){
            if(isset($ulb_tc_ward[$ward_no])){
                $data['emp_name']=$ulb_tc_ward[$ward_no];
                return $data;
            }
            return $data;
        }

        $sql="select array_to_string(array_agg(emp_name),',') as emp_name from (
select view_emp_details.emp_name from view_ward_permission 
...
and user_mstr_lock_status=0 and view_emp_details.id NOT IN (1016, 44, 985, 294) AND 
view_emp_details.user_mstr_status = 1) view_emp_details";
