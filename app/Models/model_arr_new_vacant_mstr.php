...
class model_arr_new_vacant_mstr extends Model 
{
    protected $table = 'tbl_arr_new_vacant_mstr';
    ...
    public function getNewMRRCalRate($input){
        try{
    ...
    public function getJoinVacantLandRateByRoadType(){
        try{
            return $this->db->table("tbl_arr_new_vacant_mstr")
                        ->select('tbl_road_type_mstr.road_type, 
                            tbl_arr_new_vacant_mstr.rate AS rate'  
                        )
                        ->join('tbl_road_type_mstr', 'tbl_road_type_mstr.id=tbl_arr_new_vacant_mstr.road_type_mstr_id')
                        ->where('tbl_arr_new_vacant_mstr.status', 1)
