...
class model_view_water_transaction extends Model 
{
    protected $db;
    ...
    public function waterTransactionDetails($data)
    {
    ...
    public function waterTransactionDetailsbyEmpId($data)
    {
    ...
    public function waterTransactionDetailsbyEmpIdTransDate($cash_verify_id)
    {
    ...
    public function waterNotVerified($cash_verify_id)
    {
    ...
    public function waterTotalAmount($data)
    {   
    ...
    public function waterTotalAmountbyEmpId($data)
    {   
