...
class CashVerificationWaterModel extends Model
{
    ...
    public function getVerifiedAmountWater($user_id)
    {
    ...
    public function getCollectedAmountWater($user_id)
    {
    ...
    public function getAllVerifiedWater($user_id)
    {
