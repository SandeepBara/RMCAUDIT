					        ...
					        <div class="panel">
                                ...
                                <div class="panel-body">
                                    ...
                                    ?>
                                            <tr>
                                                <td><?=++$i;?></td>
                                                <td><?=$value["ulb_name"];?></td>
                                                <td>
                                                    <a class="btn btn-primary" href="<?php echo base_url('public/ulb/create/'.$value['_id']);?>" role="button">Edit</a>
                                                        &nbsp;&nbsp;
   ...
   function deletefun(ID)
{
    ...
    if(result)
     window.location.replace("<?=base_url();?>/public/ulb/delete/"+ID);
}
