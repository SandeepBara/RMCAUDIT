			...
			<div id="page-content">
									...
									<div class="panel">
										<div class="panel-body text-center">
											<a href="<?php echo base_url('safDemandPayment/saf_due_details/'.$id);?>" type="button" class="btn btn-primary btn-labeled">View Demand Details</a>
											<a href="<?php echo base_url('safDemandPayment/saf_property_details/'.$id);?>" type="button" class="btn btn-warning btn-labeled">View Property Details</a>
