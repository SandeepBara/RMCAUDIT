...
<!--CONTENT CONTAINER-->
            ...
            <div id="content-container">
                <div id="page-head">
                    ...
                    <li class="active">New Connection Deactivation List</li>
                    </ol>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End breadcrumb-->
                </div>
                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-bordered panel-dark">
                                <div class="panel-heading">
                                    <h5 class="panel-title">New Connection Deactivation List</h5>
                                </div>
                                <div class="panel-body">
                                    <div class ="row">
                                        <div class="col-md-12">
                                            <form class="form-horizontal" method="post" action="<?=base_url('');?>/WaterNewConnectionDeactivationReport/detail">
                                    ...
                                    <div class="table-responsive">
                                     <table id="demo_dt_basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                    <?php
                                    if(!isset($newConnectionDeactivationList)):
                                    ?>
                                        <tr>
                                    ...
                                    <?php else:
                                            $i=0;
                                        foreach ($newConnectionDeactivationList as $value):
                                    ?>
                                        <tr>
                                            <td><?=++$i;?></td>
                                            ...
                                            <td><a href="<?=base_url();?>/writable/uploads/<?=$folder?>/water_new_apply_connection_deactivation/<?=$value['doc_path'];?>" target="_blank" ><img id="imageresource" src="<?=base_url();?>/public/assets/img/pdf_logo.png" style="width: 40px; height: 40px;"></a></td>
                                        </tr>
                                        <?php endforeach;?>
                                    <?php endif;  ?>
                                        </tbody>
