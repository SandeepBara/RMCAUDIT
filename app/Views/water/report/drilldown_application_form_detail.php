...
<li class="active">Application Level Status List</li>
</ol>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<!--End breadcrumb-->
</div>
		...
		<div id="page-content">
			...
			<div class="panel panel-bordered panel-dark">
				<div class="panel-heading">
                    ...
                    <div class="col-sm-6">
                        <h3 class="panel-title"> Application Level Status Lists</h3>
                    </div>
                     <div class="col-sm-6" style="text-align: right; ">
                        <a href="<?php echo base_url('WaterApplicationFormStatusDetailReport/index');?>" class="btn btn-info">Back</a>
                    </div>
					...
					<table id="demo_dt_basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
						...
						<tbody>
							...
							<tr>  
								...
								<td><a href="<?php echo base_url().'/WaterApplyNewConnection/water_connection_view/'.(in_array($result_for,[md5(1),md5(2),md5(3)])?md5($val['id']):md5($val['apply_connection_id'])); ?>" class="btn btn-info">View</a></td>
								</td>     
							</tr>
							<?php
								$i++;
