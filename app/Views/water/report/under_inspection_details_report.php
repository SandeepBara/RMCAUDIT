...
<li class="active">Under Site Inspection</li>
</ol>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<!--End breadcrumb-->
</div>
...
<!--===================================================-->
		<div id="page-content">
			...
			<div class="panel panel-bordered panel-dark">
				<div class="panel-heading">
					<h5 class="panel-title">Under Site Inspection List</h5>
				</div>
				<div class="table-responsive">
					<table id="demo_dt_basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
						...
						<tbody>
							<?php
							if($under_inspection_list)
							{
							  $i=1;
							  foreach($under_inspection_list as $val)
							  {
							?>
							<tr>  
								<td><?php echo $i; ?></td>
								...
								<td><?php echo date('d-m-Y',strtotime($val['level_date']));?></td>
								<td><a href="<?php echo base_url().'/WaterApplyNewConnection/water_connection_view/'.md5($val['id']); ?>" class="btn btn-info">View</a></td>
								</td>     
							</tr>
							<?php
								$i++;
