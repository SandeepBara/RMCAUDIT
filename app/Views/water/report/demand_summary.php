...
<!--CONTENT CONTAINER-->
            ...
            <div id="content-container">
                <div id="page-head">
                    ...
                    <li class="active"> Demand Summary </li>
                    </ol>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End breadcrumb-->
                </div>
                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-bordered panel-dark">
                                <div class="panel-heading">
                                    <h5 class="panel-title">Demand Summary</h5>
                                </div>
                                <div class="panel-body">
                                    <div class ="row">
                                        <div class="col-md-12">
                                            <form class="form-horizontal" method="post" action="<?=base_url('water_report/demand_summary')?>">
                                                <div class="form-group">
													...
													<!-- <div class="col-md-4">
														<label class="control-label" for="team_leader"><b>Team Leader</b><span class="text-danger">*</span> </label>
                            ...
                            <div class="panel panel-bordered panel-dark">
                                <div class="panel-heading">
                                    <h5 class="panel-title text-center">
                                        Total No. Of Demand. <i class="text-success">[<?=isset($total_demand)?$total_demand:0;?>]</i> &#160;&#160;&#160;&#160;&#160;&#160; 
                                        Total Metered Demand <i class="text-success">[<?=(isset($total_meter_demand)?$total_meter_demand:0);?>]</i>&#160;&#160;&#160;&#160;&#160;&#160;
                                        Total Fixed Demand. <i class="text-success">[<?=isset($fixed_demand)?$fixed_demand:0;?>]</i>&#160;&#160;&#160;&#160;&#160;&#160;
                                        Total Employees. <i class="text-success">[<?=isset($total_emp)?$total_emp:0;?>]</i>
                                    </h5>
                                </div>
                                <div class="panel-body">   
                                    <div class="row">
                                        ...
                                        <div class="" >
                                            <table id="demo_dt_basic" class="table table-striped table-bordered table-responsive" cellspacing="0" width="100%">
                                                ...
                                                <?php else:
                                                        $i=$demands['offset'];
                                                        //$i=0;
                                                        foreach ($demands['result'] as $value):
                                                ?>
                                                        <tr>
                                                            <td><?=++$i;?></td>
                                                            
                                                            <td>
                                                                <a onClick="myPopup('<?=base_url('water_report/demandSummaryDtl/'.$value['emp_details_id'].'/'.$from.'/'.$to);?>','xtf','900','700');">
                                                                    <?=$value['emp_name']." (".$value['employee_code'].")";?>
                                                                </a>
                                                            </td>
                                                            <td><?=$value['total_demand'];?></td>
                                                            <td><?=$value['meter_demand'];?></td>
                                                            <td><?=$value['fixed_demand'];?></td>
                                                            <td>
                                                                <a onClick="myPopup('<?=base_url('water_report/demandSummaryDtl/'.$value['emp_details_id'].'/'.$from.'/'.$to);?>','xtf','900','700');" class='btn btn-primary'>
                                                                    view
                                                                </a>
                                                            </td>
                                                ...
                                                <tfoot>
                                                    <tr class='text-center' >                                                    
                                                        <td colspan="2" ><strong><?=isset($total_emp)?$total_emp:0;?></strong>                                                        
                                                        <td><strong><?=isset($total_demand)?$total_demand:0;?></strong></td>
                                                        <td><strong><?=(isset($total_meter_demand)?$total_meter_demand:0);?></strong></td>
                                                        <td><strong><?=isset($fixed_demand)?$fixed_demand:0;?></strong></td>
                                                        
                                                    </tr>
                                                </tfoot>
                                            </table>
                                        </div>
                                        <?=isset($demands['count'])?pagination($demands['count']):null;?>
                                    </div>
                                </div>
                            </div>
                        </div>
