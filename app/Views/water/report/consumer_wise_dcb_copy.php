								...
								<table id="demo_dt_basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
									<thead class="bg-trans-dark text-dark">
										<tr>
											...
											<th>Outstanding at the beginning</th>
   ...
   //debugger;
    $(document).ready(function(){
        ...
        var dataTable = $('#demo_dt_basic').DataTable({
            ...
            buttons: [
                'pageLength',
                {
                    ...
                    action: function ( e, dt, node, config ) {
                        ...
                        // alert('<?=base_url();?>/WaterConsumerWiseDCBReport/WaterConsumerWiseDCBReportExcel2/'+gerUrl);
                        // window.open('<?=base_url();?>/Trade_report/total_notice_applyExcel/'+gerUrl).opener = null;
                        window.open('<?=base_url();?>/WaterConsumerWiseDCBReport/WaterConsumerWiseDCBReportExcel2/'+gerUrl).opener = null;
                    }
                }
            ],
            ...
            'ajax': {
                "type": "POST",
                'url':'<?=base_url('WaterConsumerWiseDCBReport/WaterConsumerWiseDCBReportAjax2');?>',            
