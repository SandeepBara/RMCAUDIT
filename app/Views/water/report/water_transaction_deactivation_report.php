...
<!--CONTENT CONTAINER-->
            ...
            <div id="content-container">
                <div id="page-head">
                    ...
                    <li class="active">Water Transaction Deactivate List</li>
                    </ol>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End breadcrumb-->
                </div>
                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-bordered panel-dark">
                                <div class="panel-heading">
                                    <h5 class="panel-title">Water Transaction Deactivate List</h5>
                                </div>
                                <div class="panel-body">
                                    <div class ="row">
                                        <div class="col-md-12">
                                            <form class="form-horizontal" method="post" action="<?=base_url('');?>/WaterTransactionDeactivationReport/detail">
                                    ...
                                    <div class="table-responsive">
                                     <table id="demo_dt_basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                    <?php
                                    if(!isset($waterTransactionDeactivateList)):
                                    ?>
                                            <tr>
                                    ...
                                    <?php else:
                                            $i=0;
                                            foreach ($waterTransactionDeactivateList as $value):
                                    ?>
                                            <tr>
                                                <td><?=++$i;?></td>
                                                ...
                                                <td><?=$value['paid_amount']!=""?$value['paid_amount']:"N/A";?></td>
                                                ...
                                                <td><?=$value['empDetails']['emp_name']!=""?$value['empDetails']['emp_name']:"N/A";?></td>
                                                <td><a href="<?=base_url();?>/writable/uploads/<?=$value['file_path'];?>" target="_blank" ><img id="imageresource" src="<?=base_url();?>/public/assets/img/pdf_logo.png" style="width: 40px; height: 40px;"></a>
                                                </td>
                                            </tr>
                                        <?php endforeach;?>
                                    <?php endif;  ?>
