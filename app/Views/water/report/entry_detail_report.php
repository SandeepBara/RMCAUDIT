    ...
    <div id="page-content">
        ...
        <div class="panel panel-dark">
            <div class="panel-heading text-center">
                <h5 class="panel-title"><?=$ulb_dtl['ulb_name']?> <span id="footerResult"></span></h5>
            </div>
            <div class="panel-body">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="text-center">
                            <p>Operator Wise Application Entry Report of Water Consumer</p>
...
$(document).ready(function(){
    ...
    var dataTable = $('#empTable').DataTable({
        ...
        buttons: [
            'pageLength',
            {
                ...
                action: function ( e, dt, node, config ) {
                    ...
                    if(entry_type!='')
                    {
                        search_entry_type = entry_type;
                    }                    
                    var gerUrl = search_from_date+'/'+search_upto_date+'/'+search_ward_mstr_id+'/'+search_collector_id+'/'+search_entry_type ;
                    window.open('<?=base_url();?>/water_report/entry_detail_reportExcel/'+gerUrl).opener = null;
                }
            }
        ],
        ...
        'ajax': {
            "type": "POST",
            'url':'<?=base_url('water_report/entry_detail_reportAjax');?>',
