...
<!--===================================================-->
		<div id="page-content">
			...
			<div class="panel panel-bordered panel-dark">
				<div class="panel-heading">
					<h5 class="panel-title">Level Wise Pending Lists</h5>
				</div>
				<div class="table-responsive">
					<table id="demo_dt_basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
						...
						<tbody>
							<?php
							if($level_wise_pending)
							{
							  $i=1;
							  foreach($level_wise_pending as $val)
							  {
							?>
							<tr>  
								<td><?php echo $i; ?></td>
								...
								<!--<td><a onClick="myPopup('<?php echo base_url('WaterLevelWisePendingReport/levelwisePendingLists/'.$val['user_type_mstr_id'].'/'.$val['permitted_ward']);?>','xtf','900','700');" style="font-weight: bold; float:right; margin-top:-5px; margin-right:5px ; cursor: pointer;" class="btn btn-primary">View</a></td>
								-->

								<td><a href="<?php echo base_url('WaterLevelWisePendingReport/levelwisePendingLists/'.$val['user_type_mstr_id'].'/'.$val['permitted_ward']);?>" class="btn btn-primary">View</a></td>
