...
<!--CONTENT CONTAINER-->
            ...
            <div id="content-container">
                <div id="page-head">
                    ...
                    <li class="active"> Team Summary </li>
                    </ol>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End breadcrumb-->
                </div>
                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-bordered panel-dark">
                                ...
                                <div class="panel-body">
                                    <div class ="row">
                                        <div class="col-md-12">
                                            <form class="form-horizontal" method="post" action="<?=base_url('water_report/index')?>">
                            ...
                            <div class="panel panel-bordered panel-dark">
                                <div class="panel-heading">
                                    <h5 class="panel-title text-center">
                                        Total No. Of Tran. <i class="text-success">[<?=isset($total_taransection)?$total_taransection:0;?>]</i> &#160;&#160;&#160;&#160;&#160;&#160; 
                                        Total Amount <i class="text-success">[<?=number_format((isset($total_paid_amount)?$total_paid_amount:0),2);?>]</i>&#160;&#160;&#160;&#160;&#160;&#160;
                                        Total Employee. <i class="text-success">[<?=isset($total_emp)?$total_emp:0;?>]</i>
                                    </h5>
                                </div>
                                <div class="panel-body">    
                                    <div class="row">
                                        ...
                                        <table id="demo_dt_basic" class="table table-striped table-bordered table-responsive" cellspacing="0" width="100%">
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a onClick="myPopup('<?=base_url('water_report/water_collection_dtl/'.md5($value['emp_details_id']).'/'.$from.'/'.$to);?>','xtf','900','700');">
                                                        ...
                                                        <td><?=$value['amount'];?></td>
                                                        <td>
                                                            <a onClick="myPopup('<?=base_url('water_report/water_collection_dtl/'.md5($value['emp_details_id']).'/'.$from.'/'.$to);?>','xtf','900','700');" class='btn btn-primary'>
                                                                view
                                                            </a>
                                                        </td>
