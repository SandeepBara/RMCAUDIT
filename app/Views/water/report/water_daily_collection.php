                        ...
                        <div class="col-sm-12">
                            <div class="panel">
                                ...
                                <div class="panel-body">
                                    <div class ="row">
                                        <div class="col-md-12">
                                            <form class="form-horizontal" method="post" action="<?=base_url('');?>/WaterDailyCollection/report">
                                                ...
                                                <div class="col-md-3">
                                                 ...
                                                 <div class="col-md-3">
                                                    <label class="control-label" for="transaction_type"><b>Transaction Type</b><span class="text-danger">*</span> </label>
                                                    <select id="transaction_type" name="transaction_type" class="form-control">
                                                        <option value="">ALL</option>
                                                        <option value="New Connection" <?=(isset($transaction_type))?($transaction_type=="New Connection")?"selected":"":"";?>>New Connection</option>
                                                        <option value="Demand" <?=(isset($transaction_type))?($transaction_type=="Demand")?"selected":"":"";?>>Demand</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-2">
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td><?=$value['tran_date']!=""?$value['tran_date']:"N/A";?></td>
                                            </tr>
