...
<!--CONTENT CONTAINER-->
		...
		<div id="content-container">
			<div id="page-head">
				...
				<li><a href="<?=base_url('WaterConsumerRequest/ViewDtl/'.$request_dtl["id"])?>">Request Details</a></li>
						...
						<div class="panel">
							...
							<div class="panel panel-dark">
								...
								<div class="panel-heading">
										<div class="col-sm-6">
											<h3 class="panel-title">Water Request Payment Receipt</h3>
										</div>
										<?php 
										if(isset($from) && $from=='citizen')
										{
										...
										<div class="col-sm-6" style="text-align: right;">
											<a href="<?php echo base_url('WaterConsumerRequest/ViewDtl/'.($request_dtl["id"]));?>" class="btn btn-info">Back</a>
										</div>
											<?php
										}
										?>
											...
											<tbody>
												<tr>
													<td height="71" colspan="4" align="center">
														<div style="width: 50%; padding: 8px; height: auto; border: #000000 solid 2px; font-family: Arial, Helvetica, sans-serif; font-size: 18px; font-weight: bold; text-transform:uppercase"><?=$transaction_details["transaction_type"]??"";?> </div>
													</td>
												</tr>
												...
												Account Description : Water User Charge</td>
													<td>
                                                        ...
                                                        <div >Application No : <b><?=!empty($request_dtl["request_no"])?$request_dtl["request_no"]:"N/A";?></b></div>
													</td>
												</tr>
											...
											<tbody>
												<tr>
													<td>Received From Mr / Mrs / Miss . : &nbsp;
														...
														<?php 
														$i=0;
														foreach($applicant_details as $applicant_name) {
															$i++;
															if ($i==1) {
												...
												<tr>
													<td>Mobile No. : &nbsp;
														...
														<?php 
														$j=0;
														foreach($applicant_details as $mobile_no) {
															$j++;
															if ($j==1) {
										...
										<div style="width: 99%; margin: auto; line-height: 35px;"><strong style="font-size: 14px;">WATER USER CHARGE DETAILS </strong>
											...
											<table width="99%" border="1" align="center" cellpadding="0" cellspacing="0" style="font-family: Arial, Helvetica, sans-serif; font-size: 12px; text-align:center;">
												<tbody>
													...
													<tr>
														<td><?=$transaction_details['transaction_type'];?>: Fee &nbsp;</td>														
											...
											<div class="col-sm-12 " style="text-align:center;font-size:xx-small">
