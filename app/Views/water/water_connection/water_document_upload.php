			...
			<div class="panel-heading">
				<div class="col-sm-6">
                 ...
                 <div class="col-sm-6" style="text-align: right; ">
                 	<span class="btn btn-info"><a href="<?php echo base_url('WaterApplyNewConnection/water_connection_view/'.md5($connection_dtls['id']));?>"  style="color: white;">Back</a></span>
						...
						<tbody>
							...
							?>
								...
								?>
									<tr>
										<td>
											<?php if(isset($value['conn_owner_id']["document_path"])) if($value['conn_owner_id']["document_path"]==""){ ?>
												N/A
											<?php } else { ?>
												<a href="<?=base_url();?>/getImageLink.php?path=<?=$value['conn_owner_id']["document_path"];?>" target="_blank"><img id="imageresource" src="<?=base_url();?>/getImageLink.php?path=<?=$value['conn_owner_id']["document_path"];?>" style="width: 40px; height: 40px;"></a>
											<?php } ?>
										</td>
										<td>
											<?php if(isset($value['conn_owner_doc']["document_path"])) if($value['conn_owner_doc']["document_path"]==""){ ?>
												N/A
											<?php } else { ?>
			...
			<div class="table-responsive">
				<table class="table table-striped">
					...
					<tbody>
						...
						<tr>
							<td>
								<strong>Upload Connection Form&nbsp;</strong> (<span style="color: #f00">*</span> Single Image file)
							</td>
						...
						<tr>
							<td>
								<strong>Upload electricity bill &nbsp;</strong> (<span style="color: #f00">*</span> Single Image file)
							</td>
						...
						<tr>
							<td>
								<strong>Last Payment Receipt of Holding Tax&nbsp;</strong> (<span style="color: #f00">*</span> Single Image file only)
							</td>
