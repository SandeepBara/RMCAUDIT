                ...
                <div id="page-content">
					<div class="panel panel-bordered panel-dark">
						<div class="panel-heading">
							<h5 class="panel-title">Water SH Search</h5>
						</div>
						<div class="panel-body">
							<form class="form-horizontal" method="post" action="<?php echo base_url('Water_SH/index');?>">
								<div class="form-group">
									<div class="col-md-3">
										<label class="control-label" for="from_date"><b>From Date</b> </label>
										<div class="input-group date">
											<input type="date" id="from_date" name="from_date" class="form-control mask_date" placeholder="From Date" value="<?=(isset($from_date))?$from_date:date('Y-m-d');?>">
                    ...
                    <div class="panel panel-bordered panel-dark">
						<div class="panel-heading">
							<h5 class="panel-title">Water SH List</h5>
						</div>
						<div class="panel-body">
                			<div class="row">
			                    <div class="col-sm-12">
...
<script type="text/javascript">
	...
	$(document).ready(function() {
        ...
        $("#to_date").change(function ()
        {
            ...
            //if((startDay.getTime())>(endDay.getTime()))
			if((startDay.getTime()>endDay.getTime()) || (endDay.getTime()>Date.now()))
            {
                alert("Please select valid To Date!!");
                $("#to_date").val('');
            }
