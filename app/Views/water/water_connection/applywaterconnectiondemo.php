...
<div id="content-container">
    ...
    <div id="page-content">
		...
		<?php } ?>
		<form id="form" name="form" method="post" class="commentForm">
                ...
                <div class="panel-heading">
					...
					<div class="table-responsive">
						<table class="table table-bordered" style="font-family:Arial, Helvetica, sans-serif; font-size:12px;">
							...
							<tbody id="owner_dtl">
								<tr>
									<td><input type="text" name="owner_name[]"  class="form-control"  onkeypress="return isAlpha(event);"  placeholder="Owner Name"></td>
									<td><input type="text" name="guardian_name[]" id="guardian_name" class="form-control"  onkeypress="return isAlpha(event);"  placeholder="Guardian Name"></td>
									<td><input type="text" name="mobile_no[]" id="mobile_no" class="form-control" maxlength=10 minlength=10 onkeypress="return isNum(event);"  placeholder="Mobile No."></td>
									<td><input type="email" name="email_id[]" id="email_id" class="form-control"  placeholder="Email ID"></td>
									<td>
										<select name="state[]" id="state" class="form-control" onchange="show_district(this.value,1)">
											<option value="">Select</option>
											<?php
											if($state_list):
									...
									<td><input type="text" name="city[]" id="city" class="form-control"  onkeypress="return isAlpha(event);"  placeholder="City"></td>
...
<script type="text/javascript">
  ...
  /* $("#btn_review").click(function(){
       ...
       // alert(owner_name);
/*var len=$('input[name="owner_name[]"]').length;
...
*/
	...
	*/
    ...
    function add_owner()
    {
        ...
        var html="<div class='row' id='del"+count+"'><div class='col-md-12'><table class='table table-responsive'><tr><td><input type='text' name='owner_name[]' class='form-control' placeholder='Owner Name' ></td><td><input type='text' name='guardian_name[]' class='form-control'  placeholder='Guardian Name'></td><td><input type='text' name='mobile_no[]' maxlength='10' minlength='10' class='form-control'  placeholder='Mobile No.'><td><input type='email' name='email_id[]' class='form-control' placeholder='Email ID'></td></td><td><select name='state[]' class='form-control' onchange='show_district(this.value,"+count+")'><option value=''>Select</option><?php if($state_list): foreach($state_list as $val):?><option value='<?php echo $val['name']?>'><?php echo $val['name'];?></option><?php endforeach; endif; ?></select></td><td><select name='district[]' id='district"+count+"' class='form-control'><option value=''>Select</option></select></td><td><input type='text' name='city[]' class='form-control' placeholder='City'></td><td onclick='add_owner()'><i class='form-control fa fa-plus-square'></i></td><td value='"+count+"' onclick='delete_owner("+count+")' class='remove_owner_dtl' ><i class='form-control fa fa-window-close'></i></td></tr></table></div></div>";
