...
<div id="content-container">
    ...
    <div id="page-content">
		...
		<form id="form" name="form" method="post" onsubmit="validate_from();" enctype="multipart/form-data" >
			...
			<div class="panel panel-bordered panel-dark">
                <div class="panel-heading">                    
                    <h3 class="panel-title">Consumer Connection Date</h3>
                </div>
                <div class="panel-body">
                    <div class="row">
                        <label class="col-md-2">Olde Connection Date<span class="text-danger"></span></label>
                        <div class="col-md-3 pad-btm">
                            <?php echo "<strong>".(isset($consumer_details['created_on'])?date('d-m-Y',strtotime($consumer_details['created_on'])):"N/A")."</strong>";?>
                            
                        </div>
                        <label class="col-md-2">New Connection Date<span class="text-danger"></span></label>
