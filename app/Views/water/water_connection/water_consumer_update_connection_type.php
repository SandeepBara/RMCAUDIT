            ...
            <div class="panel">
				<div class="panel-body text-center">
                   ...
                   <input type="hidden" name="consumer_id" id="consumer_id" value="<?php echo $consumer_id; ?>">
                    ...
                    <a href="<?php echo base_url('WaterUserChargeProceedPayment/pay_payment/'.md5($consumer_details['id']));?>" class="btn btn-success">
                    ...
                    <div class="col-md-3">
                        ...
                        <a href="<?php echo base_url('WaterApplyNewConnection/water_connection_view/'.md5($consumer_details['apply_connection_id']));?>" class="btn btn-info">View Application</a>
