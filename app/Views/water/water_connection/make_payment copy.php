...
<div id="content-container">
    ...
    <div id="page-head">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo base_url('WaterViewConsumerDetails/index/'.md5($consumer_dtls['id']));?>" >Water Connection Details</a></li>
    ...
    <div id="page-content">       
        ...
        <div class="panel panel-bordered panel-dark">
            <div class="panel-heading">
                <div class="col-sm-6"><h3 class="panel-title"> Water Connection Details View</h3></div>
                ...
                <form method="post" id="myform">
                    <table class="table table-responsive table-bordered">
                        ...
                        <tr>
                            ...
                            ?>
                            <td>Select Month<?=isset($connection_dtls['connection_type']) && ($connection_dtls['connection_type']==3 || isset($from_month) ) ? " Upto":''?></td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>Advance</td>
                            <td><input type="text" name="advance" id="advance" class="form-control" value="0.00" readonly required /></td>
                        </tr>
                        <tr>
                            <td ><span class="remain_advance_block">Remain Advance( in Rs.)</span></td>
                            <td ><span class="remain_advance_block text-warning" id="remain_advance" style="font-weight: bold; font-size:17px;"></span></td>
...
<script>
    ...
    function show_hide_cheque_details(argument)
    {
        ...
        if(['CHEQUE', 'DD', 'NEFT',"RTGS"].includes(payment_mode))
        {
            $("#chq_dtls1").show();
            $("#chq_dtls2").show();
            $("#chq_dtls3").show();
