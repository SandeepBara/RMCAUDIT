...
<!--CONTENT CONTAINER-->
            ...
            <div id="content-container">
                <div id="page-head">
					...
					<li><a href="#">Back To Citizen</a></li>
                    ...
                    <div class="panel panel-bordered panel-dark">
						<div class="panel-heading">
							<div class="panel-control">
								<a href="<?php echo base_url('water_da/da_back_to_citizen_list') ?>" class="btn btn-default">Back</a>
							</div>
								...
								<tbody>
									...
									else
									{
										...
										<tr>
											...
											<td>
												<a href="<?=base_url();?>/writable/uploads/<?=$imgval["document_path"];?>" target="_blank">
												<img id="imageresource" src="<?=base_url();?>/writable/uploads/<?=$imgval["document_path"];?>" style="width: 40px; height: 40px;">
												</a>
											</td>
											<td><?php
										...
										<tr>
											...
											<td>
												...
												{
												?>
												<a href="<?=base_url();?>/writable/uploads/<?=$docval['document_path'];?>" target="_blank"><img id="imageresource" src="<?=base_url();?>/writable/uploads/<?=$docval['document_path'];?>" style="width: 40px; height: 40px;"></a>
												<?php
												}
												?>
											</td>
