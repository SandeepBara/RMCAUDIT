...
<!--CONTENT CONTAINER-->
            ...
            <div id="content-container">
                <div id="page-head">
					...
					<li class="active">Water Bulk Payment Receipt</li>
                    </ol>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End breadcrumb-->
				...
				<!-- ======= Cta Section ======= -->
							<div class="panel panel-bordered panel-dark">
								<div class="panel-heading page-break">
									<h3 class="panel-title">Water Bulk Payment Receipt	
									</h3>
								</div>
								...
								<?php if(isset($printAllData)): ?>
                                 <?php foreach ($printAllData as $value):$i++;?>
								<div class="panel-body" id="print_watermark">
									...
									<table width="99%" border="0" align="center" style="font-family: Arial, Helvetica, sans-serif; font-size: 14px;">
										...
										<tbody>
											...
											<tr>
												<td colspan="3">Receipt No. : <b><?=$value['transaction_details']["transaction_no"];?></b></td>
												<td >Date : <b><?=date('d-m-Y',strtotime($value['transaction_details']["transaction_date"]));?></b></td>
											</tr>
											<tr>
												<td colspan="3">Department / Section : Water<br>
                                            Account Description : Water User Charge</td>
												<td>
													<div >Ward No : <b><?=$value['applicant_details']["ward_no"];?></b> </div>
													<div >Application No : <b><?=$value['applicant_details']["application_no"];?></div>
												</td>
											</tr>
									...
									<table width="100%" border="0">
										<tbody>
											<tr>
												<td>Received From Mr. / Ms. /Mss. : 
													...
													<span style="font-size: 14px; font-weight: bold">
														<?=$value['applicant_details']["applicant_name"];?>
													</span>
													<?php //endforeach; ?>
												</td>
											</tr>
											<tr>
												<td>Mobile No. : 
													<span style="font-size: 14px; font-weight: bold">
														<?=$value['applicant_details']["mobile_no"];?>
													</span>
												</td>
											</tr>
											<tr>
												<td>Address : 
													<span style="font-size: 14px; font-weight: bold">
														<?=$value['applicant_details']["address"];?>
													</span>
												</td>
											</tr>
											<tr>
												<td>
													...
													<div style="width: 200px; height: 15px; line-height: 20px; float: left; margin-left: 2px; padding-bottom: 3px; font-size: 14px; font-weight: bold;">
														<?=$value['transaction_details']["paid_amount"];?>
													...
													<div style="border-bottom: #333333 dotted 2px; width: 565px; height: 20px; float: left; margin-left: 2px; padding-bottom: 3px; font-size: 14px; font-weight: bold; line-height: 18px;">
														&nbsp;
													 <?php echo ucwords(getIndianCurrency($value['transaction_details']["paid_amount"])); ?>
													&nbsp; Only
													</div>
												</td>
											</tr>
											<?php if($value['transaction_details']["payment_mode"]=="CASH"){ ?>
											<tr>
												<td height="35">
													<div style="float: left;">
														towards :<strong style="font-size: 14px;">Water Tax &amp; Others</strong>&nbsp;&nbsp; vide <b><?=$value['transaction_details']["payment_mode"];?> </b> 
													</div>
											<?php } else { ?>
											<tr>
												<td height="35">
													<?php if($value['transaction_details']["payment_mode"]=="CHEQUE"){ ?>
													<div style="float: left;">
													...
													<div style="border-bottom: #333333 dotted 2px; width: 275px; height: 20px; float: left; margin-left: 2px; padding-bottom: 3px; font-weight: 700;">
														&nbsp;&nbsp; <?=$value['transaction_details']["cheque_no"];?>
													</div>
												</td>
											</tr>
											...
											<tr>
												<td height="35">
													...
													<div style="border-bottom: #333333 dotted 2px; width: 180px; height: 20px; float: left; margin-left: 2px; padding-bottom: 3px; font-weight: 700;">
														&nbsp;&nbsp; <?=$value['transaction_details']["cheque_date"];?>
													</div>
													...
													<div style="border-bottom: #333333 dotted 2px; width: 345px; height: 20px; float: left; margin-left: 2px; padding-bottom: 3px;">
														&nbsp;&nbsp; <?=$value['transaction_details']["bank_name"];?>
													</div>
												</td>
											</tr>
											<tr>
												<td height="35">
													<div style="border-bottom: #333333 dotted 2px; width: 499px; height: 20px; float: left; margin-left: 2px; padding-bottom: 3px; font-weight: 700;">
														&nbsp;&nbsp; <?=$value['transaction_details']["branch_name"];?>
													</div>
										...
										<table width="99%" border="1" align="center" cellpadding="0" cellspacing="0" style="font-family: Arial, Helvetica, sans-serif; font-size: 12px; text-align:center;">
											<tbody>
												...
												<tr>
													...
													<td><?php echo $value['transaction_details']['total_amount'];?></td>
													
												</tr>
												<tr>
													<td>Penalty</td>
													<td><?php echo $value['transaction_details']['penalty'];?></td>
													
												</tr>
												<tr>
													<td>Rebate</td>
													<td><?php echo $value['transaction_details']['rebate'];?></td>
													
												</tr>
												<tr>
													<td>Payable Amount</td>
													<td><?php echo $value['transaction_details']['paid_amount'];?></td>
