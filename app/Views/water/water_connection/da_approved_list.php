...
<!--CONTENT CONTAINER-->
            ...
            <div id="content-container">
                <div id="page-head">
					...
					<li class="active">DA Approved List</li>
                    </ol>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End breadcrumb-->
                </div>
                ...
                <div id="page-content">
					<div class="panel panel-bordered panel-dark">
						<div class="panel-heading">
							<h5 class="panel-title">DA Approved Search</h5>
						</div>
						<div class="panel-body">
							<form class="form-horizontal" method="post" action="<?php echo base_url('water_da/da_approved_list');?>">
					...
					<div class="panel panel-bordered panel-dark">
						<div class="panel-heading">
							<h3 class="panel-title">DA Approved List</h3>
						</div>
							...
							<table id="demo_dt_basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<a class="btn btn-primary" href="<?php echo base_url('water_da/da_approved_view/'.md5($value['id']));?>" role="button">View</a>
										</td>
									</tr>
									<?php endforeach;?>
									<?php endif;  ?>
