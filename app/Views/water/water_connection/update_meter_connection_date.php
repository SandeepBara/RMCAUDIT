        ...
        { 
            ...
            <div id="page-head">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active"><a href="#">Update Meter Connection</a></li>
                </ol>
                <!--End breadcrumb-->
            </div>
            <?php 
		...
		<form id="form" name="form" method="post" onsubmit="validate_from();" enctype="multipart/form-data" >
			...
			<div class="panel panel-bordered panel-dark" >
                <div class="panel-heading">                    
                    <h3 class="panel-title">Update Meter Connection Form
                        <?php
                            if($user_type=="")
                            {
                                ?>
			...
			<div class="panel panel-bordered panel-dark">
                <div class="panel-heading">                    
                    <h3 class="panel-title">Meter Connection Date <?=isset($last_paid_demands) && !empty($last_paid_demands)? "<span class='text-danger'>[ Last Paid Demand Upto ". $last_paid_demands['demand_upto']." ]</span>":""?></h3>
                </div>
                <div class="panel-body">
                    <div class="row">
                        <label class="col-md-2">Old Installation Date<span class="text-danger"></span></label>
                        <div class="col-md-3 pad-btm">
                            <?php echo "<strong>".(isset($connection_dtls['connection_date'])?date('d-m-Y',strtotime($connection_dtls['connection_date'])):"N/A")."</strong>";?>
                            
                        </div>
                        <label class="col-md-2">New Installation Date<span class="text-danger"></span></label>
                        <div class="col-md-2 pad-btm">
                            <input type="date" max = "<?=date('Y-m-d')?>" class="form-control" name = 'new_cunsumer_connection_date' id = "new_cunsumer_connection_date" value="<?=$_POST['new_cunsumer_connection_date']??'';?>">                            
                        </div>
                    </div>
                    <div class="row">
                        <label class="col-md-2">Old Connection Type <span class="text-danger"></span></label>
                        <?php
                            $connection_type = 'N/A';
                            if(isset($connection_dtls['connection_type']))
                            {
                                if($connection_dtls['connection_type']==3)
                                    $connection_type = 'Fixed';
                                elseif($connection_dtls['connection_type']==2)
                                    $connection_type = 'Gallen';
                        ...
                        ?>
                        <div class="col-md-3 pad-btm">
                            <?php echo "<strong>".($connection_type)."</strong>";?>                            
                        </div>
                        <?php
                            if(isset($connection_dtls['connection_type']) && $connection_dtls['connection_type']!=3)
                            {
                                ?>
                                    <label class="col-md-1">Meter No.<span class="text-danger"></span></label>
                                    <div class="col-md-2 pad-btm">
                                        <?php echo "<strong>".($connection_dtls['meter_no'])."</strong>";?>                         
                                    </div>
                                    <label class="col-md-1">Last Reading <span class="text-danger"></span></label>
                                    <div class="col-md-2 pad-btm">
                                        <?php echo "<strong>".($last_reading)."</strong>";?>                        
                                    </div>
                                <?php
                            }
                        ?>
                    ...
                    <div class="row">
                        <label class="col-md-2">New Connection Type <span class="text-danger">*</span></label>                        
                        <div class="col-md-3 pad-btm">
                            <select class="form-control" name="connection_type" id = "connection_type" onchange=" show_hide(this.value)" required >
                        ...
                        <div id="meter">
                            <label class="col-md-1">Meter No.<span class="text-danger"></span></label>
                            <div class="col-md-2 pad-btm">
                                <input type="text" name="meter_no" id="meter_no" class="form-control" value="<?=isset($_POST['meter_no'])?$_POST['meter_no']:''?>" onkeypress="return isAlphaNumCommaSlash(event);" required/>                        
                            </div>
                            <label class="col-md-1">Final Reading <span class="text-danger"></span></label>
                            <div class="col-md-2 pad-btm">
                                <input type="text" name="final_reading" id="final_reading" class="form-control" value="<?=isset($_POST['final_reading'])?$_POST['final_reading']:''?>" onkeypress="return isNumDot(event);"/>                        
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <label class="col-md-1">Remarks<span class="text-danger">*</span></label>
