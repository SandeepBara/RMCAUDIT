			...
			<div class="panel-heading">
				<div class="col-sm-6">
                 ...
                 <div class="col-sm-6" style="text-align: right; ">
                    <a href="<?php echo base_url('WaterApplyNewConnection/water_connection_view/'.md5($connection_dtls['id']));?>" class="btn btn-info">Back</a>
                </div>
						...
						<tbody>
							...
							?>
								...
								?>
									<tr>
										<td>
											<?php if($value['conn_owner_id']["document_path"]==""){ ?>
												N/A
											<?php } else { ?>
												<a href="<?=base_url();?>/writable/uploads/<?=$value['conn_owner_id']["document_path"];?>" target="_blank"><img id="imageresource" src="<?=base_url();?>/writable/uploads/<?=$value['conn_owner_id']["document_path"];?>" style="width: 40px; height: 40px;"></a>
											<?php } ?>
										</td>
										<td>
											<?php if($value['conn_owner_doc']["document_path"]==""){ ?>
												N/A
											<?php } else { ?>
												<a href="<?=base_url();?>/writable/uploads/<?=$value['conn_owner_doc']['document_path'];?>" target="_blank" > <img id="imageresource" src="<?=base_url();?>/public/assets/img/pdf_logo.png" style="width: 40px; height: 40px;"></a>
											<?php } ?>
										</td>
										<td>
											<?php
			...
			<div class="table-responsive">
				<table class="table table-striped">
					...
					<tbody>
						...
						if($water_conn_dtl['property_type_id']==7)
						{
						?>
						<tr>
							<td><strong>Upload Apartment Certificate Occupancy Document  &nbsp;</strong> (<span style="color: #f00">*</span> Single Image file)</td>

							<td>
								<?php if($apt_doc["document_path"]==""){ ?>
									N/A
								<?php } else { ?>
									<a href="<?=base_url();?>/writable/uploads/<?=$apt_doc['document_path'];?>" target="_blank" > <img id="imageresource" src="<?=base_url();?>/public/assets/img/pdf_logo.png" style="width: 40px; height: 40px;"></a>
								<?php } ?>
							</td>
							...
							<td>
								<?php
									...
									?>
										<button class="btn btn-success" onclick="apt_doc();">Upload Document</button>
								<?php else: ?>
									<span class="text-danger">  <b>Uploaded Successfully !!</b></span>
...
<div id="apt_doc_Modal" class="modal fade" role="dialog">
	<div class="modal-dialog modal-lg">
		<!-- Modal content-->
		<div class="modal-content">
			<div class="modal-header">
			...
			<div class="modal-body">
				...
				<div class="table-responsive">
					<table class="table table-bordered table-hover" >
                        ...
                        <tr>
                            <td><input type="file" name="apt_doc_path" id="apt_doc_path" class="form-control" accept=".pdf"/></td>
						</tr>
					</table>
				</div>
            ...
            <div class="modal-footer">
                <input name="btn_apt" id="btn_apt" class="btn btn-success" value="Upload" type="submit">
                <a href="#" class="btn" data-dismiss="modal">Close</a>
            </div>
            </form>
		</div>
