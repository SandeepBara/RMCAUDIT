    ...
    <div id="page-content">
        ...
        <div class="panel panel-bordered panel-dark">
            ...
            <div class="panel-body">
                <form class="form-horizontal" method="post" action="<?=base_url('');?>/BankReconciliationWaterList/cheque">
                    <div class="form-group">
                        <input type="hidden" id="cheque_no" name="cheque_no" value="<?=(isset($value['cheque_no']))?$value['cheque_no']:"";?>">
                        <div class="col-md-6">
                            <div class="col-md-3">
                                <label class="control-label">Transaction From</label>
                            </div>
                            <div class="col-md-3">
                               <b><?=$value['transaction_type']=='New Connection'?"Applicant":'Consumer';?></b>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="col-md-3">
                    ...
                    <div class="form-group">
                       <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-3">
                               <b><?=date('d-m-Y',strtotime($value['transaction_date']));?></b>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
