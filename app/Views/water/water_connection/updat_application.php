...
<div id="content-container">
    ...
    <div id="page-content">
		...
		<form id="form" name="form" method="post" onsubmit="validate_from();" >
            ...
            <div  class="panel panel-bordered panel-dark" id = "appliction_meta_block">
                <div class="panel-heading">
                    ...
                    <div class="panel-control">
                        <?php                        
                            ...
                            {
                                ?>
                                    <input type="checkbox" name="appliction_meta_box" id="appliction_meta_box" onclick="read_only_remove('appliction_meta_box','appliction_meta_block')" <?=isset($appliction_meta_box) && $appliction_meta_box ? 'checked':'';?> />
                                <?php
                            }
                        ?>
                    </div>                    
                    <h3 class="panel-title">Applicant Connection Request Type Details
                        <?php
                            if($user_type=="")
                            {
                                ?>
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 pad-btm">
                            <select id="connection_type_id" name="connection_type_id" class="form-control" readonly  disabled>
                        ...
                        <div class="col-md-3 pad-btm">
							<select name="conn_through_id" id="conn_through_id" class="form-control" onchange="show_hide_holding_box(this.value)" readonly  disabled>
								<option value="">SELECT</option>
								<?php
                    ...
                    <div class="row">
                        <div id="holding_div" style="display: none;">
                            ...
                            <div class="col-md-3 pad-btm">
                                <input type="text" name="holding_no" id="holding_no" class="form-control" onChange="validate_holding();" value="<?php echo isset($holding_no)?$holding_no:""; ?>"  onkeypress="return isAlphaNum(event);" placeholder="Enter Holding No." maxlength="15" readonly  disabled/>
                        ...
                        <div id="saf_div" style="display: none;">
                            ...
                            <div class="col-md-3 pad-btm">
                                <input type="text" name="saf_no" id="saf_no" class="form-control" value="<?php echo isset($saf_no)?$saf_no:""; ?>" onblur="validate_saf()"  onkeypress="return isAlphaNumCommaSlash(event);" placeholder="Enter SAF No." readonly  disabled>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 pad-btm">
							<select name="property_type_id" id="property_type_id" class="form-control" onchange="show_flat_count(this.value);show_category(this.value);" readonly  disabled>
								<option value="">SELECT</option>
								<?php
                        ...
                        <div class="row">
                            <div id="flat_count_box" style="display: none;">
                                ...
                                <div class="col-md-3 pad-btm">
                                    <input type="text" name="flat_count" id="flat_count" class="form-control" value="<?php echo isset($flat_count)?$flat_count:""; ?>"  onkeypress="return isNum(event);"   placeholder="Enter No. of Flats" readonly  disabled>
                                </div>
                            </div>						
                	    </div>
                    ...
                    <div class="row">
						...
						<div id="category_block" style="display: none;">
							...
							<div class="col-md-3 pad-btm">
								<select name="category" id="category" class="form-control" readonly  disabled>
									<option value="">SELECT</option>
						...
						<div id="pipeline_div" style="display: none;">
                            ...
                            <div class="col-md-3 pad-btm">
                                <select name="pipeline_type_id" id="pipeline_type_id" class="form-control" readonly  disabled>
                                    <option value="">SELECT</option>
                                    <?php
			...
			<div class="panel panel-bordered panel-dark" id = "consumer_block">
                <div class="panel-heading">
                    ...
                    <h3 class="panel-title">Application Property Detais</h3>
				...
				<div class="panel-body">
					...
					<div class="row">						
                        ...
                        else
                        {
                            ?>
                                <label class="col-md-2">Total Area(in Sq. Ft) <span class="text-danger">*</span></label>
                                <div class="col-md-3 pad-btm">
                                    <?php echo isset($area_in_sqft)?$area_in_sqft:''; ?>
                                </div>
                                <label class="col-md-2">Total Area(in Sq. Mtr) <span class="text-danger">*</span></label>
                                <div class="col-md-3 pad-btm">
                                    <?php echo isset($area_in_sqmt)?$area_in_sqmt:''; ?>
                                </div>
                    ...
                    <div class="row">
						...
						<div class="col-md-4 pad-btm">
                            <input type="text" name="landmark" id="landmark" class="form-control"  value="<?php echo isset($landmark)?$landmark:''; ?>"  onkeypress="return isAlphaNum(event);"  placeholder="Enter Landmarke">
							
						</div>
                        <label class="col-md-2">Pin Code<span class="text-danger">*</span></label>
						<div class="col-md-4 pad-btm">
                            <input type="text" name="pin" id="pin" class="form-control"  value="<?php echo isset($pin)?$pin:''; ?>"  onkeypress="return isAlphaNum(event);"  placeholder="Enter Pin Code">							
						</div>
                    </div>
				</div>
			</div>
            ...
            rules: {
                conn_through_id: {
                    required: function(element) {
                        return $('#appliction_meta_box').is(':checked')
                    }
                },
                connection_type_id: {
                    required: function(element) {
...
<script>
    ...
    $(document).ready(function () {
        ...
        {
            ?>
            read_only_remove('appliction_meta_box','appliction_meta_block');
            <?php
        }
        ?>
