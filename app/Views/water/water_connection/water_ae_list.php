                ...
                <div id="page-content">
					<div class="panel panel-bordered panel-dark">
						<div class="panel-heading">
							<h5 class="panel-title">Water AE Search</h5>
						</div>
						<div class="panel-body">
							<form class="form-horizontal" method="post" action="<?php echo base_url('Water_AE/index');?>">
					...
					<div class="panel panel-bordered panel-dark">
						<div class="panel-heading">
							<h5 class="panel-title">Water AE List</h5>
						</div>
						<div class="panel-body">
                			<div class="row">
			                    <div class="col-sm-12">
