        ...
        { 
            ...
            <div id="page-head">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active"><a href="#">Waiver Comity Arv Billing</a></li>
                </ol>
                <!--End breadcrumb-->
            </div>
            <?php 
		...
		<form id="form" name="form" method="post" onsubmit="validate_from();" enctype="multipart/form-data" >
			...
			<div class="panel panel-bordered panel-dark" >
                <div class="panel-heading">                    
                    <h3 class="panel-title">Average Billing Form
                        <?php
                            if($user_type==5)
                            {
                                ?>
			...
			<div class="panel panel-bordered panel-dark">
                <div class="panel-heading">                    
                    <h3 class="panel-title">Meter Connection Date </h3>
                </div>
                <div class="panel-body">
                    <div class="row">
                        <label class="col-md-2">Water Connection Date<span class="text-danger"></span></label>
                        <div class="col-md-3 pad-btm">
                    ...
                    <?php
                        if(isset($connection_dtls['connection_type']) && $connection_dtls['connection_type']!=3)
                        {
                            ...
                            <div class="row">
                                ...
                                <label class="col-md-2">Last Reading <span class="text-danger"></span></label>
                                <div class="col-md-3 pad-btm">
                    ...
                    ?>
                    <div class="row">
                        <label class="col-md-1">Reading From Date<span class="text-danger"></span></label>
                        <div class="col-md-3 pad-btm">
                            <input type="date" max = "<?=date('Y-m-d')?>" class="form-control" name = 'reading_from_date' id = "reading_from_date" value="<?=$_POST['reading_from_date']??'';?>">                            
                        </div>
                        <label class="col-md-1">Reading Upto Date<span class="text-danger"></span></label>
                        <div class="col-md-3 pad-btm">
                            <input type="date" max = "<?=date('Y-m-d')?>" class="form-control" name = 'reading_upto_date' id = "reading_upto_date" value="<?=$_POST['reading_upto_date']??'';?>">                            
                        </div>  
                        <label class="col-md-1">meter reading<span class="text-danger"></span></label>
                        <div class="col-md-3 pad-btm">
                            <input type="number" class="form-control" name = 'final_reading' id = "final_reading" value="<?=$_POST['final_reading']??'';?>">                            
                        </div>                      
                    </div>
                    <div class="row">
                        <label class="col-md-1">From Date<span class="text-danger"></span></label>
                        <div class="col-md-3 pad-btm">
                            <input type="date" max = "<?=date('Y-m-d')?>" class="form-control" name = 'from_date' id = "from_date" value="<?=$_POST['from_date']??'';?>">                            
                        </div>
                        <label class="col-md-1">Upto Date<span class="text-danger"></span></label>
                        <div class="col-md-3 pad-btm">
                            <input type="date" max = "<?=date('Y-m-d')?>" class="form-control" name = 'upto_date' id = "upto_date" value="<?=$_POST['upto_date']??'';?>">                            
                        </div>                     
                    </div>
