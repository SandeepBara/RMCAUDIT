    ...
    <div id="page-content">       
        <div class="panel panel-bordered panel-dark">
			...
			<div class="panel-body">
                <form class="form-horizontal" method="post" action="<?php echo base_url('waterfieldSiteInspection/search_consumer_for_siteInspection').(isset($mobile)?"/$mobile":'');?>">							
                    <div class="form-group">
                        ...
                        <div class="col-md-12 text-center bg-mint ">
                            <div class="radio">										
                                ...
                                <input type="radio" id="by_forward_date" class="magic-radio" name="by_holding_owner_dtl" value="by_forward_date" checked onchange="div_show(this.value)" <?=isset($by_holding_owner_dtl) && $by_holding_owner_dtl=='by_forward_date'?'checked':''?>>
						...
						<table id="demo_dt_basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<a href="<?php echo base_url('waterfieldSiteInspection/field_verification/'.md5($val['id']).'/'.md5($val['level_pending_dtl_id']).(isset($mobile)?"/$mobile":''));?>" class="btn btn-primary">View</a>
									</td>
								</tr>
								<?php endforeach;?>
								<?php endif;  ?>
