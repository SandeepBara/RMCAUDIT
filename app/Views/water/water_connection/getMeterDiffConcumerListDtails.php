...
<li class="active">Bulk Meter Demand Generate Diff Amount Genration Details</li>
</ol>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<!--End breadcrumb-->
</div>
		...
		<div id="page-content">
			<div class="panel panel-bordered panel-dark">
				<div class="panel-heading">
                    <a class = "panel-control bg-info" href="<?=base_url('/WaterViewConsumerDetails/getMeterDiffConcumerList')?>">Back</a>
					<h5 class="panel-title">Demand Details</h5>
				</div>
                                        ...
                                        if($demands??false)
                                        {
                                            ...
                                            {  
                                                ...
                                                <tr class="text-<?=$val["text_coler"]?>">  
                                                    ...
                                                    <td><?php echo $val['initial_reading']??"";?></td>
                                                    <td><?php echo $val['final_reading']??"";?></td>
                                                    <td><?php echo $val['amount']??"0.00";?></td>
                                                    <td><?php echo round($val['diffrent_ammount']??"0.00",2);?></td>
                                                    <td><?php echo $val['text_coler']=="success"?"Yes":"No";?></td>
                                                </tr>
                                                <?php
                                            }
                                        }
