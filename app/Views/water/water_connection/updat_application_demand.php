		...
		<form id="form" name="form" method="post" >
			...
			<div class="panel panel-bordered panel-dark">
                <div class="panel-heading">                
                    <h3 class="panel-title">Update Water Connection Form
                        <?php
                            if($user_type=="")
                            {
                                ?>
                ...
                <div class="panel-heading">
                    <div class="panel-title text-center bg-mint"> 
                            Application No.: <?=$consumer_details['application_no'];?>
                    </div>
                </div>
					...
					<div class="row">
						...
						<div id="saf_div" style="display: none;">
							...
							<div class="col-md-3 pad-btm">
								...
								<input type="hidden" name="saf_id" id="saf_id" value="<?=isset($saf_id)?$saf_id:""?>">
							</div>
						</div>
                	</div>
							...
							<div class="col-md-3 pad-btm">
								...
								<select name="ward_id" id="ward_id" class="form-control">
									...
									if($ward_list)
									{
										...
										{											
                                            ?>
                                            <option value="<?=$val['ward_mstr_id'];?>" <?=isset($ward_id) &&$ward_id==$val['ward_mstr_id']?'selected':'';?>><?=$val['ward_no']; ?></option>
                                            <?php			
										}
									}
									?>
						...
						<table class="table table-bordered" style="font-family:Arial, Helvetica, sans-serif; font-size:12px;">
							<thead class="bg-trans-dark text-dark">
								<tr>
									...
									<th colspan="2" id="owner_add" class="add_minus">Add</th>
								</tr>
                            </thead>
                                ...
                                <tbody id="owner_dtl">
                                    <tr>
                                        ...
                                        <td><input type="text" name="city[]" id="city<?=$i;?>" class="form-control" onkeypress="return isAlpha(event);" placeholder="City"  /></td>
                                            <td><input type="text" name="district[]" id="district<?=$i;?>" class="form-control" onkeypress="return isAlpha(event);" placeholder="District" /></td>
                                            <td><input type="text" name="state[]" id="state<?=$i;?>" class="form-control" onkeypress="return isAlpha(event);" placeholder="State"  /></td>
                                        <input type="hidden" name="count" id="count" value="1">
                                        <td onclick="add_owner()" colspan="2" class="add_minus"><i class="form-control fa fa-plus-square" style="cursor: pointer;"></i></td>
                                    </tr>
                            ...
                            else
                            {
                                ...
                                ?>
                                <input type="hidden" name="count" id="count" value="<?=sizeof($owner_name);?>">
                                <tbody id="owner_dtl">
                                <?php
                            	...
                            	{	
                                    ?>
                                        ...
                                        <tr>
                                            <td><input type="text" name="owner_name[]" id="owner_name<?=$i;?>" class="form-control"  onkeypress="return isAlpha(event);"  placeholder="Owner Name" value="<?php echo $owner_name[$i]['applicant_name'];?>" /></td>
                                            <td><input type="text" name="guardian_name[]" id="guardian_name<?=$i;?>" class="form-control"  onkeypress="return isAlpha(event);"  placeholder="Guardian Name" value="<?php echo $owner_name[$i]['father_name'];?>" /></td>
                                            <td><input type="text" name="mobile_no[]" id="mobile_no<?=$i;?>" class="form-control" maxlength=10 minlength=10 onkeypress="return isNum(event);"  placeholder="Mobile No." value="<?php echo $owner_name[$i]['mobile_no'];?>" /></td>
                                            <td><input type="email" name="email_id[]" id="email_id<?=$i;?>" class="form-control"  placeholder="Email ID" value="<?php echo $owner_name[$i]['email_id'];?>" /></td>
                                            <td><input type="text" name="city[]" id="city<?=$i;?>" class="form-control" onkeypress="return isAlpha(event);" placeholder="City" value="<?php echo $owner_name[$i]['city'];?>" /></td>
                                            <td><input type="text" name="district[]" id="district<?=$i;?>" class="form-control" onkeypress="return isAlpha(event);" placeholder="District" value="<?php echo $owner_name[$i]['district'];?>" /></td>
                                            <td><input type="text" name="state[]" id="state<?=$i;?>" class="form-control" onkeypress="return isAlpha(event);" placeholder="State" value="<?php echo $owner_name[$i]['state'];?>" /></td>   
                                            <td onclick="add_owner()" colspan="2" class="add_minus"><i class="form-control fa fa-plus-square" style="cursor: pointer;"></i></td>
                                        </tr>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2 pad-btm">
                                <input type="radio" name="elec_category" id="elec_category" value="Residential - DS I/II" <?php if(isset($electric_category_type) && (strtoupper($electric_category_type)=='RESIDENTIAL - DS I/II')){echo "checked"; }?>>  Residential - DS I/II 
                            </div>
                            <div class="col-md-2 pad-btm">
                                <input type="radio" name="elec_category" id="elec_category" value="Commercial - NDS II/III" <?php if(isset($electric_category_type) && strtoupper($electric_category_type)=='COMMERCIAL - NDS II/III'){echo "checked"; }?>>  Commercial - NDS II/III 
                            </div>
                            <div class="col-md-2 pad-btm">
                                <input type="radio" name="elec_category" id="elec_category" value="Agriculture - IS I/II" <?php if(isset($electric_category_type) && strtoupper($electric_category_type)=='AGRICULTURE - IS I/II'){echo "checked"; }?>>Agriculture - IS I/II
                            </div>
                            <div class="col-md-2 pad-btm">
                                <input type="radio" name="elec_category" id="elec_category" value="Low Tension - LTS" <?php if(isset($electric_category_type) && strtoupper($electric_category_type)=='LOW TENSION - LTS'){echo "checked"; }?>>Low Tension - LTS 
                            </div>
                            <div class="col-md-2 pad-btm">
                                <input type="radio" name="elec_category" id="elec_category" value="High Tension - HTS" <?php if(isset($electric_category_type) && strtoupper($electric_category_type)=='HIGH TENSION - HTS'){echo "checked"; }?>>High Tension - HTS
                            </div>                        
                        </div>                    
                    </div>
                </div>
            ...
            $('#form').validate({ // initialize the plugin counter
                rules: {
                    ...
                    required: function(element) {
                        if($('#elec_account_no').val()=='' && $('#elec_account_no').val()=='' && $('#elec_category').val()=='')
                        {
                            return true;
                        }
                    }
                ...
                elec_category :{
                    required: function(element) {
                        if($('#elec_bind_book_no').val()=='' && $('#elec_account_no').val()=='' && $('#elec_k_no').val()=='')
                        {
                            return true;
                        }
                    }
                ...
                elec_account_no :{
                    required: function(element) {
                        if($('#elec_bind_book_no').val()=='' && $('#elec_k_no').val()=='' && $('#elec_category').val()=='')
                        {
                            return true;
                        }
                    }
...
function load()
{
    ...
    show_flat_count(property_type_id);
    ...
    if(saf_no)
    {
        // validate_saf();
        show_hidd_div();
        read_only_remove('owner_dtl',true);
        show_hidd_div();
    }
...
<script type="text/javascript">
                ...
                if (data.response==true)
                {
                    ...
                    for(var k in data.dd)
                    {
                        ...
                        if(payment_status==0)
                        {
                            ...
                            var tbody = '<tr><td><input type="text"  name="owner_name[]" id="owner_name1";class="form-control owner_name" placeholder="Owner Name" value="" onkeypress="return isAlpha(event);" onkeyup="borderNormal(this.id);" /></td>';
                            tbody +='<td><input type="text" id="guardian_name1" name="guardian_name[]" class="form-control guardian_name" placeholder="Guardian Name" value="" onkeypress="return isAlpha(event);" onkeyup="borderNormal(this.id);" /></td>';
                            tbody +='<td><input type="text" id="mobile_no1" name="mobile_no[]" class="form-control mobile_no" placeholder="Mobile No." value="" onkeypress="return isNum(event);" onkeyup="borderNormal(this.id);" minlength="10" maxlength="10" /></td>';
                            tbody +='<td><input type="email" id="email_id" name="email_id[]"  class="form-control city" placeholder="Email Id" value="" onkeyup="borderNormal(this.id);" /></td>';
                            
                            tbody+='<td><input type="text" name="city[]" id="city1" class="form-control" onkeypress="return isAlpha(event);" value=""  placeholder="City" ></td>';
                            tbody+='<td><input type="text" name="district[]" id="district1" class="form-control" onkeypress="return isAlpha(event);" value=""  placeholder="District" ></td>';
                            tbody+='<td><input type="text" name="state[]" id="state1" class="form-control" onkeypress="return isAlpha(event);" value=""  placeholder="State" ></td>';
                            
                            tbody +='<td onclick="add_owner()">Add</td></tr>';
                        ...
                        else
                        {
                            ...
                            {                               
                                ...
                                tbody+='<td><input type="text" name="city[]" id="city'+k+'" class="form-control" onkeypress="return isAlpha(event);" value=""  placeholder="City" ></td>';
                                tbody+='<td><input type="text" name="district[]" id="district'+k+'" class="form-control" onkeypress="return isAlpha(event);" value=""  placeholder="District" ></td>';
                                tbody+='<td><input type="text" name="state[]" id="state'+k+'" class="form-control" onkeypress="return isAlpha(event);" value=""  placeholder="State" ></td>';
                ...
                success:function(data)
                {
                    ...
                    if (data.response==true)
                    {
                            ...
                            for(var k in data.dd) 
                            {
                                ...
                                if(owner_type=='OWNER')
                                {
                                    tbody+='<td><input type="text" name="owner_name[]" id="owner_name'+k+'" class="form-control" onkeypress="return isAlpha(event);" value="'+data.dd[k]['owner_name']+'" readonly  placeholder="Owner Name" ></td>';

                                    tbody+='<td><input type="text" name="guardian_name[]" id="guardian_name'+k+'" class="form-control" onkeypress="return isAlpha(event);" value="'+data.dd[k]['guardian_name']+'" readonly  placeholder="Guardian Name"></td>';

                                    tbody+='<td><input type="text" name="mobile_no[]" id="mobile_no'+k+'" class="form-control" onkeypress="return isNum(event);" value="'+data.dd[k]['mobile_no']+'"  maxlength=10 minlength=10  placeholder="Mobile No."></td>';

                                    tbody+='<td><input type="email" name="email_id[]" id="email_id'+k+'" class="form-control" value="'+data.dd[k]['email']+'"  placeholder="Email ID" ></td>';
                                    tbody+='<td><input type="text" name="city[]" id="city'+k+'" class="form-control" onkeypress="return isAlpha(event);" value=""  placeholder="City" ></td>';
                                    tbody+='<td><input type="text" name="district[]" id="district'+k+'" class="form-control" onkeypress="return isAlpha(event);" value=""  placeholder="District" ></td>';
                                    tbody+='<td><input type="text" name="state[]" id="state'+k+'" class="form-control" onkeypress="return isAlpha(event);" value=""  placeholder="State" ></td>';
    ...
    function add_owner()
    {
        ...
        input5.name='city[]';
        input5.id='city'+count;
        input5.type='text';      
        input5.placeholder='City';
        input5.setAttribute('onkeypress','return isAlpha(event)');
        td5.append(input5);
        tr.append(td5);

        input6.name='district[]';
        input6.id='district'+count;
        input6.type='text';      
        input6.placeholder='District';
        input6.setAttribute('onkeypress','return isAlpha(event)');
        td6.append(input6);
        tr.append(td6);

        input7.name='state[]';
        input7.id='state'+count;
        input7.type='text';      
        input7.placeholder='State';
        input7.setAttribute('onkeypress','return isAlpha(event)');
        td7.append(input7);
        tr.append(td7);
    ...
    function read_only_remove(type,bool)
    {
        var ch = document.getElementById(type);
        
        if(bool==true)
        {        
           $('input[name="owner_name[]"]').attr('readonly',true);
           $('textarea[name="address"]').attr('readonly',true);
           $('input[name="pin"]').attr('readonly',true);
           $('.add_minus').remove();           
        }
        else
        {
           
            $("#"+ type ).find("select, textarea, input").attr('readonly',true);
            $("#"+ type).find("select").attr('disabled',true);
            $("#"+ type).find("input:radio").attr('disabled',true);
            
        }
        
    }

    function show_hidd_div()
    {
        var connection_through_id=$("#conn_through_id").val();
        if(connection_through_id==1)
        {
