                        ...
                        <div class="col-sm-12">
                            <div class="panel">
                                <div class="panel-heading">
                                    <h5 class="panel-title">Daily Collection</h5>
                                </div>
                                <div class="panel-body">
                                    <div class ="row">
                                        <div class="col-md-12">
                                            <form class="form-horizontal" method="post" action="<?=base_url('');?>/DailyCollectionMobi/report">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?=$value['application_no']!=""?$value['application_no']:$value['consumer_no'];?></td>
                                            <td><?=$value['ownerDetails']['applicant_name']!=""?$value['ownerDetails']['applicant_name']:"N/A";?></td>
