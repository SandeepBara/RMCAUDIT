					...
					<div class="panel panel-bordered panel-dark">
                        <div class="panel-heading" style="background-color: #298da0;">
                            ...
                            <div class="panel-body">
                                <div class ="row">
                                    <div class="col-md-12">
                                        <form class="form-horizontal" action="<?php echo base_url('levelwisependingform/reportleveltimetaken2');?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-3">
                                                    <label class="control-label" for="to_date"><b>Type</b> <span class="text-danger">*</span></label>
                                                    <select name="filter_type" id="user_type" class="form-control">
                                                        ...
                                                        <option value="Property Section Incharge" <?= ($_GET['filter_type']=='Property Section Incharge')?'selected':"" ?> >Property Section Incharge</option>
...
<!--                                        <td>--><?php //= $value["forward_date"]??""; ?><!--</td>-->
                                        <td>
                                            <!-- level id passing -->
                                            <a class="btn btn-primary" target="_blank" href="<?php echo base_url('safDtl/full/' . $value['saf_dtl_id']); ?>" role="button">View</a>
