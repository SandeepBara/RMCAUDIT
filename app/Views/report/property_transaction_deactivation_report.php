...
<!--CONTENT CONTAINER-->
            ...
            <div id="content-container">
                <div id="page-head">
                    ...
                    <li class="active">Property Transaction Deactivate List</li>
                    </ol>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End breadcrumb-->
                </div>
                        ...
                        <div class="col-sm-12">
                            <div class="panel">
                                <div class="panel-heading">
                                    <h5 class="panel-title">Property Transaction Deactivate List</h5>
                                </div>
                                <div class="panel-body">
                                    <div class ="row">
                                        <div class="col-md-12">
                                            <form class="form-horizontal" method="post" action="<?=base_url('');?>/PropertyTransactionDeactivationReport/detail">
                                    ...
                                    <div class="table-responsive">
                                     <table id="demo_dt_basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                    <?php
                                    if(!isset($propertyTransactionDeactivateList)):
                                    ?>
                                            <tr>
                                    ...
                                    <?php else:
                                            $i=0;
                                            foreach ($propertyTransactionDeactivateList as $value):
                                    ?>
                                            <tr>
                                                <td><?=++$i;?></td>
                                                ...
                                                <td><?=$value['payable_amt']!=""?$value['payable_amt']:"N/A";?></td>
                                                <td><?=$value['saf_no']!=""?$value['saf_no']:$value['holding_no'];?></td>
                                                ...
                                                <td><a href="<?=base_url();?>/writable/uploads/RANCHI/property_transaction_deactivation/<?=$value['file_path'];?>" target="_blank" ><img id="imageresource" src="<?=base_url();?>/public/assets/img/pdf_logo.png" style="width: 40px; height: 40px;"></a></td>
                                            </tr>
                                        <?php endforeach;?>
                                    <?php endif;  ?>
                                        </tbody>
