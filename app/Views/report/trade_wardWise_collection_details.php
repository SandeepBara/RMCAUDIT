...
<!--CONTENT CONTAINER-->
            ...
            <div id="content-container">
                <div id="page-head">
					...
					<li class="active">Ward Wise  List</li>
                    </ol>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End breadcrumb-->
                </div>
					    ...
					    <div class="col-sm-12">
					        <div class="panel panel-bordered panel-dark">
					            <div class="panel-heading">
					                <h5 class="panel-title">Ward Wise  List</h5>
					            </div>
                                <div class="panel-body">
					                ...
					                <table id="demo_dt_basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
										...
										?>
                                            <tr>
                                                ...
                                                <td><?=$value["sum"];?></td>
                                                <td>
                                                <a class="btn btn-primary" href="<?php echo base_url('trade_da/view_application_details/'.md5($value['id']));?>" role="button">View</a>
                                                </td>
                                                <?php $total += $value["sum"];?>
                                            </tr>
                                        <?php endforeach;?>
                                    ...
                                    <hr>
                                    <h3><b>Total Collection Amount :- <?= $total;?> </b></h3><br>
                                        </div>
                                    </div>
                                </div>
					        </div>
