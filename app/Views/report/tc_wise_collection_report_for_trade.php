                ...
                <div id="page-content">
                    <div class="panel panel-bordered panel-dark">
						<div class="panel-heading">
							<h5 class="panel-title">TC Wise Collection Report</h5>
						</div>
						<div class="panel-body">
							<div class ="row">
								<div class="col-md-12">
									<form class="form-horizontal" method="post" action="<?=base_url('');?>/TradeTCWiseCollectionReports/index">
										<div class="form-group">
											<div class="col-md-2">
												...
												<div class="input-group">
												   <select name="tc_id" id="tc_id" class="form-control">
													   ...
													   ?>
													   <option value="<?php echo $val['id'];?>"><?php echo $val['emp_name']." ".$val['middle_name']." ".$val['last_name'];?></option>
													   <?php
														 endforeach;
														endif;
													   ?>
											...
											<div class="col-md-2">
												<label class="control-label" for="tc_no"><b>Application Type</b> <span class="text-danger">*</span></label>
												<div class="input-group">
							...
							?>
									<tr>
										...
										<td><?=$value['transaction_type']!=""?$value['transaction_type']:"N/A";?></td>
										<td>
							...
							<?php endif;  ?>
								...
								<tfoot>
									<tr>
									  <td colspan="8" style="text-align: right;color:#e80e91;font-weight:bold;">Total</td>
									  <td colspan="1" style="color:#e80e91;font-weight:bold;"><?=(isset($total))?$total:"0";?></td>
									</tr>
								</tfoot>
							</table>
							</div>
