...
<!--CONTENT CONTAINER-->
            ...
            <div id="content-container">
                <div id="page-head">
                    ...
                    <li class="active">Daily Collection List</li>
                    </ol>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End breadcrumb-->
                </div>
                        ...
                        <div class="col-sm-12">
                            <div class="panel">
                                <div class="panel-heading">
                                    <h5 class="panel-title">Daily Collection List</h5>
                                </div>
                                <div class="panel-body">
                                    <div class ="row">
                                        <div class="col-md-12">
                                            <form class="form-horizontal" method="post" action="<?=base_url('');?>/TransactionReport/report">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="text-center text-danger text-bold">Total Amount: <?php echo isset($getTotalAmount)?$getTotalAmount:0;?> 
                                                    </div>
                                                </div>
                                            </div>
                                            </form>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td><?=$value['fy']!=""?$value['fy']:"N/A";?></td>
                                                <td><?=$value['upto_fy']!=""?$value['upto_fy']:"N/A";?></td>
                                                <td class="text-right pad-no"><?=$value['payable_amt']!=""?round($value['payable_amt']).".00":"0";?></td>
                                            </tr>
                                    ...
                                    <?php endif;  ?>
                                        ...
                                        <tfoot>
                                            <tr>
                                              <td colspan="8" class="text-right text-bold text-danger">Total</td>
                                              <td class="text-right text-bold text-danger pad-no"><?=(isset($total))?round($total).".00":"0";?></td>
                                            </tr>
                                          </tfoot>
                                    </table>
                                    </div>
