...
<!--CONTENT CONTAINER-->
            ...
            <div id="content-container">
                ...
                <div id="page-content">
                    <div class="panel panel-bordered panel-dark">
						...
						<div class="panel-body">
							<form class="form-horizontal" method="post" action="<?=base_url('');?>/TradeCollectionSummary/collection_details">
								...
								<div class="col-md-3">
								<label class="control-label" for="Ward"><b>Tax Collector </b><span class="text-danger">*</span>&nbsp;&nbsp;<span style="color:#6583b9;" id="slct_tc"></span></label>
					...
					<div id="loadingDivs" style="display: none; background: url(<?=base_url('');?>/public/assets/img/loaders/dotloader.gif) no-repeat center center; position: absolute; top: 150px; left: 0; height: 100%; width: 100%; z-index: 9999999;"></div>
					<div class="panel panel-bordered panel-dark" id="printableArea">
						<div class="panel-heading text-center" style="height:149px;">
							<h3 class="panel-title"><?=strtoupper($ulb_name)?></h3>
							<h5 class="panel-title" style="margin: -20px;font-size: 12px;">Team Summary Report of Municipal Licence</h5>
							<h5 class="panel-title" style="font-size: 12px;" id="from_date_to_date">From -- To --</h5>
							<h5 class="panel-title ttl_cons" style="font-size: 12px;margin-left: 1000px;" id="ttl_cons">Total Consumers :- -- </h5>
                            <h5 class="panel-title ttl_collloectn" style="font-size:12px;margin-left: 1000px;margin-top: -17px;" id="ttl_collloectn">Total Collections :- --</h5> 
						</div><br/><br/>
 										<table class="table table-bordered">
											 
											<thead>
												<th id="leftTd" class="col-sm-1"><b>SN</b></th>
												<th id="leftTd"><b>Tax Collector</b></th>
												<th id="leftTd"><b>Total Applications</b></th>
												<th id="leftTd"><b>Total Collections</b></th>
											</thead>
                                            ...
                                            <tfoot>
												...
												<td id="leftTd"></td>
												<td id="leftTd" class="ttl_cons">Total Consumers :- -- </td>
												<td id="leftTd" class="ttl_collloectn">Total Collections :- --</td>
                                            </tfoot>
										</table>
...
$( "#team_leader" ).change(function() {
  ...
  else
  {
    ...
    $("#view_collection").prop("disabled",true);
 	...
 	$.ajax({
    type: "POST",
    url: "<?=base_url('TradeCollectionSummary/get_tax_collector_ajax');?>",
...
<script>
 function get_collection()
 {
	 ...
	 var tax_collector_id = $("#tax_collector").val();
   	$.ajax({
    type: "POST",
    url: "<?=base_url('TradeCollectionSummary/get_collection_details_ajax');?>",
    ...
    success: function(response){
        ...
        $(".ttl_cons").text(response.ttl_cons);
        $(".ttl_collloectn").text(response.ttl_collloectn);
