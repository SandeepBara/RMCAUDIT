...
<!--CONTENT CONTAINER-->
            ...
            <div id="content-container">
                <div id="page-head">
                    ...
                    <li class="active">Property Ward Wise Collection</li>
                    </ol>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End breadcrumb-->
                </div>
                        ...
                        <div class="col-sm-12">
                            <div class="panel">
                                <div class="panel-heading">
                                    <h5 class="panel-title">Property Ward Wise Collection</h5>
                                </div>
                                <div class="panel-body">
                                    <div class ="row">
                                        <div class="col-md-12">
                                            <form class="form-horizontal" method="post" action="<?=base_url('');?>/PropertyCollectionWardWise/report">
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td class="text-right"><?=$value['payable_amt']!=""?round($value['payable_amt']).".00":"0";?></td>
                                            </tr>
                                    ...
                                    <?php endif;  ?>
                                        ...
                                        <tfoot>
                                            <tr>
                                            <td colspan="7" class="text-danger text-right text-bold">Total</td>
                                             <td class="text-danger text-right text-bold"><?=(isset($total))?round($total).".00":"0";?></td>
                                            </tr>
                                        </tfoot>
                                    </table>
                                    </div>
