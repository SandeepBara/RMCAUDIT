                    ...
                    <div class="col-sm-12">
                        <div class="table-responsive">
                            <table id="empTable" class="table table-striped table-bordered text-sm">
                                ...
                                <tfoot>
                                            <tr>
                                              <td colspan="10" style="text-align: right;color: red;font-weight: bold;">Total</td>
...
<script type="text/javascript">
    ...
    var dataTable = $('#empTable').DataTable({
        ...
        lengthMenu: [
            [10, 25, 50, 5000,(-1)],
            ['10 rows', '25 rows', '50 rows', '5000 rows','All']
        ],
        buttons: [
            'pageLength',
			{
        ...
        'ajax': {
            "type": "POST",
            'url':'<?=base_url('TradeTCWiseCollectionReports/get_data_tc_wise_collection_ajax');?>',
            "dataType": "json",
            'data': function(data){ 
                console.log(data);
