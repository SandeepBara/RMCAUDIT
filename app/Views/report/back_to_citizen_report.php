                        ...
                        <div class="col-sm-12">
                            <div class="panel">
                                <div class="panel-heading">
                                    <h5 class="panel-title">Back To Citizen</h5>
                                </div>
                                <div class="panel-body">
                                    <div class ="row">
                                        <div class="col-md-12">
                                            <form class="form-horizontal" method="post" action="<?=base_url('');?>/BackToCitizen/report">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-2">
                                                    ...
                                                    <button class="btn btn-primary btn-block" id="btn_citizen" name="btn_citizen" type="submit">Search</button>
                                                </div>
                                            </div>
                                            </form>
                                        </div>
                                    ...
                                    <?php else:
                                        $i=0;
                                        foreach ($backToCitizenList as $value):
                                    ?>
                                        <tr>
                                            <td><?=++$i;?></td>
                                            <td><?=$value['ward_no']!=""?$value['ward_no']:"N/A";?></td>
                                            <td>
                                                <?=$value['saf_no']!=""?$value['saf_no']:"N/A";?>
                                            </td>
