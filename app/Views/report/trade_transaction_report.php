...
<div id="content-container">
    <div id="page-head">
        ...
        <li class="active">Trade Daily Mode Wise Collection List</li>
        </ol>
    </div>
    <!--Page content-->
    <div id="page-content">
            ...
            <div class="col-sm-12">
                <div class="panel">
                    <div class="panel-heading">
                        <h5 class="panel-title">Trade Daily  Mode Wise Collection List</h5>
                    </div>
                    <div class="panel-body">
                        <div class ="row">
                            <div class="col-md-12">
                                <form class="form-horizontal" method="post" action="<?=base_url('');?>/TradeCollectionReports/report">
                                    ...
                                    <div class="col-md-3">
                                        <label class="control-label" for="to_date"><b>Payment Mode</b><span class="text-danger">*</span> </label>
                                        <div class="input-group">
                                            <select name="payment_mode" id="payment_mode" class="form-control">
                                                ...
                                                <option value="DD" <?php if($payment_mode=='DD'){ echo "selected";}?>>DD</option>
                        ...
                        <div class="row">
                        <div class="col-md-12">
                            <div class="text-center text-danger text-bold">Total Amount: <?php echo isset($getTotalAmount)?$getTotalAmount:0;?> </div>
                            <div class="table-responsive">
                                <table id="demo_dt_basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                    ...
                                    ?>
                                        <tr>
                                            <td><?=++$i;?></td>
                                            <td style="width: 9px;"><?=$value['ward_no']!=""?$value['ward_no']:"N/A";?></td>
                                    ...
                                    <tfoot>
                                        <tr>
                                            <td class="text-success text-right text-danger text-bold" colspan="8">Total</td>
                                            <td class="text-success text-right text-danger text-bold"><?=(isset($total))?$total:"0";?></td>
                                        </tr>
                                    </tfoot>
                                </table>
                            </div>
