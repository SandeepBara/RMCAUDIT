                    ...
                    <table class="table table-sm table-striped table-bordered text-sm table-responsive datatable text-center" id="levelTable">
                        ...
                        <tbody>
                           ...
                           <tr style="font-size: 15px;">
                                ...
                                <th><?= $boprocess ?></th>
                                <th>
                                    <a target="_blank" href="<?php echo base_url('levelwisependingform/exportreportleveltimetaken2?report_type=list&from_date='.$from_date.'&to_date='.$to_date.'&filter_type=Back+Office');?>">
                                        <button class="activelink" formtarget="_blank"><?= $bopending??"" ?></button>
                                    </a>
                                </th>
                                <th><?= $dadone ?></th>
                                <th><?= $da_process ?></a>
                                ...
                                <th>
                                    <a target="_blank" href="<?php echo base_url('levelwisependingform/exportreportleveltimetaken2?report_type=list&from_date='.$from_date.'&to_date='.$to_date.'&filter_type=Dealing+Assistant');?>">
                                        <button class="activelink" formtarget="_blank"><?= $da_pending??"" ?></button>
                                    </a>
                                </th>
                                <th><?= $tcdone ?></th>
                                <th><?= $tc_process ?></th>
                                <th>
                                    <a target="_blank" href="<?php echo base_url('levelwisependingform/exportreportleveltimetaken2?report_type=list&from_date='.$from_date.'&to_date='.$to_date.'&filter_type=Tax+Collector');?>">
                                        <button class="activelink" formtarget="_blank"><?= $tc_pending??"" ?></button>
                                    </a>
                                </th>
                                <th>
                                    <a target="_blank" href="<?php echo base_url('levelwisependingform/exportreportleveltimetaken2?report_type=list&from_date='.$from_date.'&to_date='.$to_date.'&filter_type=ULB+Tax+Collector');?>">
                                        <button class="activelink" formtarget="_blank"><?= $utc_pending??"" ?></button>
                                    </a>
                                </th>
                                <th>
                                    <a target="_blank" href="<?php echo base_url('levelwisependingform/exportreportleveltimetaken2?report_type=list&from_date='.$from_date.'&to_date='.$to_date.'&filter_type=Section+Incharge');?>">
                                        <button class="activelink" formtarget="_blank"><?= $sitc_pending??"" ?></button>
                                    </a>
                                </th>
                                <th>
                                    <a target="_blank" href="<?php echo base_url('levelwisependingform/exportreportleveltimetaken2?report_type=list&from_date='.$from_date.'&to_date='.$to_date.'&filter_type=Executive+Officer');?>">
                                        <button class="activelink" formtarget="_blank"><?= $eotc_pending??"" ?></button>
                                    </a>
                                </th>
                            </tr>
                           <?php } ?>
