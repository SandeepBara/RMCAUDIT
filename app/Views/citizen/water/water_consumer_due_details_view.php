			...
			<div class="panel panel-bordered panel-dark">
                    ...
                    <div class="panel-body">
                        ...
                        <table class="table table-bordered table-responsive">
                            <thead class="bg-trans-dark text-dark">
                                <tr>
                                    <th class="bolder">Month</th>
                                    <th class="bolder">Amount</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php
                                ...
                                ?>
                                <tr>
                                    <td><?php echo date('F-Y',strtotime($val['demand_upto']));?></td>
                                    <td><?php echo isset($val['balance_amount']) && !empty($val['balance_amount'])? $val['balance_amount'] :($val['amount']+$val['amount']);?></td>
				...
				<div class="panel-body text-center">
                   ...
                   <input type="hidden" name="consumer_id" id="consumer_id" value="<?php echo $consumer_id; ?>">
                    ...
                    <div class="col-md-3">
                      ...
                      <a href="<?php echo base_url('WaterUserChargeProceedPaymentCitizen/pay_payment/'.md5($consumer_details['id']));?>" class="btn btn-primary">Proceed to Payment</a>
