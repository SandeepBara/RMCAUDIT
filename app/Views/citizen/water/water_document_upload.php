    ...
    <div id="page-content">
            ...
            <div class="panel panel-bordered panel-dark">
                <div class="panel-heading">
						...
						<span class="btn btn-info"><a href="<?php echo base_url('WaterApplyNewConnectionCitizen/water_connection_view/'.md5($connection_dtls['id']));?>"  style="color: white;">Back</a></span>
					</div>
							...
							?>
								...
								?>
									<tr>
										<td>
											<?php 
											if($value['conn_owner_id']["document_path"]=="")
											{
												?>
												N/A
												<?php 
											...
											{
												?>
												<a href="<?=base_url();?>/getImageLink.php?path=<?=($value['conn_owner_id']["document_path"]);?>" target="_blank">
													<img id="imageresource" src="<?=base_url();?>/getImageLink.php?path=<?=($value['conn_owner_id']["document_path"]);?>" style="width: 40px; height: 40px;" />
												</a>
												<?php 
											}
											?>
										...
										<td>
											<?php if($value['conn_owner_doc']["document_path"]==""){ ?>
												N/A
											<?php } else { ?>
												<a href="<?=base_url();?>/getImageLink.php?path=<?=$value['conn_owner_doc']['document_path'];?>" target="_blank" > <img id="imageresource" src="<?=base_url();?>/public/assets/img/pdf_logo.png" style="width: 40px; height: 40px;"></a>
											<?php } ?>
										</td>
										<td>
											<?php
											if(empty($value['conn_owner_id']['applicant_detail_id'])):
											?>
		...
		<!-- <div class="panel panel-bordered panel-dark">
			...
			<div class="table-responsive">
				<table class="table table-striped">
					<caption class="text text-danger"> * Upload PDF File Only</caption>
					<thead class="bg-trans-dark text-dark">
						<tr>
					...
					<tbody>
						...
						# Id Proof
						if($water_conn_dtl['connection_through_id']!=6)
						{
							?>
							<tr>
								<td>
									<strong>Last Payment Receipt of Holding Tax&nbsp;</strong>
								</td>
								<td>
									...
									{ 
										?>
										<a href="<?=base_url();?>/getImageLink.php?path=<?=$payment_receipt_doc['document_path'];?>" target="_blank" > <img id="imageresource" src="<?=base_url();?>/public/assets/img/pdf_logo.png" style="width: 40px; height: 40px;"></a>
										<?php 
									} 
									?>
								</td>
						...
						<tr>
							...
							<td>
								<?php 
								if($address_prf_doc["document_path"]=="")
								{
									?>
									N/A
									<?php 
								...
								{
									?>
									<a href="<?=base_url();?>/getImageLink.php?path=<?=$address_prf_doc['document_path'];?>" target="_blank" > <img id="imageresource" src="<?=base_url();?>/public/assets/img/pdf_logo.png" style="width: 40px; height: 40px;"></a>
									<?php 
								}
								?>
							</td>
						...
						<tr>
							<td>
								<strong>Upload Connection Form&nbsp;</strong> 
							</td>
							<td>
								<?php 
								if($connection_form_doc["document_path"]=="")
								{
									?>
									N/A
									<?php 
								...
								{
									?>
									<a href="<?=base_url();?>/getImageLink.php?path=<?=$connection_form_doc['document_path'];?>" target="_blank" > <img id="imageresource" src="<?=base_url();?>/public/assets/img/pdf_logo.png" style="width: 40px; height: 40px;"></a>
									<?php 
								}
								?>
							</td>
						...
						<tr>
							<td>
								<strong>Upload electricity bill &nbsp;</strong> 
							</td>
							<td>
								<?php 
								if($electricity_bill_doc["document_path"]=="")
								{
									 ?>
									N/A
									<?php 
								...
								{ 
									?>
									<a href="<?=base_url();?>/getImageLink.php?path=<?=$electricity_bill_doc['document_path'];?>" target="_blank" > <img id="imageresource" src="<?=base_url();?>/public/assets/img/pdf_logo.png" style="width: 40px; height: 40px;"></a>
									<?php 
								} 
								?>
							</td>
						...
						<?php
							//if($water_conn_dtl['connection_type_id']==2)
							{
								...
								<tr>
									<td>
										<strong>Upload Meter Bill  &nbsp;</strong> 
									</td>
									<td>
										<?php 
										if($meter_bill_doc["document_path"]=="")
										{ 
											?>
											N/A
											<?php 
										...
										{ 
											?>
											<a href="<?=base_url();?>/getImageLink.php?path=<?=$meter_bill_doc['document_path'];?>" target="_blank" > <img id="imageresource" src="<?=base_url();?>/public/assets/img/pdf_logo.png" style="width: 40px; height: 40px;"></a>
											<?php 
										} 
										?>
									</td>
						...
						<tr>
							<td>
								<strong>Upload BPL Document  &nbsp;</strong> 
							</td>
							<td>
								<?php if($bpl_doc["document_path"]==""){ ?>
									N/A
								<?php } else { ?>
									<a href="<?=base_url();?>/getImageLink.php?path=<?=$bpl_doc['document_path'];?>" target="_blank" > <img id="imageresource" src="<?=base_url();?>/public/assets/img/pdf_logo.png" style="width: 40px; height: 40px;"></a>
								<?php } ?>
							</td>
							<td>
								<?php
			...
			<div class="modal-body">
				...
				<div class="table-responsive">
					<table class="table table-bordered table-hover" >
                        <tr>
							<td>Last Payment Receipt of Holding Tax </td>
                            </tr>
                        <tr>
				...
				<div class="table-responsive">
					<table class="table table-bordered table-hover" >
                        ...
                        <tr>
							...
							<td colspan="3">
                                <select id="owner_doc_mstr_id" name="owner_doc_mstr_id" class="form-control">
                                     ...
                                     <?php
                                        ...
                                        {
                                           foreach($photo_id_proof_document_list as $photo_proof_details)
                                           {
                                                ?>
                            ...
                            <td colspan="4">
                            	<input type="file" name="photo_id_proof_doc_path" id="photo_id_proof_doc_path" class="form-control" accept=".pdf" />
                            	&nbsp;&nbsp;&nbsp;<span class="text text-danger"> Upload PDF File</span>
                            </td>
						</tr>
						<tr>
...
<?php
	if($connection_dtls['doc_status']==1)
	{
	?>
		<div class="panel panel-bordered panel-dark text-center">
			<div class="panel-body">
				<a href="<?php echo base_url('WaterPaymentCitizen/payment/'.md5($connection_dtls['id']));?>"><button class="btn btn-success"  name="submit" value="proceed_payment">Proceed to Payment</button></a>
