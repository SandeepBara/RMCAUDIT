...
class WaterApplyNewConnectionCitizen extends HomeController
{
    ...
    public function __construct()
    {
        ...
        $this->user=new model_user_hierarchy($this->dbSystem);
        $this->water_property_details_model=new WaterViewPropertyDetailModel($this->db);
  ...
  /*  public function index()
    {
        ...
        $data=array();
        helper(['form']);
       // $m=$this->user->get_project_manager_by_user('eccbc87e4b5ce2fe28308fd9f2a7baf3');
        ...
        if($this->request->getMethod()=='post')
        {
            if($this->request->getVar('id')=="")
            {
             ...
             /*   $rules=[
                    ...
                    'pipeline_type_id' =>'required|numeric',
                    'category' =>'required|alpha',
                    'ward_id' =>'required|numeric',
                    
                    'area_in_sqft' =>'required|numeric',
                    'address' =>'required',
                    'landmark' =>'required|alpha',
             ...
             /* $count_prop=$this->apply_wtrconn_model->check_saf_exists($data['prop_id']);
              ...
              $count_saf=$count_saf['count_saf'];
               ...
               /*if($inputs['email_id'])
                ...
                $apply_water_conn['apply_from']='Citizen';
    ...
    public function validate_holding_no()
    {
        ...
        if($this->request->getMethod()=="post")
        {
           ...
           $holding_no=$inputs['holding_no'];
            ...
            if ($count = $this->water_property_details_model->chkholding_exist($holding_no)){
    ...
    public function getdistrictname()
    {
        ...
        if($this->request->getMethod()=="post")
        {
          ...
          // $state_id=$inputs['state_id'];  
           ...
           $statedet = $this->state_model->getstateid($state_name);

            $state_id=$statedet['id'];  

            $count = $this->district_model->getdistrictbystateid($state_id);
