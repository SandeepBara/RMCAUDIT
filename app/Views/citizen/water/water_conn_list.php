						...
						<div id="page-content">
					        <div class="panel panel-bordered panel-dark">
					            <div class="panel-heading">
					                <h5 class="panel-title">Water Connection List</h5>
					            </div>
                                <div class="panel-body">
									<form class="form-horizontal" method="post" action="<?php echo base_url('waterdocument/index');?>">
										<div class="form-group">
											<div class="col-md-3">
												<label class="control-label" for="from_date"><b>From Date</b> <span class="text-danger">*</span></label>
												<div class="input-group date">
													<input type="date" id="from_date" name="from_date" class="form-control mask_date" placeholder="From Date" value="<?=(isset($from_date))?$from_date:date('Y-m-d');?>" readonly>
												</div>
											</div>
											<div class="col-md-3">
												<label class="control-label" for="to_date"><b>To Date</b> <span class="text-danger">*</span></label>
												<div class="input-group date">
													<input type="date" id="to_date" name="to_date" class="form-control mask_date" placeholder="To Date" value="<?=(isset($to_date))?$to_date:date('Y-m-d');?>" readonly>
												</div>
											</div>
											<div class="col-md-3">
                                    ...
                                    <div class="table-responsive">
										...
										?>
												<tr>
													...
													<td>
														<a class="btn btn-primary" href="<?php echo base_url('waterdocument/view/'.md5($value['id']));?>" role="button">View</a>
													</td>
												</tr>
											<?php endforeach;?>
											<?php endif;  ?>
