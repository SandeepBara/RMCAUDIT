...
<div id="content-container">
    ...
    <div id="page-content">
        ...
        if (isset($_SESSION['msg'])) { ?>
            <p class="bg bg-danger form-control text-center"><?php echo $_SESSION['msg'];
                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-md-3 pad-btm">
                            <select id="connection_type_id" name="connection_type_id" class="form-control" <?=isset($connection_type_id) ? 'redonly disabled' :'' ;?>>
                                ...
                                if ($conn_type_list) 
                                {
                                    foreach ($conn_type_list as $val) 
                                    {
                                        ...
                                        <option value="<?php echo $val['id']; ?>" <?php if (isset($connection_type_id) && $connection_type_id == $val['id']) {
                                                                                        echo "selected";
                        ...
                        <div class="col-md-3 pad-btm">
                            <select name="conn_through_id" id="conn_through_id" class="form-control" onchange="show_hide_holding_box(this.value)">
                                ...
                                if ($conn_through_list) 
                                {
                                    ...
                                    ?>
                                            <option value="<?php echo $val['id']; ?>" <?php if (isset($conn_through_id) && $conn_through_id == $val['id']) {
                                                                                            echo "selected";
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 pad-btm">
                            <select name="property_type_id" id="property_type_id" class="form-control" onchange="show_flat_count(this.value);show_category(this.value);">
                                ...
                                ?>
                                        ...
                                        <option value="<?php echo $val['id']; ?>" <?php if (isset($property_type_id) && $property_type_id == $val['id']) {
                                                                                        echo "selected";
                        ...
                        <div class="col-md-3 pad-btm">
                            <select name="owner_type" id="owner_type" class="form-control" onchange="validate_saf(),validate_holding()">
                                <option value="">SELECT</option>
                                <option value="OWNER" <?php if (isset($owner_type) && $owner_type == 'OWNER') {
                                                            echo "selected";
                                                        } ?>>OWNER</option>
                                <option value="TENANT" <?php if (isset($owner_type) && $owner_type == 'TENANT') {
                                                            echo "selected";
                                                        } ?>>TENANT</option>
                            </select>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div id="category_block" style="display: none;">
                            ...
                            <div class="col-md-3 pad-btm">
                                <select name="category" id="category" class="form-control" <?=session()->get('apply_from')=='swsc'?"readonly":""?>>
                                    <option value="">SELECT</option>
                                    <option value="APL" <?php if (isset($category) && $category == 'APL') {
                                                            echo "selected";
                                                        } ?>>APL</option>
                                    <option value="BPL" <?php if (isset($owner_type) && $category == 'BPL') {
                                                            echo "selected";
                                                        } ?>>BPL</option>
                                </select>
                            </div>
                                ...
                                <select name="pipeline_type_id" id="pipeline_type_id" class="form-control">
                                    ...
                                    if ($pipeline_type_list) 
                                    {
                                        foreach ($pipeline_type_list as $val) 
                                        {
                                            ...
                                            <option value="<?php echo $val['id']; ?>" <?php if (isset($pipeline_type_id) && $pipeline_type_id == $val['id']) {
                                                                                            echo "selected";
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10 pad-btm">
                            <textarea name="address" id="address" class="form-control" onkeypress="return isAlphaNum(event);"><?php echo isset($address) ? trim($address) : ""; ?></textarea>
                        </div>
                    </div>
                ...
                <div class="panel-body table-responsive">
                    <table class="table table-bordered" style="font-family:Arial, Helvetica, sans-serif; font-size:12px;">
                        ...
                        { 
                            ...
                            <tbody id="owner_dtl">
                                <tr>
                                    <td><input type="text" name="owner_name[]" id="owner_name1" class="form-control" onkeypress="return isAlpha(event);" placeholder="Owner Name" value="<?= isset($firstName) || isset($lastName) ? ($firstName . ' ' . $lastName) : '' ?>" <?= isset($firstName) || isset($lastName) ? 'readonly' : '' ?>></td>
                                    <td><input type="text" name="guardian_name[]" id="guardian_name1" class="form-control" onkeypress="return isAlpha(event);" placeholder="Guardian Name" value="<?= isset($guardian_name) ? $guardian_name : '' ?>" <?= isset($guardian_name)  ? 'readonly' : '' ?>></td>
                                    <td><input type="text" name="mobile_no[]" id="mobile_no1" class="form-control" maxlength=10 minlength=10 onkeypress="return isNum(event);" placeholder="Mobile No." value="<?= isset($mobile) ? ($mobile) : '' ?>" <?= isset($mobile)  ? 'readonly' : '' ?>></td>
                                    <td><input type="email" name="email_id[]" id="email_id1" class="form-control" placeholder="Email ID" value="<?= isset($email) ? ($email) : '' ?>" <?= isset($email)  ? 'readonly' : '' ?>></td>
                                    <input type="hidden" name="count" id="count" value="1">
                                    <td onclick="add_owner()" colspan="2" class="add_owner"><i class="form-control fa fa-plus-square" style="cursor: pointer;"></i></td>
                                </tr>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2 pad-btm">
                                <input type="radio" name="elec_category" value="Residential - DS I/II" <?php if ($elec_category ?? null == 'RESIDENTIAL - DS I/II') {
                                                                                                            echo "checked";
                                                                                                        } ?>> Residential - DS I/II
                            </div>
                            <div class="col-md-2 pad-btm">
                                <input type="radio" name="elec_category" value="Commercial - NDS II/III" <?php if ($elec_category ?? null == 'COMMERCIAL - NDS II/III') {
                                                                                                                echo "checked";
                                                                                                            } ?>> Commercial - NDS II/III
                            </div>
                            <div class="col-md-2 pad-btm">
                                <input type="radio" name="elec_category" value="Agriculture - IS I/II" <?php if ($elec_category ?? null == 'AGRICULTURE - IS I/II') {
                                                                                                            echo "checked";
                                                                                                        } ?>>Agriculture - IS I/II
                            </div>
                            <div class="col-md-2 pad-btm">
                                <input type="radio" name="elec_category" value="Low Tension - LTS" <?php if ($elec_category ?? null == 'LOW TENSION - LTS') {
                                                                                                        echo "checked";
                                                                                                    } ?>>Low Tension - LTS
                            </div>
                            <div class="col-md-2 pad-btm">
                                <input type="radio" name="elec_category" value="High Tension - HTS" <?php if ($elec_category ?? null == 'HIGH TENSION - HTS') {
                                                                                                        echo "checked";
                                                                                                    } ?>>High Tension - HTS
                            </div>
                        </div>
                        ...
                        for (var k in data.dd) 
                        {
                            ...
                            else 
                            {
                                if (owner_type == 'OWNER') 
                                {
                                    ...
                                    tbody += '<td><input type="text" name="owner_name[]" id="owner_name'+(parseInt(count)+i)+'" class="form-control" onkeypress="return isAlpha(event);" value="' + data.dd[k]['owner_name'] + '" readonly  placeholder="Owner Name" /></td>';
                                    tbody += '<td><input type="text" name="guardian_name[]" id="guardian_name'+(parseInt(count)+i)+'" class="form-control" onkeypress="return isAlpha(event);" value="' + data.dd[k]['guardian_name'] + '" '+ (data.dd[k]['guardian_name']!=""?'readonly':"")+'  placeholder="Guardian Name" /></td>';
                                    tbody += '<td><input type="text" name="mobile_no[]" id="mobile_no'+(parseInt(count)+i)+'" class="form-control" onkeypress="return isNum(event);" value="' + data.dd[k]['mobile_no'] + '"  maxlength="10" minlength="10"  placeholder="Mobile No." /></td>';
                                    tbody += '<td><input type="email" name="email_id[]" id="email_id'+(parseInt(count)+i)+'" class="form-control" " value="' + data.dd[k]['email'] + '"  placeholder="Email ID" /></td>';
                                    tbody += "</tr>";
                                    i++;
                                } 
                                else 
                            ...
                            $("#owner_dtl").append(tbody);
                            console.log($("#owner_dtl"));
