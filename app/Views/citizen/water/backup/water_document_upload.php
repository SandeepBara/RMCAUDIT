							...
							?>
								...
								?>
									<tr>
										<td>
											<?php
											if(empty($value['applicant_detail_id'])):
											?>
		...
		<div class="panel panel-bordered panel-dark">
			...
			<div class="table-responsive">
				<table class="table table-striped">
					...
					<tbody>
						<?php
						if($water_conn_dtl['connection_through_id']==2)
						{
			...
			<div class="modal-body">
				...
				<div class="table-responsive">
					<table class="table table-bordered table-hover" >
                        ...
                        <tr>
                            <td><input type="file" name="last_payment_doc_path" id="last_payment_doc_path" class="form-control" accept=".jpg,.jpeg,.png"/></td>
						</tr>
					</table>
				</div>
			...
			<div class="modal-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover" >
                            ...
                            <tr>
                                <td><input type="file" name="address_proof_doc_path" id="address_proof_doc_path" class="form-control" accept=".jpg,.jpeg,.png"/></td>
                            </tr>
                        </table>
                    </div>
			...
			<div class="modal-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover" >
                            ...
                            <tr>
                                <td><input type="file" name="connection_form_doc_path" id="connection_form_doc_path" class="form-control" accept=".jpg,.jpeg,.png"/></td>
                            </tr>
                        </table>
                    </div>
			...
			<div class="modal-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover" >
                            ...
                            <tr>
                                <td><input type="file" name="electricity_bill_doc_path" id="electricity_bill_doc_path" class="form-control" accept=".jpg"/></td>
                            </tr>
                        </table>
                    </div>
			...
			<div class="modal-body">
				...
				<div class="table-responsive">
					<table class="table table-bordered table-hover" >
                        ...
                        <tr>
                            <td><input type="file" name="meter_bill_doc_path" id="meter_bill_doc_path" class="form-control" accept=".jpg,.jpeg,.png"/></td>
						</tr>
					</table>
				</div>
			...
			<div class="modal-body">
				...
				<div class="table-responsive">
					<table class="table table-bordered table-hover" >
                        ...
                        <tr>
                            <td><input type="file" name="bpl_doc_path" id="bpl_doc_path" class="form-control" accept=".jpg,.jpeg,.png"/></td>
						</tr>
					</table>
				</div>
				...
				<div class="table-responsive">
					<table class="table table-bordered table-hover" >
                        ...
                        <tr>
                            ...
                            <td colspan="4"><input type="file" name="photo_id_proof_doc_path" id="photo_id_proof_doc_path" class="form-control" accept=".png,.jpg,.jpeg" /></td>
						</tr>
						<tr>
