				...
				<div class="panel-body text-center">
                   ...
                   <input type="hidden" name="consumer_id" id="consumer_id" value="<?php echo $consumer_id; ?>">
                    ...
                    <div class="col-md-3">
                        ...
                        <a href="<?php echo base_url('WaterApplyNewConnectionCitizen/water_connection_view/'.md5($consumer_details['apply_connection_id']));?>" class="btn btn-info">View Application</a>

                    </div>
                   
                    <div class="col-md-3">

                        <a href="<?php echo base_url('WaterViewConsumerDueDetailsCitizen/index/'.md5($consumer_details['id']));?>" class="btn btn-warning">View Dues</a>
