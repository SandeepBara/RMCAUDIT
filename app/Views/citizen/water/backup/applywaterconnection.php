			...
			<div class="panel panel-bordered panel-dark">
                ...
                <div class="panel-body">
					...
					<div class="row">
						...
						<div class="col-md-3 pad-btm">
                        	<input type="text" name="area_in_sqft" id="area_in_sqft" class="form-control"  value="<?php echo isset($area_in_sqft)?$area_in_sqft:""; ?>"  onkeypress="return isNum(event);" placeholder="Enter Total Area in Sqft" onblur="validate_area(this.value)">
						</div>
...
<script type="text/javascript">
  ...
  /*$("#btn_review").click(function(){
	...
	*/
	...
	function validate_area(str)
	{
		var area=str;
		if(area==0)
		{
			alert("Area can not be 0");
			$("#area_in_sqft").val("");
     ...
     $( document ).ready(function() {
	    ...
	    show_hide_holding_box(conn_through_id);
    ...
    {      
       ...
       // alert(cnt);
          ...
          $.ajax({
            type:"POST",
            url: '<?php echo base_url("WaterApplyNewConnectionCitizen/getdistrictname");?>',
            dataType: "json",
            data: {
                    "state_name":str
            },
