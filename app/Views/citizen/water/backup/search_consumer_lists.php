					...
					<form class="form-horizontal" id="myform" method="post" >
						<div class="form-group">
							...
							<div class="col-md-4">
								 ...
								 <input type="text" name="keyword" id="keyword" class="form-control" value="<?php echo $keyword; ?>" style="text-transform:uppercase" placeholder="Enter Owner Name or Mobile No. or Consumer No.">
							</div>
							<div class="col-md-2">
