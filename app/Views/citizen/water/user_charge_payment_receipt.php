				...
				<!-- ======= Cta Section ======= -->
							<div class="panel panel-bordered panel-dark">
								...
								<br><br>
										...
										<tbody>
                                            ...
                                            Account Description : Water User Charge</td>
												<td>
													...
													<div >Application No : <b><?=$consumer_details["consumer_no"];?></div>
												</td>
											</tr>
									...
									<table width="100%" border="0">
										<tbody>
											<tr>
												<td>Received From Mr. / Ms. /Mss. : 
													...
													<span style="font-size: 14px; font-weight: bold">
														<?=$consumer_owner_details["applicant_name"];?>
													</span>
													<?php //endforeach; ?>
												</td>
											</tr>
											<tr>
												<td>Mobile No. : 
													<span style="font-size: 14px; font-weight: bold">
														<?=$consumer_owner_details["mobile_no"];?>
													</span>
												</td>
											</tr>
											<tr>
									...
									<div style="width: 99%; margin: auto; line-height: 35px; border-bottom: #000000 double 2px;"><strong style="font-size: 14px;">WATER USER CHARGE DETAILS </strong>
							...
							<div class="panel">
								<div class="panel-body text-center">
									...
									<?php
									if(isset($downloadReceipt))
									{
										?>
										<a href="<?php echo base_url("CitizenProperty/index/".md5($consumer_details['prop_dtl_id']));?>" class="btn btn-info">Go to holding</a>
										<?php
									}
									?>
								</div>
...
if(isset($downloadReceipt))
{
	?>
	<script>
		// code for download payment receipt
	</script>
	<?php
}
?>
