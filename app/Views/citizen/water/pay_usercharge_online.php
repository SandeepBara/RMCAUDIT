<html>
    <head>
        <title>Water User Charge | Online Payment</title>
...
{		
    ...
    var options = {
        ...
        "handler": function (response)
        {
            ...
            window.location.href="<?=base_url("WaterUserChargeProceedPaymentCitizen/proceed_payment/$pg_mas_id");?>/"+razorpay_payment_id+'/'+razorpay_order_id+'/'+razorpay_signature+'/'+<?=$downloadReceipt;?>;
        },
        "prefill": {
            "name": "<?=$owner_name?>",
            "email": "<?=$email_id?>",
    ...
    rzp1.on('payment.failed', function (response){
            ...
            */
            ...
            window.location.href = "<?php echo base_url("WaterUserChargeProceedPaymentCitizen/paymentFailed/$pg_mas_id")?>/"+razorpay_payment_id+'/'+razorpay_order_id+'/'+error_code+'/'+error_desc+'/'+error_source+'/'+error_step+'/'+error_reason;
    });
