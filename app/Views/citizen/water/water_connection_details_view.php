				...
				<div class="panel-body text-center">
                 ...
                 /* if($consumer_details['payment_status']==0)
                  ...
                  //echo $consumer_details['doc_status'];
                    ...
                    {
                        ?>
                        <a onClick="myPopup('<?=base_url('citizenPaymentReceipt/view_memo/'.md5($consumer_details['id']).'/'.$ulb_id);?>','xtf','900','700');" class="btn btn-primary">
                        View Memo
                        </a>
                        <?php
                    }
                    ...
                    if($consumer_details['payment_status']==1)
                    {
                        ?>
                        <div class="col-md-3">
