					...
					<form class="form-horizontal" id="myform" method="post" >
						<div class="form-group">
							...
							<div class="col-md-4">
								 ...
								 <input type="text" name="keyword" id="keyword" class="form-control" value="<?php echo $keyword; ?>" style="text-transform:uppercase" placeholder="Enter Owner Name or Mobile No. or <?=isset($type) && $type==2 ?'Consumer':'Application'?> No.">
							</div>
							<div class="col-md-2">
					...
					<table id="demo_dt_basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
						<thead class="bg-trans-dark text-dark">
							<tr>
								<th>S. No.</th>   
								<th>Ward No.</th>   
								<th><?=isset($type) && $type==2 ?'Consumer':'Application'?> No.</th>
								<th>Category</th>
