                        ...
                        <div class="col-md-3 pad-btm">
                            <select id="connection_type_id" name="connection_type_id" class="form-control">
                                <option value="">SELECT</option>
                             	...
                             	<option value="<?php echo $val['id'];?>" <?php if($connection_type_id ??FALSE &&$connection_type_id==$val['id']){echo "selected";}?>><?php echo $val['connection_type'];?></option>
                             	<?php		
                             		}
                             	}
                             	?>
							...
							<select name="conn_through_id" id="conn_through_id" class="form-control" onchange="show_hide_holding_box(this.value)">
								...
								if($conn_through_list)
								{
									foreach($conn_through_list as $val)
									{
										...
										?>
										<option value="<?php echo $val['id'];?>" <?php if($conn_through_id?? false && $conn_through_id==$val['id']){echo "selected"; }?>><?php echo $val['connection_through'];?></option>
										<?php
									}
								}
								?>
					...
					<div class="row">
                        ...
                        <div class="col-md-3 pad-btm">
							<select name="property_type_id" id="property_type_id" class="form-control" onchange="show_flat_count(this.value);show_category(this.value);">
								...
								<option value="<?php echo $val['id'];?>" <?php if($property_type_id??false && $property_type_id==$val['id']){ echo "selected";}?>><?php echo $val['property_type'];?></option>
						...
						<div class="col-md-3 pad-btm">
							<select name="owner_type" id="owner_type" class="form-control" onchange="validate_saf(),validate_holding()">
								<option value="">SELECT</option>
								<option value="OWNER" <?php if($owner_type??false && $owner_type=='OWNER'){ echo "selected"; }?>>OWNER</option>
								<option value="TENANT" <?php if($owner_type??false && $owner_type=='TENANT'){ echo "selected"; }?>>TENANT</option>
							</select>
						</div>
					...
					<div class="row">
						...
						<div id="category_block" style="display: none;">
							...
							<div class="col-md-3 pad-btm">
								<select name="category" id="category" class="form-control">
									<option value="">SELECT</option>
									<option value="APL" <?php if($category??false && $category=='APL'){ echo "selected"; }?>>APL</option>
									<option value="BPL" <?php if($category??false && $category=='BPL'){ echo "selected"; }?>>BPL</option>
								</select>
							</div>
						</div>
                        ...
                        <div class="col-md-3 pad-btm">
							<select name="pipeline_type_id" id="pipeline_type_id" class="form-control">
								...
								<option value="<?php echo $val['id'];?>" <?php if($pipeline_type_id??false && $pipeline_type_id==$val['id']){echo "selected";}?>><?php echo $val['pipeline_type'];?></option>
					...
					<div class="row">
						...
						<div class="col-md-3 pad-btm">
							<select name="holding_exists" id="holding_exists" class="form-control" onchange="show_hide_saf_holding_box(this.value)">
								<option value="">SELECT</option>
								<option value="YES" <?php if( $holding_exists??false && $holding_exists=='YES'){echo "selected"; }?>>Yes</option>
								<option value="NO" <?php if($holding_exists??false && $holding_exists=='NO'){echo "selected"; }?>>No</option>
							</select>
                       </div>-->
...
<script type="text/javascript">
    ...
    function validate_holding()
    {
		...
		var owner_type=
        var conn_through_id= $("#conn_through_id").val();
		if(owner_type == "" || owner_type == "")
		{
			alert('Please Select Owner Type');
			return false;
		}
		if(holding_no.length != 15 && conn_through_id==1)
		{
