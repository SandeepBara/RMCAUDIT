...
<link href="<?=base_url();?>/public/assets/plugins/bootstrap-validator/bootstrapValidator.min.css" rel="stylesheet">
<style type="text/css">
    .error {
        color: red;
    }
    ...
    <div id="page-content">
            ...
            <div class="panel panel-bordered panel-dark">
                <div class="panel-heading">
                    <h3 class="panel-title">Self Assessment Form - <?=$assessmentType;?></h3>
                </div>
                <div class="panel-body">
                    ...
                    <!-- Form wizard with Validation -->
                        ...
                        <div id="demo-bv-wz">
                            ...
                            <!--Form-->
                            <form id="demo-bv-wz-form" class="form-horizontal bv-form" name="demo-bv-wz-form" method="post" action="<?=base_url("CitizenSaf/AddUpdate/$param");?>" novalidate="novalidate">
                                <div class="panel-body">
                                    <div class="tab-content">
                                        ...
                                        <div id="demo-bv-tab1" class="tab-pane">
                                            ...
                                            <div class="<?=(isset($assessmentType))?($assessmentType=="")?"hidden":"":"";?>">
                                                <div class="row">
                                                    <label class="col-md-3">Is the Applicant tax payer for the mentioned holding? Is owner(s) have been changed. <span class="text-danger">*</span></label>
                                                    <div class="col-md-3 pad-btm">
                                                        <?php if ($assessmentType=="") { ?>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3 pad-btm">
                                                    <select id="ward_mstr_id" name="ward_mstr_id" class="form-control" data-bv-field="ward_mstr_id">
                                                        <option value="">== SELECT ==</option>
                                                        <?php
                                                        if(isset($wardList))
                                                        {
                                        ...
                                        if ($assessmentType!="" && isset($prop_owner_dtl_list))
                                        {
                                            ?>
                                            <div class="panel panel-bordered panel-dark">
                                                <div class="panel-heading">
                                        ...
                                        ?>
                                            <div class="panel panel-bordered panel-dark <?=(isset($assessmentType) && $assessmentType=="Re-Assessment")?"hidden":NULL;?>">
                                                <div class="panel-heading">
                                        ...
                                        <!--Fourth tab-->
                                        <div id="demo-bv-tab4" class="tab-pane  mar-btm">
                                            <div class="panel panel-bordered panel-dark">
                                                <div class="panel-heading">
                                ...
                                <div class="panel text-center">
                                    <div class="box-inline">
                                        ...
                                        <button type="submit" class="finish btn btn-warning" id="btn_review" name="btn_review" disabled>SUBMIT</button>
                                    </div>
                                </div>
...
$(document).ready(function() {
    ...
    $('#btn_review').click(function()
    {
		...
		if ($("#prop_type_mstr_id").val()==3 ) { //FLATS / UNIT IN MULTI STORIED BUILDING
        ...
        if ($("#prop_type_mstr_id").val()!=4 )//vacant land
        {
    ...
    <!-- <script src="<?=base_url();?>/public/assets/js/demo/nifty-demo.min.js"></script> -->

    
    <!--Bootstrap Wizard [ OPTIONAL ]-->
    <script src="<?=base_url();?>/public/assets/plugins/bootstrap-wizard/jquery.bootstrap.wizard.min.js"></script>


    <!--Bootstrap Validator [ OPTIONAL ]-->
    <script src="<?=base_url();?>/public/assets/plugins/bootstrap-validator/bootstrapValidator.min.js"></script>


    <!--Form Wizard [ SAMPLE ]-->
    <script src="<?=base_url();?>/public/assets/js/demo/form-wizard.js"></script>
