	...
	<div id="page-content">
				...
				<table class="table table-bordered" style="font-family:Arial, Helvetica, sans-serif; font-size:12px;">
					...
					<tbody>
						...
						<tr>
							...
							<td>Quarter : <?php echo $tax_list['qtr']; ?> / Year : <?php echo $tax_list['fyear']; ?></td>
		...
		<div class="panel">
			<div class="panel-body text-center">
				<?php
				if($basic_details['doc_upload_status']=='0')
					{ 
				?>
				<a href="<?php echo base_url('CitizenSaf/documentUpload/'.$id);?>" type="button" class="btn btn-purple btn-labeled">Document Upload</a>
				<?php
				}
				else
				{ 
				?>
				<a href="<?php echo base_url('CitizenSaf/documentView/'.$id);?>" type="button" class="btn btn-purple btn-labeled">Document Upload View</a>
				<?php
				}
				?>
			</div>
