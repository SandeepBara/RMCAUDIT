                ...
                <div class="panel-body">
                    <div class="fixed-fluid">
						...
						<div class="col-md-12">
							...
							<div class="panel panel-bordered panel-dark" id="printpage" name="printpage">
								...
								<div class="panel-body">
									...
									if($verification_data['prop_type_mstr_id']!=4)
									{
										...
										if(isset($ExtraFloorAddedByTC, $ExtraFloorAddedByTC))
										{
											?>
											<div class="row">
												<div class="col-sm-12 text-danger text-bold">
													...
													<div class="table-responsive">
														<table class="table table-bordered text-sm">
															...
															foreach($ExtraFloorAddedByTC as $new_floor)
															{
																?>
																<tr>
																	<td><?=$assessed_floor['floor_name'];?></td>
													...
													<table class="table table-bordered text-sm">
														...
														foreach($safGeoTaggingDtl as $geoTaggingDtl)
														{
															...
															<tr>
																...
																<td><a target="_blank" onclick="window.open('<?=base_url();?>/writable/uploads/<?=$geoTaggingDtl['image_path'];?>', 'newwindow', 'width=700, height=700'); return false;" href="javascript: void(0)" class="btn btn-primary btn-sm">View image</a></td>
