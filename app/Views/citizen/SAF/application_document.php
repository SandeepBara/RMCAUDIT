									...
									<div class="panel-body" style="padding-bottom: 0px;">
										<div class="row">
											<div class="col-md-12">
                                                ...
                                                if($is_specially_abledflag=in_array('t',array_column($saf_owner_detail,'is_specially_abled'))){ ?>
                                                 <th>Specially Abled Certificate</th>
                                                <?php  } } ?>
                                                <?php if(isset($is_armed_force)) {
                                                if($is_armed_doc_dtlflag=in_array('t',array_column($saf_owner_detail,'is_armed_force'))){ ?>
                                                ...
                                                if($owner_detail['is_specially_abled']!='f'){ ?>
												  ...
												  ?>
													...
													<?php }else{
                                                    if($is_specially_abledflag=='t'){ echo '<td></td>'; }
                                                }
