			...
			<div id="page-content">
						...
						<div class="panel panel-bordered panel-dark">						
							<div class="panel-heading">
								<div class="panel-control">
									<a href="<?php echo base_url('safDemandPayment/saf_Property_Tax');?>" class="btn btn-default">Back</a>
								</div>
						...
						<div class="panel">
							<div class="panel-body text-center" style="height:70px;">
								<a href="<?php echo base_url('CitizenPropertySAF/citizen_saf_property_details/'.$id);?>" type="button" class="btn btn-primary btn-labeled"><i class="fa fa-eye" aria-hidden="true"></i> View Property</a>
