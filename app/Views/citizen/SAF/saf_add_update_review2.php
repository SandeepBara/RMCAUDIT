...
<div id="content-container" style="padding-top: 10px;">
    <!--Page content-->
    <div id="page-content">
        <form method="post" id="form_saf_property" name="form_saf_property" action="<?=base_url('CitizenSaf2/addUpdate');?><?=(isset($param))?"/".$param:"";?>">
            ...
            <!-- <input type="hidden" name="appartment_name" value="<?=isset($appartment_name)?$appartment_name:"";?>" /> -->
            ...
            <input type="hidden" name="is_school_trust" value="<?=$is_school_trust;?>" />
            ...
            <div class="panel panel-bordered panel-dark">
                ...
                <div class="panel-body">
                    ...
                    <div class="<?=(isset($prop_type_mstr_id))?(($prop_type_mstr_id!=3)?"hidden":""):"";?>">
                        <div class="row">
                            <label class="col-md-3">Appartment</label>
                            <div class="col-md-3 pad-btm">
                                <?=(isset($apartment_details_data['apartment_name']))?$apartment_details_data['apartment_name']:"";?> ( <?=(isset($apartment_details_data['apt_code']))?$apartment_details_data['apt_code']:"";?>)
                            </div>
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php if($prev_gender[$i]!=""){?>
                                                    <?=($prev_gender[$i]=="Male")?"Male":"";?>
                                                    <?=($prev_gender[$i]=="Female")?"Female":"";?>
                                                    <?=($prev_gender[$i]=="Other")?"Other":"";?>
                                                <?php }else{?>
                                                    N/A
                                                <?php }?>
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                <?=$prev_is_armed_force[$i]??"";?>
                                            </td>
                                            <td>
                                                <input type="hidden" name="prev_is_specially_abled[]" value="<?=$is_specially_abled[$i]??"";?>" />
        ...
        ?>
            ...
            <div class="panel panel-bordered panel-dark">
                ...
                <div class="panel-body" style="padding-bottom: 0px;">
                    ...
                    <div class="<?=(isset($no_electric_connection))?"hidden":"";?>">
                        <div class="row">
                            <label class="col-md-3">Electricity K. No</label>
                            <div class="col-md-3 pad-btm">
                                <?=(isset($elect_consumer_no) && $elect_consumer_no!="")?$elect_consumer_no:"N/A";?>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 pad-btm">
                                <?=(isset($elect_acc_no) && $elect_acc_no!="")?$elect_acc_no:"N/A";?>
                            </div>
                            <label class="col-md-3">BIND/BOOK No.</label>
                            <div class="col-md-3 pad-btm">
                                <?=(isset($elect_bind_book_no) && $elect_bind_book_no!="")?$elect_bind_book_no:"N/A";?>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-3 pad-btm">
                                ...
                                <?=(isset($elect_cons_category))?($elect_cons_category!='')?$elect_cons_category:"N/A":"N/A";?>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="panel panel-bordered panel-dark">
                ...
                <div class="panel-body" style="padding-bottom: 0px;">
                    <div class="row">
                        ...
                        <div class="col-md-3 pad-btm">
                            <?=(isset($building_plan_approval_no))?($building_plan_approval_no!="")?$building_plan_approval_no:"N/A":"N/A";?>
                        </div>
                        <label class="col-md-3">Building Plan Approval Date </label>
                        <div class="col-md-3 pad-btm">
                            <?=(isset($building_plan_approval_date))?($building_plan_approval_date!="")?$building_plan_approval_date:"N/A":"N/A";?>
                        </div>
                    </div>
                    <div class="row">
                        <label class="col-md-3">Water Consumer No. </label>
                        <div class="col-md-3 pad-btm">
                            <?=(isset($water_conn_no))?($water_conn_no!="")?$water_conn_no:"N/A":"N/A";?>
                        </div>
                        <label class="col-md-3">Water Connection Date</label>
                        <div class="col-md-3 pad-btm">
                            <?=(isset($water_conn_date))?($water_conn_date!="")?$water_conn_date:"N/A":"N/A";?>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 pad-btm">
                            <?=(isset($trade_license_no))?($trade_license_no!="")?$trade_license_no:"N/A":"N/A";?>
                        </div>
            ...
            <div class="panel panel-bordered panel-dark <?=(!isset($is_corr_add_differ))?"hidden":"";?>">
                ...
                <div class="panel-body" style="padding-bottom: 0px;">
                    <div class="row">
                        ...
                        <div class="col-md-7 pad-btm">
                            <?=(isset($corr_address))?$corr_address:"";?>
                        </div>
                    ...
                    <div class="row">
                        <label class="col-md-3">City</label>
                        <div class="col-md-3 pad-btm">
                            <?=(isset($corr_city))?$corr_city:"";?>
                        </div>
                        <label class="col-md-3">District</label>
                        <div class="col-md-3 pad-btm">
                            <?=(isset($corr_dist))?$corr_dist:"";?>
                        </div>
                    </div>
                    <div class="row">
                        <label class="col-md-3">State</label>
                        <div class="col-md-3 pad-btm">
                            <?=(isset($corr_state))?$corr_state:"";?>
                        </div>
                        <label class="col-md-3">Pin</label>
                        <div class="col-md-3 pad-btm">
                            <?=(isset($corr_pin_code))?$corr_pin_code:"";?>
                        </div>
                    </div>
                </div>
            </div>
...
Underground Storage Area (in Sq. Ft.)</label>
    ...
    ?>
            ...
            <div class="panel panel-bordered panel-dark">
                <div class="panel-heading">
                <h3 class="panel-title">Tax - As Per Current Rule (Effect From 01-04-2022 to 31-03-2024)</h3>
                </div>
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-12">
        ...
        ?>
                <div class="panel panel-bordered panel-dark">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <span class="text-danger"><b>Note </b></span> : Tax at the following rates are imposed on the calculated ARV as per old rule <br>
                            </div>
                            <div class="col-md-12 mar-lft">
                                (a) Holding tax 12.5% 
                            </div>
    ...
    ?>
            ...
            <?php } ?>
                <div class="panel panel-bordered panel-dark">
                    <div class="panel-heading">
                    <h3 class="panel-title">Capital Value - As Per Current Rule (Effect From 01-04-2022 to 31-03-2024)</h3>
                    </div>
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12 mar-lft">
                                Circle Rate : <a href="#" class="text-bold text-dark" onclick="window.open('<?=base_url();?>/citizen_calc_factr/citizengetCapitalValueRateFactor/<?= $old_ward ?>', 'newwindow', 'width=850, height=600'); return false;">Click here</a> to view circle rate.
                            </div>
                            <div class="col-md-12 mar-lft">
                                Occupancy Factor : <a href="#" class="text-bold text-dark" onclick="window.open('<?=base_url();?>/citizen_calc_factr/citizengetOccupancyFactor', 'newwindow', 'width=400, height=250'); return false;">Click here</a> here to view occupancy factors.
                            </div>
                        ...
                        <div class="row mar-btm">
                            <div class="col-md-12">
                                <b>Property Tax = Circle Rate X Buildup Area X Occupancy Factor X Tax Percentage X Calculation Factor X Matrix Factor Rate (<span class="text-danger text-xs">Only in case of 100% residential property</span>)</b>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                    ...
                                    <table class="table table-bordered text-sm">
                                        <thead class="bg-trans-dark text-dark">
                                            <tr>
                                                <th>#</th>
                                                <th>Effect From</th>
                                                <th style="width: 100px;">Property Tax (<span class="text-danger">Annual</span>)</th>
                                                <th>Holding Tax (<span class="text-danger">Quarterly</span>)</th>
                                                <th>RWH Penalty</th>
                                                <th>Quarterly Tax (<span class="text-danger">Total</span>)</th>
                ...
                <div class="panel panel-bordered panel-dark 24">
                    <div class="panel-heading">
                        <h3 class="panel-title">Capital Value - As Per Current Rule (Effect From 01-04-2024)</h3>
                    </div>
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12 mar-lft">
                                Circle Rate : <a href="#" class="text-bold text-dark" onclick="window.open('<?=base_url();?>/citizen_calc_factr/citizengetCapitalValueRateFactor24/<?= $new_ward ?>', 'newwindow', 'width=850, height=600'); return false;">Click here</a> to view circle rate.
                            </div>
                            <div class="col-md-12 mar-lft">
                                Occupancy Factor : <a href="#" class="text-bold text-dark" onclick="window.open('<?=base_url();?>/citizen_calc_factr/citizengetOccupancyFactor', 'newwindow', 'width=400, height=250'); return false;">Click here</a> here to view occupancy factors.
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="table-responsive">
                                    ...
                                    $sn = 0;
                                    foreach ($floorDtlArr as $key=>$taxDtl) { 
                                        if ($taxDtl["date_from"]."-01"<"2026-04-01" && $taxDtl["type"]=="floor") {
                                    ?>
                                            <tr>
                                                <td><?=++$sn;?></td>
                                                <td style="text-align: right;"><?=number_format($taxDtl['cv_2024_cal_method']['cvr'], 2);?></td>
                                                <td style="text-align: right;"><?=number_format($taxDtl['cv_2024_cal_method']['buildup_area'], 2);?></td>
                                                <td style="text-align: right;"><?=number_format($taxDtl['cv_2024_cal_method']['occupancy_rate'], 2);?></td>
                                                <td style="text-align: right;"><?=number_format($taxDtl['cv_2024_cal_method']['resi_comm_type_rate']*100, 3);?>%</td>
                                                <td style="text-align: right;"><?=number_format($taxDtl['cv_2024_cal_method']['calculation_factor'], 2);?></td>
                                                <td style="text-align: right;"><?=number_format($taxDtl['cv_2024_cal_method']['matrix_factor_rate'], 2);?></td>
                                                <td style="text-align: center;">Quarter : <?=($taxDtl["date_from"]."-01"<"2026-04-01")?1:$taxDtl['qtr'];?>   Financial Year : <?=($taxDtl["date_from"]."-01"<"2026-04-01")?"2024-2025":$taxDtl['fyear'];?> </td>
                                                <td style="text-align: right;"><?=number_format($taxDtl['cv24'], 2);?></td>
                                            </tr>
                                    <?php
                                        }
                                    }
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="table-responsive">
                                        ...
                                        <?php
                                        foreach ($floorDtlArr as $key=>$taxDtl) {
                                            if ($taxDtl["date_from"]."-01"<="2026-04-01" && $taxDtl["type"]!="floor" && $taxDtl["type"]!="vacant") {
                                        ?>
                                                <tr>
                                                    <td><?=$key+1;?></td>
                                                    <td><?=strtoupper($taxDtl['type']);?></td>
                                                    <td><?=$taxDtl['area_type'];?></td>
                                                    <td style="text-align: right;"><?=number_format($taxDtl["cv_2024_cal_method"]['cvr'], 2);?></td>
                                                    <td style="text-align: right;"><?=$taxDtl["cv_2024_cal_method"]['buildup_area'];?></td>

                                                    <td style="text-align: right;"><?=number_format($taxDtl["cv_2024_cal_method"]['occupancy_rate'], 2);?></td>
                                                    <td style="text-align: right;"><?=number_format($taxDtl["cv_2024_cal_method"]['resi_comm_type_rate']*100, 3);?>%</td>
                                                    <td style="text-align: right;"><?=number_format($taxDtl["cv_2024_cal_method"]['matrix_factor_rate'], 2);?></td>
                                                    <td style="text-align: center;">Quarter : <?=($taxDtl["date_from"]."-01">"2024-04-01")?1:$taxDtl['qtr'];?> Financial Year : <?=($taxDtl["date_from"]."-01"<"2026-04-01")?"2024-2025":$taxDtl['fyear'];?> </td>
                                                    <td style="text-align: right;"><?=number_format($taxDtl['cv24'], 2);?></td>
                                                </tr>
                                        <?php
                                            }
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="table-responsive">
                                    ...
                                    $sn = 0;
                                    foreach ($safTaxDtl as $taxDtl) {
                                        if($taxDtl['rule_type']=="CV_RULE2024"){
                                            if ($taxDtl['arv']<>0) {
                                    ?>
                                                <tr>
                                                    <td><?=++$sn;?></td>
    ...
    ?>
                ...
                <div class="panel-body demo-nifty-btn">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9 text-center">
                            ...
                            <button type="SUBMIT" id="btn_submit" name="btn_submit" value="submitt" class="btn btn-primary hidden" disabled>SUBMIT</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <input type="submit" id="form_submit" value="submit" hidden>
        </form>
