...
<div id="content-container" style="padding-top: 10px;">
    <!--Page content-->
    <div id="page-content">
        <form id="form_saf_property" name="form_saf_property" method="post" action="<?=base_url('CitizenSaf2/AddUpdate');?><?=(isset($param))?"/".$param:"";?>">
            <?php
            if(isset($validation)){
            ?>
            ...
            <div class="panel panel-bordered panel-dark">
                <div class="panel-heading">
                    <h3 class="panel-title">Self Assessment Form (<?=$assessment_type??""?>)</h3>
                </div>
                <div class="panel-body">
                    <div class="row">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <?php if ($is_owner_changed==1 || $prop_owner_dtl['gender']!="") { ?>
                                                ...
                                                <td>
                                                    <?php if ($is_owner_changed==1 || $prop_owner_dtl['dob']!="") { ?>
                                                        <?=$prop_owner_dtl['dob'];?>
                                                ...
                                                <td>
                                                    <?php if ($is_owner_changed==1 || $prop_owner_dtl['is_specially_abled']!="") { ?>
                                                ...
                                                <td>
                                                    <?php if ($is_owner_changed==1 || $prop_owner_dtl['is_armed_force']!="") { ?>
                    ...
                    <div class="panel panel-bordered-primary new_owner_dtl_panel">
                        <div class="panel-body"style="padding: 5px 10px;">
                            <div class="row">
                                ...
                                <div class="col-md-2 col-xs-6">
                                    <div class="form-group">
                                        <?php if ($gender[$i]=="Male") { echo "sssss"; };?>
                    ...
                    <div class="panel panel-bordered-primary new_owner_dtl_panel">
                        <div class="panel-body"style="padding: 5px 10px;">
                            <div class="row">
                                ...
                                <div class="col-md-2 col-xs-6">
                                    <div class="form-group">
                                        <label class="control-label">Guardian Name <span class="text-danger">*</span></label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 pad-btm">
                            <input type="text" id="trade_license_no" name="trade_license_no" class="form-control"
                                ...
                                value="<?= (isset($trade_license_no)) ? $trade_license_no : ""; ?>"
                                onkeypress="return isAlphaNum(event);" />
                        </div>
                    </div>
            ...
            <div class="panel panel-bordered panel-dark">
                ...
                <div class="panel-body" style="padding-bottom: 0px;">
                    <div class="row">
                        ...
                        <div class="col-md-3 pad-btm">
                            <input type="text" id="khata_no" name="khata_no" class="form-control" placeholder="Khata No." value="<?=(isset($khata_no))?$khata_no:"";?>" onkeypress="return isNumComma(event);" />
                        </div>
                        <label class="col-md-3">Plot No. <span class="text-danger">*</span></label>
                        <div class="col-md-3 pad-btm">
                            <input type="text" id="plot_no" name="plot_no" class="form-control" placeholder="Plot No." value="<?=(isset($plot_no))?$plot_no:"";?>" onkeypress="return isNumComma(event);" />
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div id="road_width_hide_show">
                            <label class="col-md-3">Road Width <span class="text-bold">(in ft)</span> <span class="text-danger">*</span><br /><span class="text-danger text-sm">In Case of No Road Enter "0" (For Vacant Land Only)</span></label>
                            <div class="col-md-3 pad-btm">
...
Supporting Equipments & Accessories (in Sq. Ft.) <span class="text-danger">*</span></label>
                    ...
                    <div class="hidden" id="petrol_pump_dtl_hide_show">
                        ...
                        <div class="hidden" id="is_petrol_pump_hide_show">
                            <div class="row">
                                <label class="col-md-3">Underground Storage Area (in Sq. Ft.) <span class="text-danger">*</span></label>
                                <div class="col-md-3">
