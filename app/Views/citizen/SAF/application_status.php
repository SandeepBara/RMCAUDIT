									...
									<div class="panel panel-bordered panel-dark">
										...
										<div class="panel-body">
											<div class="col-sm-8 col-sm-offset-2">
												<b style="color:#60a042;font-size:20px;">Current Status :
													<span style="color:red;font-size:20px;"> <?= $application_status; ?></span></b>
											</div>
														...
														?>
																<tr>
																	...
																	<td>
																		...
																		?>
																			<a target="_blank" href="<?= base_url(); ?>/writable/uploads/<?= $path; ?>">
																				<img src='<?= base_url(); ?>/writable/uploads/<?= $path; ?>' class='img-lg' />
																			</a>
																		<?php
																			if ($owner_detail['applicant_img_dtl']['verify_status'] == 0) {
																				echo "<br /><span class='text-danger text-bold'>Not Verify.</span>";
																			} else if ($owner_detail['applicant_img_dtl']['verify_status'] == 1) {
																				echo "<br /><span class='text-danger text-bold'>Verified.</span>";
																	...
																	<td>
																		...
																		if ($owner_detail['applicant_doc_dtl']) {
																			...
																			if ($extention == "pdf") {
																		?>
																				<a href="<?= base_url(); ?>/writable/uploads/<?= $path; ?>" target="_blank">
								...
								<div class="row">
									<div class="text text-center">
										<?php if ($payment_status == 0) { ?>
											<a href="<?= base_url(); ?>/CitizenPropertySAF/citizen_saf_confirm_payment/<?= md5($saf_dtl_id); ?>" class="btn btn-primary">
												Proced To Pay
											</a>
										<?php } ?>
									</div>
