...
<div id="content-container" style="padding-top: 10px;">
    <!--Page content-->
    <div id="page-content">
        <form method="post" id="form_saf_property" name="form_saf_property" action="<?=base_url('CitizenSaf/addUpdate');?><?=(isset($param))?"/".$param:"";?>">

            <!-- Self Assessment Form -->
            <input type="hidden" name="saf_no" value="<?=$saf_no;?>" />
            ...
            <input type="hidden" name="elec_cons_category" value="<?=$elec_cons_category;?>" />
                ...
                <div class="panel panel-bordered panel-dark">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-md-12 mar-lft pad-btm">
                                Rental Rate : <a href="#" class="text-bold text-dark" onclick="window.open('<?=base_url();?>/citizen_calc_factr/citizengetRentalRateFactor', 'newwindow', 'width=750, height=300'); return false;">Click here</a> here to view rental rate .
                            </div>
                            <div class="col-md-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9 text-center">
                            <?php if( $isCurrentFinancialYearEffected==true ){ ?>
                                <div id="btn_submit_hide_show" style="display: none">
                                    <button type="SUBMIT" id="btn_submit" name="btn_submit" value="submitt" class="btn btn-primary" disabled>FINAL SUBMIT</button>
                                </div>
