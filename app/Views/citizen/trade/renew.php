...
<div id="content-container">
    ...
    <div id="page-content">
        <form method="post" action="<?=base_url('TradeCitizen/renew');?>">
            ...
            <div class="panel panel-bordered panel-dark">
                ...
                <div class="panel-body">
					...
					<div class="col-md-2">
						<input type="text" name="application_type" id="application_type" value="RENEWAL" class="form-control" readonly>
					</div>
