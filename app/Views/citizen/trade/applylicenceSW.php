                        ...
                        <div class="col-md-3 pad-btm">
                            ...
                            ?>
                                <select name="firmtype_id" id="firmtype_id" onchange="forother(this.value); validate_holding()" class="form-control">
                                    ...
                                    ?>
                                            <option value="<?php echo $val['id']; ?>" <?php if (isset($firm_type_id) && $firm_type_id == $val['id']) {
                                                                                            echo "selected";
                                                                                        } ?>><?php echo $val['firm_type']; ?></option>
                                    <?php
                                        }
                                    }
                                    ?>
                        ...
                        <div class="col-md-3 pad-btm"><?php if ($application_type["id"] == 1 or $application_type["id"] == 3) { ?>
                                <select name="ownership_type_id" id="ownership_type_id" onchange="validate_holding()" class="form-control">
                                    ...
                                    ?>
                                            ...
                                            <option value="<?php echo $val['id']; ?>" <?php if (isset($ownership_type_id) && $ownership_type_id == $val['id']) {
                                                                                            echo "selected";
                                                                                        } ?>><?php echo $val['ownership_type']; ?></option>
                                    <?php
                                                                }
                                                            }
                                    ?>
                        ...
                        <div class="col-md-3 pad-btm">
                            <?php if ($application_type["id"] == 1) { ?>
                                <select name="category_type_id" id="category_type_id" class="form-control">
                                    ...
                                    ?>
                                            <option value="<?php echo $vdata['id']; ?>" <?php if (isset($category_type_id) && $category_type_id == $vdata['id']) {
                                                                                            echo "selected";
                                                                                        } ?>><?php echo $vdata['category_type']; ?>
                                            </option>
                                    <?php
                                        }
                                    }
                            ...
                            <?php } else {
                                echo  $categoryDetails["category_type"] ? $categoryDetails["category_type"] : "N/A";
                            } ?>
                        </div>
                    </div>
                </div>
            ...
            <div class="panel panel-bordered panel-dark">
                ...
                ?>
                            ...
                            <div class="col-md-3 pad-btm">
                                <select name="old_ward_id" id="old_ward_id" class="form-control" onchange="validate_holding(),openModel()">
                                    ...
                                    if ($ward_list) 
                                    {
                                        ...
                                        {
                                        ?>
                                            <option value="<?php echo $val['id']; ?>" <?php if (isset($ward_id) && $ward_id == $val['id']) {
                                                                                            echo "selected";
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table table-bordered text-sm">
                                                            ...
                                                            <tbody id="owner_dtl_append">
                                                                <tr>
                                                                    <td>
                                                                        <input type="text" id="owner_name1" name="owner_name[]" class="form-control owner_name" placeholder="Owner Name" value="<?=isset($woner_name)?$woner_name:''?>" <?=isset($woner_name) && !empty($woner_name)?'readonly':''?> onkeypress="return isAlpha(event);" />
                                                                    </td>
                                                                    <td>
                                                                    ...
                                                                    <td>
                                                                        <input type="text" id="mobile_no1" name="mobile_no[]" class="form-control mobile_no" placeholder="Mobile No." value="<?=isset($mobile_no)?$mobile_no:''?>" <?=isset($mobile_no) && !empty($mobile_no)?'readonly':''?> onkeypress="return isNum(event);" maxlength="10" />
                                                                    </td>
                                                                    <td>
                                                                        <input type="email" id="emailid1" name="emailid[]" class="form-control address" placeholder="Email Id" value="<?=isset($email)?$email:''?>" <?=isset($email) && !empty($email)?'readonly':''?> maxlength="30" />
                                                                    </td>
                                                                    ...
                                                                    <td>
                                                                        <select id="tade_item<?= $ti ?>" name="tade_item[]" class="form-control tade_item demo-select2-multiple-selects" required="required" onchange="borderNormal(this.id);" multiple="multiple">
                                                                            <optgroup label="Central Time Zone">
                                                                                ...
                                                                                ?>
                                                                                        <option value="<?php echo $valit['id']; ?>" <?php if ($itemvalue["id"] == $valit['id']) {
                                                                                                                                        echo "selected";
                                                                                                                                    } ?>><?php echo $valit['trade_item']; ?></option>
                                                                                <?php
                                                                                    }
                                                                                }
                                                                                ?>
                    ...
                    ?>
                        <div class="panel panel-bordered panel-dark">
                            <div class="panel-heading">
                                <h3 class="panel-title">Nature Of Business <?php if ($tobacco_status == 1) {
                                                                                echo '<span class="text text-danger">(Tobbaco)</span>';
                                                                            } ?></h3>
                            </div>
                            <div class="panel-body">
                                <div class="row">
                                            ...
                                            ?>
                                                    <select id="tade_item<?= $ti ?>" name="tade_item[]" class="form-control tade_item demo-select2-multiple-selects" multiple="multiple" required="required" onchange="borderNormal(this.id);" readonly disabled>
                                                        ...
                                                        if ($tradeitemlist) {
                                                            ...
                                                            foreach ($tradeitemlist as $valit) {
                                                        ?>
                                                                <option value="<?php echo $valit['id']; ?>" <?php if (in_array($valit['id'], $tradeitemdet)) {
                                                                                                                echo "selected";
                                                                                                            } ?>><?php echo $valit['trade_item']; ?></option>
                                                        <?php
                                                            }
                    ...
                    $shw = 1;
                    if (($application_type["id"] > 1) && ($licencedet["area_in_sqft"] == 0)) 
                    {
                        $shw = 0;
                    }
                    if ($shw == 1) 
    ...
    function trade_item_append_fun() 
    {
        ...
        var tappendData = '<tr><td><select id="tade_item' + ti + '" name="tade_item[]" required="required" class="form-control tade_item"  onchange="borderNormal(this.id);"><option value="">SELECT</option><?php if ($tradeitemlist) {
                                                                                                                                                                                                                    foreach ($tradeitemlist as $valit) { ?><option value="<?php echo $valit['id']; ?>" ><?php echo $valit['trade_item']; ?></option><?php }
                                                                                                                                                                                                                                                                                                                                                            } ?></select></td><td class="text-2x"><i class="fa fa-plus-square" style="cursor: pointer;" onclick="trade_item_append_fun();"></i>&nbsp;<i class="fa fa-window-close remove_trade_item" style="cursor: pointer;"></i></td></tr>';
        ...
        if (str != "" && timefor != "") {
            $.ajax({
                ...
                data: {
                    ...
                    <?php if ($application_type["id"] > 1) {
                        echo '"apply_licence_id":' . ($apply_licence_id ?? null);
                    } ?>
                },
                beforeSend: function() {
                    $("#charge").val(0);
