...
<div id="content-container">
    ...
    <div id="page-content">
        <form method="post" action="<?=base_url('TradeCitizen/surrender');?>">
            
            <div class="panel panel-bordered panel-dark">
                <div class="panel-heading">                   
                    <h3 class="panel-title">Apply For Surrender Licence</h3>
                </div>
                <div class="panel-body">
					<label class="col-md-1">Apply For</label>
					<div class="col-md-2">
						<input type="text" name="application_type" id="application_type" value="SURRENDER" class="form-control" readonly>
					</div>
