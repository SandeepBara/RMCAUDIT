						...
						<div class="panel-body" id="print_watermark">
							<div class="panel-body" style="border: solid 2px black;">
								...
								<div class="col-sm-1 noprint text-right">
									<button class="btn btn-mint btn-icon" onclick="print()" style="height:40px;width:60px;"><i class="demo-pli-printer icon-lg"></i></button>
								</div>
								...
								<?=$ulb_mstr_name["ulb_name"];?>
									...
									<table width="100%" border="0">
										<tbody>
											...
											<?php 
											if(in_array(strtolower($transaction_details["payment_mode"]), ['cash', 'online']))
											{
												?>
												<tr>
													<td height="35">
										...
										<table width="99%" border="1" align="center" cellpadding="0" cellspacing="0" style="font-family: Arial, Helvetica, sans-serif; font-size: 12px; text-align:center;">
											<tbody>
												...
												<tr>
													...
													<td><?=$transaction_details['paid_amount']?$transaction_details['paid_amount'] - $transaction_details['penalty'].".00":'0.00';?></td>
