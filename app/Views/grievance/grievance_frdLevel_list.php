							...
							<div class="table-responsive">
								 <table id="demo_dt_basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
									...
									<tbody>
										...
										<?php foreach($grievance_tllist as $value): ?>
										<tr>
											<td><?php echo $i++; ?></td>
											<td><?=$value['grievance_type']?$value['grievance_type']:"N/A"; ?></td>
											...
											<?php 
											if($user_type==11 || $user_type==4){
												if($value['status']==1){ ?>
													<td><button type="button" class="btn btn-info" data-toggle="modal" title="Reply" data-target="#complain"><i class="fa fa-reply" style="font-size: 14px;color:green;"></i></button>
													<a href="<?php echo base_url('grievance_responce/grievance_forwardPM/'.$value['token_no']);?>" type="button" title="Forward to PM" class="btn btn-purple btn-labeled"><i class="fa fa-fast-forward"></i></a></td>
											<?php } } else if($user_type==3){ ?>
												<?php if($value['status']==1){ ?>
												<td><button type="button" class="btn btn-info" data-toggle="modal" title="Reply" data-target="#complain"><i class="fa fa-reply" style="font-size: 14px;color:green;"></i></button></td>
											<?php } } ?>
										</tr>
										<?php endforeach; ?>
