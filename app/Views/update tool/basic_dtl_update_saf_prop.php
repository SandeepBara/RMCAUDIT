					...
					<form action="<?php echo base_url('update_tool/basic_dtl_update');?>" method="post" role="form" class="php-email-form">
						<div class="panel panel-bordered panel-dark">
							...
							<div class="panel-body">
								<div class="row">
									...
									<div class="col-md-4 pad-btm">
										<div class="form-group">
											<select id="type" name="type" class="form-control m-t-xxs" onchange="">
												<option value="<?=$type?$type:""; ?>"><?=$type?$type:"Select"; ?></option>
								...
								<div class="row">
									<div class="col-md-8" id="saf" style="display:none;">
										<label class="col-md-3">Enter Saf No. <span class="text-danger">*</span></label>
										<div class="col-md-6 pad-btm">
											<div class="form-group">
												<input type="text" id="saf_no" name="saf_no" class="form-control" style="height:38px;" placeholder="Enter Saf No." value="">
											</div>
										</div>
									...
									<div class="col-md-8" id="holding" style="display:none;">
											...
											<table id="demo_dt_basic" class="table table-striped table-bordered"  width="100%" style="font-family:Arial, Helvetica, sans-serif; font-size:12px;text-align:center;">
												...
												<tbody>
													...
													<tr>
														...
														<td><?=$post['plot_no']?$post['plot_no']:"N/A"; ?></td>
														<td>
															<a href="<?php echo base_url('update_tool/jsk_due_details/'.md5($post['prop_dtl_id']));?>" type="button" id="customer_view_detail" class="btn btn-primary" style="color:white;">View</a></td>
