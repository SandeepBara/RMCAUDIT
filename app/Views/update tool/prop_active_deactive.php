...
<!-- ======= Cta Section ======= -->
				...
				<div id="page-content">
					<form action="<?php echo base_url('update_tool/prop_active_deactive');?>" method="post" role="form" class="php-email-form">
						<div class="panel panel-bordered panel-dark">
							...
							<div class="panel-body">
								<div class="row">
									<div class="col-md-8" id="holding">
										<label class="col-md-3">Enter Holding No. <span class="text-danger">*</span></label>
										<div class="col-md-6 pad-btm">
											<div class="form-group">
												<input type="text" id="holding_no" name="holding_no" class="form-control" style="height:38px;" placeholder="Enter Holding No." value="<?php echo $holding; ?>">
											</div>
										</div>
													...
													<tr>
														...
														<td>
															<?php if($post['status']==1){ ?>
																	<a href="<?php echo base_url('update_tool/prop_active_deactive/'.md5($post['prop_dtl_id']));?>"><button class="btn btn-danger" id="deactivate" name="deactivate">
																		Deactivate
																	</button></a>
															<?php } else { ?>
																	<a href="<?php echo base_url('update_tool/prop_active_deactive/'.md5($post['prop_dtl_id']));?>"><button class="btn btn-success" id="activate" name="activate">
																		Activate
																	</button></a>
															<?php } ?>
...
<script>
	...
	<?php if($result = flashToast('prop_active_deactive')) { ?>
		modelInfo('<?=$result;?>');
	<?php }?>	
