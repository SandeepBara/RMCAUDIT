                ...
                <div class="row">
                        ...
                        <?=($basic_details_data['saf_no']!="")?$basic_details_data['saf_no']:"N/A";?>
                        </div>

                        <label class="col-md-3">Apply Date</label>
                        <div class="col-md-3 text-bold pad-btm">
                        <?=($basic_details_data['apply_date']!="")?$basic_details_data['apply_date']:"N/A";?>
                        </div>
                </div>
                    <div class="row">
                    ...
                    <div class="row">
                    <!-- apartment case -->
                    <?php if(isset($basic_details_data['prop_type_mstr_id'])) { if($basic_details_data['prop_type_mstr_id']==3) {   ?>
