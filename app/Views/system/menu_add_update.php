                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" maxlength="100" id="menu_name" name="menu_name" class="form-control" placeholder="Enter Menu Name" value="<?=(isset($menu['menu_name']))?$menu['menu_name']:'';?>" onkeypress="return isAlpha(event);">
                                    </div>
                                </div>
                                 <div class="col-sm-6">
                                    <div class="form-group">
                                        <label class="control-label">Order No</label>
                                        <input type="text" maxlength="2" id="order_no" name="order_no" class="form-control" placeholder="Enter Order No" value="<?=(isset($menu['order_no']))?$menu['order_no']:'';?>" onkeypress="return isNum(event);">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select id="parent_menu_mstr_id" name="parent_menu_mstr_id" class="form-control">
                                            ...
                                            <option value="-1" <?=(isset($menu['parent_menu_mstr_id']))?("-1"==$menu['parent_menu_mstr_id'])?'selected':'':'';?> >DIRECT ACTIVE MENU</option>
                                        <?php
                                        if(isset($underMenuNameList)){
                                            foreach ($underMenuNameList as $values){
                                        ?>
                                            <option value="<?=$values['id']?>" <?=(isset($menu['parent_menu_mstr_id']))?($values['id']==$menu['parent_menu_mstr_id'])?'selected':'':'';?> ><?=$values['menu_name']?></option>
                                        <?php
                                            }
                                        }
                                        ?>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="menu_path" name="url_path" class="form-control" placeholder="Enter Menu Path" value="<?=(isset($menu['url_path']))?$menu['url_path']:'';?>"/>
                                    </div>
                                </div>
                                <div class="col-sm-6" id="menu_icon_hide_show" style="display: none;">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="menu_icon" name="menu_icon" class="form-control" placeholder="Enter Menu Icon" value="<?=(isset($menu['menu_icon']))?$menu['menu_icon']:'';?>"/>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
