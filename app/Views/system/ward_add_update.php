					    ...
					    <div class="col-sm-12">
					        <div class="panel">
                              ...
                              <input type="hidden" id="id" name="id" value="<?=(isset($ward['id']))?$ward['id']:'';?>" />
                                    <div class="panel-body">
                                     <div class="pad-btm">
                                      ...
                                      <div class="form-group">
                                       <label class="col-sm-2 control-label " for="ulb_mstr_id">ULB<span style="color:red"> *</span></label>
                                      <div class="col-sm-4">
                                        <select id="ulb_mstr_id" name="ulb_mstr_id" class="form-control">
                                         <option value="">--select--</option>
                                          <?php foreach($ulb_list as $value):?>
                                          <option value="<?=$value['id']?>" <?=(isset($ulb_mstr_id))?$ulb_mstr_id==$value["id"]?"SELECTED":"":"";?>><?=$value['ulb_name'];?>
                                          </option>
                                          <?php endforeach;?>
                                        </select>
                                    </div>
                                   ...
                                   <div class="form-group">
					                        <label class="col-sm-2 control-label" for="ward_no">Ward Number <span style="color:red"> *</span></label>
					                        <div class="col-sm-4">
					                            <input type="text" maxlength="3" placeholder="Enter Ward Number" id="ward_no" name="ward_no" class="form-control" value="<?=(isset($ward_no))?$ward_no:"";?>" onkeypress="return isNum(event);">
					                        </div>
					                    </div>
					                </div>
					                <div class="panel-footer text-center">
					                    <button class="btn btn-success" id="btn_ward" name="btn_ward" type="submit"><?=(isset($id))?"Edit Ward":"Add Ward";?></button>
					                </div>
                                     <div class="row">
