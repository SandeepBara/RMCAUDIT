...
@media print {
	.print_watermark {
        background-image:url(<?php //echo base_url()."/public/assets".$ulb_mstr_name["watermark_path"];?>) !important;
            ...
            <div class="panel-body">
                ...
                <div class="print_watermark">
                    <div class="row">
                        <div class="col-md-12" style="text-align: center;">
                            <img style="height:80px;width:80px; border-radius: 50px;" src='<?php //echo  base_url() . "/public/assets/" . $ulb_details['logo_path']; ?>'><br>
                            <label style="color:#000;">
                                <strong style="font-size:24px;">कार्यालय: <?php //echo  $ulb_details['ulb_name_hindi']; ?></strong><br />
                                <strong>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <label style="font-size:14px; font-weight: bold;">दिनांक : <span style="border-bottom:1.5px dotted black;"><?php //echo  date('d-m-y')   ?></span></label>
                        </div>
                        <div class="col-md-12" style="text-align: center;">
                            ...
                            <strong>
                                <label style="font-size:14px;">श्री / श्रीमती /मेसर्स : 
                                    <span style="border-bottom:1.5px dotted black;">
                                        <?php if (isset($prop_owner_detail)) {
                                            foreach ($prop_owner_detail as $owner) { ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <p id="para" style="text-align: justify;">
                                सम्पत्तिकर नियम 2013 में संशोधन किया गया है, अतः वित्तिय वर्ष 2022-23 से सम्पत्तिकर का मूल्याकन वार्षिक किराया मूल्य के स्थान पर पूजीगत मूल्य के आधार पर किया जायेगा। आपके भवन (होल्डिंग नं० - <?php //echo $new_holding_no;?>) के घृतिकर की गणना 01.04.2022 से सर्किलरेट के अनुसार किया जायेगा।
                            </p>
                        </div>
                        <div class="col-md-12">
                            <p id="para" style="text-align: justify;">
                ...
                <div class="row">
                    <div class="col-md-12">
                            ...
                            <table class="table table-bordered text-sm">
                                <thead class="bg-trans-dark text-dark text-xs">
                                    <tr>
                                        ...
                                        <th>Circle Rate</th>
                                        <th>ARV Total property Tax</th>
                                        <th>CV Total property Tax</th>
                                    </tr>
                                </thead>
                                <tbody>
                            <?php
                            ...
                            ?>
                                    <tr>
                                        <td><?php //echo $floorTaxDtl["floor_name"];?></td>
                                        <td><?php //echo $floorTaxDtl["builtup_area"];?></td>
                                        <td><?php //echo $floorTaxDtl["new_arv_cal_method"]["usage_factor"];?></td>
                                        <td><?php //echo $floorTaxDtl["new_arv_cal_method"]["occupancy_factor"];?></td>
                                        <td><?php //echo $floorTaxDtl["new_arv_cal_method"]["carper_area"];?></td>
                                        <td><?php //echo $floorTaxDtl["new_arv_cal_method"]["rental_rate"];?></td>
                                        <td>N/A</td>
                                        <td>N/A</td>
                                        <td><?php //echo $floorTaxDtl["new_arv"];?></td>
                                        <td>N/A</td>
                                        <td><?php //echo $floorTaxDtl["new_arv"]*0.02;?> <?php $totalArv += $floorTaxDtl["new_arv"]*0.02;?></td>
                                        <td>N/A</td>
                                    </tr>
                                    <tr>
                                        <td><?php //echo $floorTaxDtl["floor_name"];?></td>
                                        <td><?php //echo $floorTaxDtl["builtup_area"];?></td>
                                        <td>N/A</td>
                                        <td><?php //echo $floorTaxDtl["cv_2022_cal_method"]["occupancy_rate"];?></td>
                                        <td>N/A</td>
                                        <td><?php //echo $floorTaxDtl["cv_2022_cal_method"]["matrix_factor_rate"];?></td>
                                        <td><?php //echo $floorTaxDtl["cv_2022_cal_method"]["resi_comm_type_rate"]*100;?>%</td>
                                        <td><?php //echo $floorTaxDtl["cv_2022_cal_method"]["calculation_factor"];?></td>
                                        <td>N/A</td>
                                        <td><?php //echo $floorTaxDtl["cv_2022_cal_method"]["cvr"];?></td>
                                        <td>N/A</td>
                                        <td><?php //echo $floorTaxDtl["cv"];?> <?php $totalCV += $floorTaxDtl["cv"];?></td>
                                    </tr>
                                    <tr>
                                        <td colspan="10"></td>
                                    </tr>
                            <?php } ?>
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <td></td>
                                        <td>Total</td>
                                        <td><?php //echo $totalArv;?></td>
                                        <td><?php //echo $totalCV;?></td>
                                    </tr>
                                </tfoot>
                            </table>
                            <?php } ?>
