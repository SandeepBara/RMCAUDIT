                    ...
                    <div class="row" style="border: 3px;  padding: 20px;">
                            ...
                            <tr>
                                <td style="width: 100%; text-align: center;">
                                    <span style="border: 3px; border-style: solid; padding: 10px 50px; font-weight: 600; font-size: 20px;">
                                        Govt. Building Self-Assessment Form Demand
                                    </span>
                                </td>
                            </tr>
                        </table>
                        ...
                        <table style="width: 100%; font-weight: 300;">
                            <tr>
                                <td style="width: 60%; font-size: 18px;">
                                   <span style="font-size:16px">Acknowledgement No.</span> : <span style="font-weight:600;font-size:16px"><?=$application_no;?></span>
                                </td>
                            ...
                            <tr>
                                ...
                                <td style="width: 40%; font-size: 16px;">
                                    <span style="font-size:16px">Holding No. : </span><span style="font-weight:600;font-size:16px"><?=($new_holding_no=="")?"N/A":$new_holding_no;?></span>
                                </td>
                            </tr>
                            <tr>
                                <td style="width: 60%; font-size: 16px;">
                                    Account Description: Service Charge & Others
                                </td>
                                <td style="width: 40%; font-size: 16px;">
                                </td>
                            </tr>
                        ...
                        <table style="width: 100%; font-weight: 300;margin-top:15px;">
                            <tr>
                                <td style="width: 60%; font-size: 16px;">
                                    ...
                                    <span style="font-size:16px">Colony/ Building name : </span><span style="font-weight:600;font-size:16px"><?=$building_colony_name;?></span>
                                </td>
                            </tr>
                            <tr>
                                <td style="width: 60%; font-size: 16px;">
                                  
                                    <span style="font-size:16px">Address : </span><span style="font-weight:600;font-size:16px"><?=$building_colony_address;?></span>
                                </td>
                            </tr>
                        </table>
                        <table id="data_table_view" style="width: 100%; font-weight: 300;margin-top:15px;">
                            <tr id="data_table_view_first_row">
                                ...
                                <td >
                                    Quarterly Service Charge <br > (In Rs.)
                                </td>
                                <td >
                                    Demand <br > (In Rs.)
                                </td>
                                <td >
                                    Additional Service Charge <br > (In Rs.)
                                </td>
                                <td >
                                    Already Paid <br > (In Rs.)
                                </td>
                                <td >
                                    Total <br > (In Rs.)
                                </td>
                            ...
                            <tr>
                                <td colspan="4" style="font-size: 16px; text-align: right;font-weight:600">Total</td>
