    ...
    <div id="page-content">
        <form id="form_saf_property" method="post" action="<?=base_url('Gsaf/add_update');?>">
            ...
            <div class="panel panel-bordered panel-dark">
                ...
                <div class="panel-body">
                    <div class="row">
                        <label class="col-md-4">Name Of Colony <span class="text-danger">*</span></label>
                        <div class="col-md-3 pad-btm">
                            <select id="colony_type_mstr_id" name="colony_type_mstr_id" class="form-control" onchange="colonyMstrChngFun();">
                                <option value="">== SELECT ==</option>
                                <?php
                                if(isset($colonyList)){
                                    foreach ($colonyList as $list) {
                                ?>
                                <option value="<?=$list['id'];?>" <?=(isset($colony_type_mstr_id))?($list['id']==$colony_type_mstr_id)?"selected":"":"";?>><?=$list['colony_name'];?></option>
                                <?php
                                    }
                                }
                                ?>
                    ...
                    <div class="row">
                        <label class="col-md-4">Ownership Type <span class="text-danger">*</span></label>
                        <div class="col-md-3 pad-btm">
                            <select id="govt_building_type_mstr_id" name="govt_building_type_mstr_id" class="form-control">
                                <option value="">== SELECT ==</option>
                                <?php
                                if(isset($govtBuildTypeList)){
                                    foreach ($govtBuildTypeList as $govtBuildType) {
            ...
            <div class="panel panel-bordered panel-dark">
                ...
                <div class="panel-body">
                    ...
                    <div class="row"><br>
                        ...
                        <div class="col-md-3 pad-btm">
                          <input type="text" id="designation" name="designation" class="form-control" value="<?=(isset($designation))?$designation:"";?>" />
                        </div>
                    </div>
