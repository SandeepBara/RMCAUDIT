                            ...
                            <table width="100%">
                                 <tr>
                                    <td width="40%" style="text-align: right;">
                                        <img style="height:60px;width:60px;" src='<?php echo base_url('public/assets/').session()->get("ulb_dtl")["logo_path"];?>'>
                                    </td>
                             ...
                             <table style="width:100%;">
                                 ...
                                 <tr>
                                     <td> The annual rent value of this holding is Rs.  <b> <?=$saf_tax['arv'];?> / - </b> after local check made by <?=$ulb['ulb_name'];?> in the light of the self assessment declaration letter made by you for assessment of tax for <b>Ward No. </b><?=@$saf['ward_no'];?> (<b>Old Ward No.</b> <?=@$saf['ward_no'];?>)
                                    , <?=$prop_tax['arv'];?> / - is fixed at the place.
                                     </td>
                                 </tr>
                                 <tr>
                             ...
                             <table>
                                ...
                                <tr>
                                    ...
                                    <?php if ($memo["verify_user_type_id"]==9) { ?>
                                        <img  src="<?php echo base_url('writable/eo_sign/robinkachhap.jpeg');?>" style="width:100px;height:100px;" />
                                        <br />
                                        <label style="font-size: 15px; font-weight: bold;">Citi&nbsp;Manager&nbsp;/Incharge</label>
                                    ...
                                    <?php } else { ?>
                                        ...
                                        <br />
                                        <label style="font-size: 15px; font-weight: bold;">Deputy&nbsp;Municipal&nbsp;Commissioner</label>
                                        <br/>
                                        <?=$ulb['ulb_name'].', '.$ulb_short_nm;?> 
                                    <?php } ?>
                                    </td>
