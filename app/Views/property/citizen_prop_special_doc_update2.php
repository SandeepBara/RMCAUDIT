...
<div id="content-container">
    ...
    <div id="page-content">
        ...
        <!------- Panel Owner Details-------->
        <div class="container-fluid" style="background-color: white;padding:10px 10px 100px 20px">
            <form method="post" enctype="multipart/form-data">
                <div class="row" style="margin-top: 20px;">
                    ...
                    <div id="main_form_container" class="container-fluid" style="display:none">
                            ...
                            <div class="row" style="margin-top: 20px;display:block" id="senior_container">
                                ...
                                <div class="col-sm-3 dob_class" style="display: block" id="dob_input">
                                    <div>
                                        ...
                                        <input id="dob_date_value" max="<?php echo date('Y-m-d');?>" type="date" name="dob_input" class="form-control">
...
<script>
    ...
    function show_file_input(e) {
        ...
        try {
            $.ajax({
                type: "POST",
                url: "<?= base_url('CitizenPropSpecialDocUpload/ajaxgetPropOwnerData'); ?>",
                dataType: "json",
                data: {
                    "ownerId": onwer_id
                },
