            ...
            <div id="content-container">
                <div id="page-head">
                    ...
                    <ol class="breadcrumb">
						...
						<li class="active">Objection Mail List</li>
                    </ol>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End breadcrumb-->
													...
													if($result):
														...
														foreach($result as $post):
															...
															<tr>
																...
																<td><?=date('d-m-Y h:i A', strtotime($post['timestamp']));?></td>
																<td>
																	<a href="<?=base_url('propDtl/ViewObjection1/'.md5($post['id']));?>" type="button" id="customer_view_detail" class="btn btn-primary" style="color:white;">View</a>
																</td>
															</tr>
															<?php 
														endforeach;
