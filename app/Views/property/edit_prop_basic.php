...
<div id="content-container">
    ...
    <div id="page-content" id="divIdPDF">
        ...
        <form method="post" id="owner_form" enctype="multipart/form-data">
            ...
            <input type="hidden" id="owner_saf_dtl_id" name="owner_saf_dtl_id" value="<?=$saf_dtl_id;?>" />
                    ...
                    <div class="row">
                        <div class="col-md-3 col-xs-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="owner_name" name="owner_name" class="form-control owner_name" placeholder="Owner Name" value="">
                            </div>
                        </div>
                        <div class="col-md-3 col-xs-6">
                            <div class="form-group">
                                <label class="control-label">Guardian Name</label>
                                <input type="text" id="guardian_name" name="guardian_name" class="form-control guardian_name" placeholder="Guardian Name" value="">
                            </div>
                        </div>
                        <div class="col-md-3 col-xs-6">
                            <div class="form-group">
