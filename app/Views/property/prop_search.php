...
<div id="content-container">
    <div id="page-head">
        ...
        <li><a href="#"><?=($holding_type=="government")?"GOVERNMENT":"PROPERTY";?></a></li>
            ...
            <div class="col-sm-12">
                <div class="panel panel-bordered panel-dark">
                    ...
                    <div class="panel-body">
                        <div class ="row">
                            <div class="col-md-12">
                                <form class="" method="post" action="<?=base_url('propDtl/search')."/".escapeData($holding_type);?>">
                    ...
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered text-sm">
                                ...
                                <?php
                                $i=0;
                                $holding_type = ($holding_type=="government")?"government":"property";
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><a href="<?=base_url();?>/propDtl/full/<?=md5($list['id'])."/".$holding_type;?>"><i class="fa fa-street-view" style="font-size: 22px"></i></a></td>
                                    </tr>
                                <?php
                                }
                                ?>
