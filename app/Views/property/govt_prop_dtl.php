                            ...
                            <div class="table-responsive">
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?=($owner_detail['mobile_no']!="")?$owner_detail['mobile_no']:"N/A";?>
                                            </td>
                                            <td>
            ...
            <div class="panel panel-bordered panel-dark">
                ...
                <div class="panel-body" style="padding-bottom: 0px;">
                    <div class="row">
                        ...
                        <div class="col-md-3 text-bold pad-btm">
                            <?=(isset($area_of_plot))?$area_of_plot:"N/A";?>
                        </div>
                        <label class="col-md-3">Road Type</label>
                        <div class="col-md-3 text-bold pad-btm">
                            <?=(isset($road_type))?$road_type:"N/A";?>
            ...
            <div class="panel panel-bordered panel-dark">
                ...
                <div class="panel-body" style="padding-bottom: 0px;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 text-bold pad-btm">
                            <?=(!isset($prop_city) || $prop_city=="")?"N/A":$prop_city;?>
                        </div>
            ...
            <div class="panel panel-bordered panel-dark">
                ...
                <div class="panel-body" style="padding-bottom: 0px;">
                    ...
                    <div class="row">
                        <label class="col-md-3">City</label>
                        <div class="col-md-3 text-bold pad-btm">
                            <?=(!isset($corr_city) || $corr_city=="")?"N/A":$corr_city;?>
                        </div>
                        <label class="col-md-3">District</label>
...
Underground Storage Area (in Sq. Ft.)</label>
                        ...
                        <table class="table table-bordered text-sm">
                            ...
                            ?>			
                                <tr>
                                    ...
                                    <td><?=($demand_detail['paid_status']==0)?"<span class='text-danger'>NOT PAID</span>":"<span class='text-success'>PAID</span>";?></td>
                                </tr>
                                <?php
                                }
                                ?>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered" style="font-family:Arial, Helvetica, sans-serif; font-size:12px;">
                            <thead class="bg-trans-dark text-dark">
                                ...
                                if (in_array($emp_details['user_type_mstr_id'], $arr_user_type_mstr_id)) {
                                ?>
                                    <th>View</th>
                                <?php
                                }
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    if (in_array($emp_details['user_type_mstr_id'], $arr_user_type_mstr_id)) {
                                    ?>
                                    <td><a href="<?php echo base_url('jsk/payment_jsk_receipt/'.md5($payment_detail['id']));?>" type="button" id="customer_view_detail" class="btn btn-primary" style="color:white;">View</a></td>
                                    <?php
                                    }
                                    ?>
                                </tr>
            ...
            <?php if(getEmpDetails()['user_type_mstr_id']==7 || getEmpDetails()['user_type_mstr_id']==1) {?>
            <div class="panel panel-bordered panel-dark">
                <div class="panel-body">
                    <a href="<?=base_url('jsk/jsk_due_details/'.md5($prop_dtl_id));?>" class="btn btn-primary">Goto Payment</a>
                </div>
            </div>
            <?php } ?>
        </form>
