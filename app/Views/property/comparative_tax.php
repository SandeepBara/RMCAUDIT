            ...
            <div class="panel-body">
                ...
                <div class="print_watermark">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <p id="para" style="text-align: justify;">
                                सम्पत्तिकर नियम 2013 में संशोधन किया गया है, अतः वित्तिय वर्ष 2022-23 से सम्पत्तिकर का मूल्याकन वार्षिक किराया मूल्य के स्थान पर पूजीगत मूल्य के आधार पर किया जायेगा। आपके भवन (होल्डिंग नं० - <?=$new_holding_no;?>) के घृतिकर की गणना 01.04.2022 से सर्किलरेट के अनुसार किया जायेगा।
                            </p>
                        </div>
                        <div class="col-md-12">
                            <p id="para" style="text-align: justify;">
                    ...
                    <div class="row mar-top">
                        ...
                        <div class="col-md-12 mar-lft">
                            <label>c. Commercial & greater than 25000 sqft (For Hotel, Mall, Shopping Complex and Banquet Hall) - 0.20%</label>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                            ...
                            <?php //dd(count($floorDtlArr));
                             if (isset($floorDtlArr)) { ?>
                            <table class="table table-bordered text-sm">
                                <thead class="bg-trans-dark text-dark text-xs">
                                    <tr>
                                        ...
                                        <th>CV Total property Tax(Avg. Calculation)</th>
                                        <th>CV Total property Tax(2024-2025)</th>
                                    </tr>
                                </thead>
                                <tbody>
                            <?php
                            ...
                            ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><?=$floorTaxDtl["builtup_area"];?></td>
                                        <td>N/A</td>
                                        <td><?=$floorTaxDtl["cv_2022_cal_method_old"]["occupancy_rate"];?></td>
                                        <td>N/A</td>
                                        <td><?=$floorTaxDtl["cv_2022_cal_method_old"]["matrix_factor_rate"];?></td>
                                        <td><?=$floorTaxDtl["cv_2022_cal_method_old"]["resi_comm_type_rate"]*100;?>%</td>
                                        <td><?=$floorTaxDtl["cv_2022_cal_method_old"]["calculation_factor"];?></td>
                                        <td>N/A</td>
                                        <td><?=$floorTaxDtl["cv_2022_cal_method_old"]["cvr"];?></td>
                                        <td>N/A</td>
                                        <td><?=$floorTaxDtl["cv_old"]??0;?> <?php $totalCV_old += $floorTaxDtl["cv_old"]??0;?></td>
                                        <td>N/A</td>
                                        <td>N/A</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>N/A</td>
                                        <td><?=$floorTaxDtl["cv_2024_cal_method"]["cvr"];?></td>
                                        <td>N/A</td>
                                        <td>N/A</td>
                                        <td>N/A</td>
