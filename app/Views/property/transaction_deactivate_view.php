...
<!--CONTENT CONTAINER-->
            ...
            <div id="content-container">
                <div id="page-head">
					...
					<li class="active">Property Transaction Deactivation</li>
                    </ol>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End breadcrumb-->
                </div>
                ...
                <div id="page-content">
	                <div class="panel panel-bordered panel-dark">
						<div class="panel-heading">
							<div class="panel-control">
								<a class="btn btn-default" href="<?php echo base_url('PropertyTransactionDeactivate/detail/'.md5($tranDetails['id']));?>" role="button">Back</a>
							</div>
						...
						<div class="panel-body">
							<div class="row">
								...
								<div class="col-sm-3">
									<?php echo date('d-m-Y',strtotime($tranDetails['tran_date'])); ?>
								</div>
							</div>
							<div class="row">
								<div class="col-md-2">
								...
								<div class="col-md-3">
									<?php echo $tranDetails['payable_amt']; ?>
								</div>
							</div>
							<div class="row">
								<div class="col-md-2">
									<?=(isset($holding_no))?"<b>Holding No</b>":"<b>SAF No</b>";?>
								</div>
								<div class="col-md-3">
									<?=(isset($holding_no))?$holding_no:$saf_no;?>
								</div>
								<div class="col-md-1">
								</div>
								<div class="col-md-3">
					...
					<div class="panel panel-bordered panel-dark">
	                    ...
	                    <div class="panel-body">
	                        <div class ="row">
	                            <div class="col-md-12">
	                                <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?=base_url('');?>/PropertyTransactionDeactivate/create">
	                                    <div class="form-group">
	                                        <div class="col-md-3">
	                                        	<input type="hidden" id="transaction_id" name="transaction_id" value="<?=(isset($tranDetails['id']))?$tranDetails['id']:"";?>">
