...
<div id="content-container">
    <div id="page-head">
        ...
        <li class="active">SAF Deactivation</li>
        </ol>
        <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
        <!--End breadcrumb-->
    </div>
    ...
    <div id="page-content">
        <div class="panel panel-bordered panel-dark">
            <div class="panel-heading">
                <h5 class="panel-title">SAF Deactivation</h5>
            </div>
            <div class="panel-body">
                <div class ="row">
                    <div class="col-md-12">
                        <form class="form-horizontal" method="post" action="<?=base_url('');?>/SafDeactivation/detail">
                            <div class="form-group">
                               <div class="col-md-3">
                                    <label class="control-label" for="saf_no">SAF No<span class="text-danger">*</span> </label>
                                    <div class="input-group">
                                        <input type="text"  id="saf_no" name="saf_no" autocomplete="off" class="form-control" placeholder="Enter SAF Number" value="<?=(isset($saf_no))?$saf_no:"";?>"  onkeypress="return isAlphaNum(event);">
                                    </div>
                                </div>
                                <div class="col-md-2">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-primary" href="<?php echo base_url('SafDeactivation/view/'.md5($value['id']));?>" role="button">View</a>
                                        </td>
                                    </tr>
                                <?php endforeach;  ?>
                                <?php endif;  ?>
