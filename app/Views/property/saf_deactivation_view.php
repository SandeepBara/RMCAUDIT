                ...
                <div id="page-content">
					...
					<div class="panel panel-bordered panel-dark">
	                    ...
	                    <div class="panel-body">
	                        <div class ="row">
	                            <div class="col-md-12">
	                                <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?=base_url('');?>/SafDeactivation/create">
	                                    <div class="form-group">
	                                        <div class="col-md-3">
	                                        	<input type="hidden" id="saf_dtl_id" name="saf_dtl_id" value="<?=(isset($basic_details['saf_dtl_id']))?$basic_details['saf_dtl_id']:"";?>">
