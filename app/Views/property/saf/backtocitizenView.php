                                                                        ...
                                                                        <div class="table-responsive">
                                                                            <table class="table table-bordered text-sm">
                                                                                ...
                                                                                if (isset($owner_detail["gender"])) {
                                                                                    if ($owner_detail["gender"] == 'Female' || $owner_detail["gender"] == 'Other') {
                                                                                        if (!isset($owner_detail["gender_doc_dtl"]) || $owner_detail['gender_doc_dtl']["verify_status"] != 1) {
                                                                                            $upload_doc_button_show++;
                                                                                            ?>
                                                                                            <tr>
                        ...
                        <tbody>
                            ...
                            <?php /* if (!empty($additional_document)) {  */?>
                                <tr>
                                    ...
                                    <td>
                                        <?php //dd($additional_document);
                                        if (isset($additional_document[0])) {
                                            $extention = strtolower(explode('.',  $additional_document[0]["doc_path"])[1]??"NA");
                                            if ($extention == "pdf") {
                                        ?>
                                                                    ...
                                                                    <form method="post" enctype="multipart/form-data">
                                                                        <table class="table table-bordered text-sm">
                                                                            <tr>
                                                                                <td><b>Document Name</b></td>
                                                                                <td>:</td>
                                                                                <td><select class="form-control checkDocType" name="doc_mstr_id" id="doc_mstr_id" required>
                                                                                        <option value="">Select</option>
                                                                                        <?php
