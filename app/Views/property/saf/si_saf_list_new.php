...
<div id="content-container">
    ...
    <div id="page-content">
        <div class="panel panel-bordered panel-dark">
            ...
            <div class="row">
                <div class="col-md-12">
                    <form class="form-horizontal" method="get" action="<?=base_url('si_saf/inbox_list_new');?>">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-primary btn-sm" href="<?= base_url('si_saf/view_new/' . md5($value['saf_dtl_id'])); ?>">View</a>
                                        </td>
                                    </tr>
                                <?php
                                }
