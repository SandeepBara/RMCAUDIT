...
<div id="content-container">
    <!--Page content-->
    <div id="page-content">
        <form id="form_saf_property" name="form_saf_property" method="post" action="<?=base_url('saf/AddUpdate2');?><?=(isset($param))?"/".$param:"";?>">
            <?php
            if(isset($validation)){
            ?>
            ...
            <div class="panel panel-bordered panel-dark">
                <div class="panel-heading">
                    <h3 class="panel-title">Self Assessment Form (<?=$assessmentType??""?>)
                        <?php
                ...
                <div class="panel-body">
                    ...
                    <div class="<?=($is_owner_changed==1)?"":"hidden";?>">
                        <div class="row">
                            <label class="col-md-3">Is the Applicant tax payer for the mentioned holding? If owner(s) have been changed <span class="text-danger">*</span></label>
                            <div class="col-md-3 pad-btm">
                                    ...
                                    if (isset($prop_owner_dtl_list)) {
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if($prop_owner_dtl['mobile_no']=="" || $prop_owner_dtl['mobile_no']==0){?>
                                                        <input type="text" id="prev_mobile_no<?=$key+1;?>" name="prev_mobile_no[]" class="form-control prev_mobile_no" value="<?=$prop_owner_dtl['mobile_no'];?>" placeholder="Enter Mobile No." onkeypress="return isNum(event);" maxlength="10" />
                                                    <?php } else {?>
                            ...
                            <div class="row">
                                <div class="col-md-2 col-xs-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="owner_name<?=$i+1;?>" name="owner_name[]" class="form-control owner_name" placeholder="Owner Name" value="<?=$owner_name[$i];?>" onkeypress="return isAlpha(event);" <?=$has_previous_holding_no=="1"?"readonly":"";?> />
                                    </div>
                                </div>
                                <div class="col-md-2 col-xs-6">
                                    <div class="form-group">
                                ...
                                <div class="col-md-2 col-xs-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" id="dob<?=$i+1;?>" name="dob[]" class="form-control dob" placeholder="Date of Birth" max="<?=date('Y-m-d', strtotime('-18 years'));?>" value="<?=$dob[$i]??"";?>" onkeypress="return isAlpha(event);" <?=$has_previous_holding_no=="1"?"readonly":"";?> />
                                    </div>
                                </div>
                                <div class="col-md-2 col-xs-6">
                                    <div class="form-group">
                                        <label class="control-label">Guardian Name</label>
                                        <input type="text" id="guardian_name<?=$i+1;?>" name="guardian_name[]" class="form-control guardian_name" placeholder="Guardian Name" value="<?=$guardian_name[$i];?>" onkeypress="return isAlpha(event);" <?=$has_previous_holding_no=="1"?"readonly":"";?> />
                                    </div>
                                </div>
                                <div class="col-md-2 col-xs-6">
                                    <div class="form-group">
                                        <label class="control-label">Relation</label>
                                        <select id="relation_type<?=$i+1;?>" name="relation_type[]" class="form-control relation_type" >
                                            <option value="">SELECT</option>
                                ...
                                <div class="col-md-2 col-xs-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="mobile_no<?=$i+1;?>" name="mobile_no[]" class="form-control mobile_no" placeholder="Mobile No." value="<?=$mobile_no[$i];?>" onkeypress="return isNum(event);" maxlength="10" <?=$has_previous_holding_no=="1"?"readonly":"";?> />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-2 col-xs-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="aadhar_no<?=$i+1;?>" name="aadhar_no[]" class="form-control aadhar_no" placeholder="Aadhar No." value="<?=$aadhar_no[$i];?>" onkeypress="return isNum(event);" maxlength="12" <?=$has_previous_holding_no=="1"?"readonly":"";?> />
                                    </div>
                                </div>
                                <div class="col-md-2 col-xs-6">
                                    <div class="form-group">
                                        <label class="control-label">PAN No.</label>
                                        <input type="text" id="pan_no<?=$i+1;?>" name="pan_no[]" class="form-control pan_no" placeholder="PAN No." value="<?=$pan_no[$i];?>" onkeypress="return isAlphaNum(event);" maxlength="10" <?=$has_previous_holding_no=="1"?"readonly":"";?> />
                                    </div>
                                </div>
                                <div class="col-md-2 col-xs-6">
                                    <div class="form-group">
                                        <label class="control-label">Email ID</label>
                                        <input type="email" id="email<?=$i+1;?>" name="email[]" class="form-control email" placeholder="Email ID" value="<?=$email[$i];?>" <?=$has_previous_holding_no=="1"?"readonly":"";?> />
                                    </div>
                                </div>
                                <div class="col-md-2 col-xs-6">
                                    <div class="form-group">
                        ...
                        <div class="panel-body"style="padding: 5px 10px;">
                            <div class="row">
                                ...
                                <div class="col-md-2 col-xs-6">
                                    <div class="form-group">
                                        <label class="control-label">Relation</label>
                                        <select id="relation_type1" name="relation_type[]" class="form-control relation_type" >
                                            <option value="">SELECT</option>
                            ...
                            <div class="row">
                                <div class="col-md-2 col-xs-6">
                                    <div class="form-group">
                                        <label class="control-label">Aadhar No.<!--  <span class="text-danger">*</span> --></label>
                                        <input type="text" id="aadhar_no1" name="aadhar_no[]" class="form-control aadhar_no" placeholder="Aadhar No." value="" onkeypress="return isNum(event);" maxlength="12" />
                                    </div>
                                </div>
                                <div class="col-md-2 col-xs-6">
                                    <div class="form-group">
                                        <label class="control-label">PAN No.</label>
                                        <input type="text" id="pan_no1" name="pan_no[]" class="form-control pan_no" placeholder="PAN No." value="" onkeypress="return isAlphaNum(event);" maxlength="10" />
                                    </div>
                                </div>
                                <div class="col-md-2 col-xs-6">
                                    <div class="form-group">
                                        <label class="control-label">Email ID</label>
                                        <input type="email" id="email1" name="email[]" class="form-control email" placeholder="Email ID" value="" />
                                    </div>
                                </div>
                                <div class="col-md-2 col-xs-6">
                                    <div class="form-group">
            ...
            <div class="panel panel-bordered panel-dark">
                ...
                <div class="panel-body" style="padding-bottom: 0px;">
                    <div class="row">
                        ...
                        <div class="col-md-3 pad-btm">
                            <input type="text" id="khata_no" name="khata_no" class="form-control" placeholder="Khata No." <?php if(!empty($khata_no)){echo 'Readonly="Readonly"';} ?> value="<?=(isset($khata_no))?$khata_no:"";?>" onkeypress="return isAlphaNum(event);" />
                        </div>
                        <label class="col-md-3">Plot No. <span class="text-danger">*</span></label>
                        <div class="col-md-3 pad-btm">
                            <input type="text" id="plot_no" name="plot_no" class="form-control" placeholder="Plot No." <?php if(!empty($plot_no)){echo 'Readonly="Readonly"';} ?> value="<?=(isset($plot_no))?$plot_no:"";?>" onkeypress="return isAlphaNum(event);" />
                        </div>
                    </div>
                    <div class="row">
                        <label class="col-md-3">Village/Mauja Name <span class="text-danger">*</span></label>
                        <div class="col-md-3 pad-btm">
                            <input type="text" id="village_mauja_name" name="village_mauja_name" class="form-control" placeholder="Village/Mauja Name"  <?php if(!empty($village_mauja_name)){echo 'Readonly="Readonly"';} ?> value="<?=(isset($village_mauja_name))?$village_mauja_name:"";?>" onkeypress="return isAlphaNum(event);" />
                        </div>
                    ...
                    <div class="row">
                        <div id="road_width_hide_show">
                            <label class="col-md-3">Road Width <span class="text-bold">(in ft)</span> <span class="text-danger">*</span><br /><span class="text-danger text-sm">In Case of No Road Enter "0" (For Vacant Land Only)</span></label></label>
                            <div class="col-md-3 pad-btm">
                                ...
                                <div class="table-responsive">
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="month" id="date_from<?=$i+1;?>" name="date_from[]" class="form-control date_from" value="<?=$date_from[$i];?>" max="<?=date('Y-m')?>" style="width: 175px;" />
                                                </td>
                                                <td>
                                                    <input type="month" id="date_upto<?=$i+1;?>" name="date_upto[]" class="form-control date_upto" value="<?=$date_upto[$i];?>" max="<?=date('Y-m')?>" style="width: 175px;" />
                                                </td>
                                                <td class="text-2x">
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="month" id="date_from1" name="date_from[]" class="form-control date_from" value="" max="<?=date('Y-m')?>" style="width: 175px;" />
                                                </td>
                                                <td>
                                                    <input type="month" id="date_upto1" name="date_upto[]" class="form-control date_upto" value="" max="<?=date('Y-m')?>" style="width: 175px;" />
                                                </td>
                                                <td class="text-2x">
                                                    <i class="fa fa-plus-square" style="cursor: pointer;" onclick="floor_dtl_append_fun();"></i>
                                                </td>
            ...
            <div class="panel panel-bordered panel-dark">
                <div class="panel-body" style="padding-bottom: 0px;">
                    ...
                    <div class="hidden" id="is_mobile_tower_hide_show">
                        <div class="row">
                            <label class="col-md-3">Total Area Covered by Mobile Tower & its Supporting Equipments & Accessories (in Sq. Ft.) <span class="text-danger">*</span></label>
                            <div class="col-md-3">
    ...
    Underground Storage Area (in Sq. Ft.) <span class="text-danger">*</span></label>
                    ...
                    <div class="hidden" id="vacant_land_occupation_date_hide_show">
                        <div class="row">
                            ...
                            <div class="col-md-3">
								<?php if($assessmentType == 'New-Assessment' && false){?>
...
<script type="text/javascript">	
    ...
    let propTypeMstrChngFun = function() {
        ...
        /* if(prop_type_mstr_id!=4 || prop_type_mstr_id==""){
            $("#road_type_mstr_id option[value='4']").remove();
        } else {
            if ($('#road_type_mstr_id > option').length==4) {
                $('#road_type_mstr_id').append('<option value="4">No road</option>');
            }
        } */
    }

    /* let roadTypeMstrChngFun = function() {
        if ($("#road_type_mstr_id").val()==4) {
            $("#road_width_hide_show").addClass("hidden");
        } else {
            $("#road_width_hide_show").removeClass("hidden");
        }
    } */
    ...
    let owner_dtl_append_fun = function() {
        ...
        var appendData = '<div class="panel panel-bordered-primary new_owner_dtl_panel">';
            ...
            appendData += '<div class="col-md-2 col-xs-6"><div class="form-group"><label class="control-label">Guardian Name</label><input type="text" id="guardian_name'+zo+'" name="guardian_name[]" class="form-control guardian_name" placeholder="Guardian Name" value="" onkeypress="return isAlpha(event);" /></div></div>';
            appendData += '<div class="col-md-2 col-xs-6"><div class="form-group"><label class="control-label">Relation</label><select id="relation_type'+zo+'" name="relation_type[]" class="form-control relation_type" ><option value="">SELECT</option><option value="S/O">S/O</option><option value="D/O">D/O</option><option value="W/O">W/O</option><option value="C/O">C/O</option></select></div></div>';
            ...
            appendData += '</div>';
            appendData += '<div class="row">';
            appendData += '<div class="col-md-2 col-xs-6"><div class="form-group"><label class="control-label">Aadhar No.</label><input type="text" id="aadhar_no'+zo+'" name="aadhar_no[]" class="form-control aadhar_no" placeholder="Aadhar No." value="" onkeypress="return isNum(event);" maxlength="12" /></div></div>';
            appendData += '<div class="col-md-2 col-xs-6"><div class="form-group"><label class="control-label">PAN No.</label><input type="text" id="pan_no'+zo+'" name="pan_no[]" class="form-control pan_no" placeholder="PAN No." value="" onkeypress="return isAlphaNum(event);" maxlength="10" /></div></div>';
            appendData += '<div class="col-md-2 col-xs-6"><div class="form-group"><label class="control-label">Email ID</label><input type="email" id="email'+zo+'" name="email[]" class="form-control email" placeholder="Email ID" value="" /></div></div>';
