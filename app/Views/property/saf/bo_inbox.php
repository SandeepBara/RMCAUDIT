	...
	<div id="page-content">
		<div class="panel panel-bordered panel-dark">
			...
			<div class="panel-body">
				<div class="row">
					<div class="col-md-12">
						<form class="form-horizontal" method="get" action="<?php echo base_url('boc_saf/inbox'); ?>">
								...
								?>
										...
										?>
											<tr>
												...
												<td><?= $value["remarks"]; ?></td>
												<td>
													<a class="btn btn-primary" href="<?php echo base_url('safDoc/SAFdocumentUpload/' . md5($value['saf_dtl_id'])); ?>" role="button">View</a>
												</td>
											</tr>
										<?php endforeach; ?>
									<?php endif;  ?>
