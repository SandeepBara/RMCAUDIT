...
<div id="content-container">
    <div id="page-head">
        <ol class="breadcrumb">
            ...
            <li class="active">GB SAF Inbox</li>
        </ol>
    </div>
    <div id="page-content">
        <div class="panel panel-bordered panel-dark">
            <div class="panel-heading">
                <h5 class="panel-title">GB SAF Inbox</h5>
            </div>
            <div class="panel-body">
                <div class ="row">
                    <div class="col-md-12">
                        <form class="form-horizontal" method="post" action="<?php echo base_url('si_saf/gb_index');?>">
                            ...
                            <table id="demo_dt_basic" class="table table-striped table-bordered text-sm">
                                ...
                                <?php $i=0; foreach ($inboxList as $value) { ?>
                                    <tr>
                                        ...
                                        <td><a class="btn btn-primary" href="<?php echo base_url('si_saf/verifyGBSaf/'.md5($value['id']));?>" role="button">View</a></td>
                                    </tr>
                                <?php } ?>
                                </tbody>
                            </table>
