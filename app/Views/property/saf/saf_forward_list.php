...
<div id="content-container">
    <div id="page-head">
        <ol class="breadcrumb">
            ...
            <li><a href="#">SAF</a></li>
            <li class="active">SAF Forward List</li>
        </ol>
    </div>
    <div id="page-content">
        <div class="panel panel-bordered panel-dark">
            <div class="panel-heading">
                <h5 class="panel-title">SAF Forward List</h5>
            </div>
            <div class="panel-body">
                <div class="row">
                    <div class="col-md-12">
                        <form class="form-horizontal" method="post" action="<?php echo base_url('documentverification/Outboxforwardlist'); ?>">
