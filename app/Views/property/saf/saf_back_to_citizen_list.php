					    ...
					    <div class="col-sm-12">
					        <div class="panel panel-bordered panel-dark">
                                ...
                                <div class="panel-body">
                                    <div class ="row">
                                        <div class="col-md-12">
                                            <form class="form-horizontal" method="post" action="<?php echo base_url('documentverification/saf_back_to_citizen_list');?>">
                                    ...
                                    <?php
                                            ...
                                            foreach ($posts as $value)
                                            {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="btn btn-primary" href="<?=base_url('safdtl/full/'.md5($value['id']));?>">View</a>
                                                    </td>
                                                </tr>
                                                <?php
                                            }
