...
<!--CONTENT CONTAINER-->
            ...
            <div id="content-container">
                <div id="page-head">
					...
					<li><a href="#">SAF</a></li>
					<li class="active">EO GB SAF List</li>
                    </ol>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End breadcrumb-->
                </div>
					    ...
					    <div class="col-sm-12">
					        <div class="panel panel-bordered panel-dark">
					            <div class="panel-heading">
					                <h5 class="panel-title">GB SAF List</h5>
					            </div>
                                <div class="panel-body">
                                    <div class ="row">
                                        <div class="col-md-12">
                                            <form class="form-horizontal" method="post" action="<?php echo base_url('EO_SAF/gb_index');?>">
                                    ...
                                    <table id="demo_dt_basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        foreach ($inboxList as $value)
                                        {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-primary" href="<?php echo base_url('EO_SAF/verifyGBSaf/'.md5($value['id']));?>" role="button">View</a>
                                                </td>
                                            </tr>
                                            <?php
                                        }
