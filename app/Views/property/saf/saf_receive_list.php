			...
			<div class="col-sm-12">
				<div class="panel panel-bordered panel-dark">
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-md-12">
								<form class="form-horizontal" method="get" action="<?=base_url('documentverification/inbox_list');?>">
										...
										?>
												...
												?>
													<tr>
														...
														<td>
															<a class="btn btn-primary" href="<?php echo base_url('DocumentVerification/verifyDocument/' . md5($value['saf_dtl_id'])); ?>">View</a>
														</td>
													</tr>
												<?php endforeach; ?>
											<?php endif;  ?>
