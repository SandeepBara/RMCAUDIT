...
<!--CONTENT CONTAINER-->
            <div id="content-container">
                <div id="page-head">
					...
					<li><a href="#">SAF</a></li>
					<li class="active">ULB TC SAF List</li>
                    </ol>
                </div>
                <!--Page content-->
                <div id="page-content">
					    ...
					    <div class="col-sm-12">
					        <div class="panel panel-bordered panel-dark">
					            <div class="panel-heading">
					                <h5 class="panel-title">ULB TC SAF List</h5>
					            </div>
                                <div class="panel-body">
                                    <div class ="row">
                                        <div class="col-md-12">
                                            <form class="form-horizontal" method="post" action="<?php echo base_url('ulbtc_saf/index');?>">
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-primary" href="<?php echo base_url('ulbtc_saf/view/'.md5($value['id']));?>" role="button">View</a>
