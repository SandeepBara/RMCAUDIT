...
<div id="content-container">
    <!--Page content-->
    <div id="page-content">
        <form method="post" id="form_saf_property" name="form_saf_property" action="<?=base_url('saf/addUpdate2');?><?=(isset($param))?"/".$param:"";?>">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 pad-btm">
                                ...
                                if(isset($wardList)){
                                    foreach ($wardList as $ward) {
                                ?>
                                <?=(isset($new_ward_mstr_id))?($ward['id']==$new_ward_mstr_id)? $new_ward = $ward['ward_no']:"":"";?>
                                <?php
                                    }
                                }else{
                                    echo "N/A";
                ...
                <div class="panel-body" style="padding-bottom: 0px;">
                    ...
                    <div class="<?=(isset($no_electric_connection))?"hidden":"";?>">
                        <div class="row">
                            ...
                            <div class="col-md-3 pad-btm">
                                <?=(isset($elect_consumer_no))?$elect_consumer_no:"";?>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 pad-btm">
                                <?=(isset($elect_acc_no))?$elect_acc_no:"";?>
                            </div>
                            <label class="col-md-3">BIND/BOOK No.</label>
                            <div class="col-md-3 pad-btm">
                                <?=(isset($elect_bind_book_no))?$elect_bind_book_no:"";?>
                            </div>
                        </div>
                    </div>
                </div>
...
Total Area of Wall / Roof / Land (in Sq. Ft.)</label>
    ...
    ?>
            ...
            <?php }
        if (!empty($cv_rule_arv_sub)) {
            ?>
                <div class="panel panel-bordered panel-dark">
                    <div class="panel-heading">
<!--                        <h3 class="panel-title">Capital Value - As Per Current Rule (Effect From 01-04-2022)</h3>-->
                        <h3 class="panel-title">Capital Value - As Per Old  Rule (Effect From 01-04-2022 to 31-03-2024)</h3>
                    </div>
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-12">
                ...
                <div class="panel panel-bordered panel-dark">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-md-12 mar-lft">
                                Circle Rate : <a href="#" class="text-bold text-dark" onclick="window.open('<?=base_url();?>/citizen_calc_factr/citizengetCapitalValueRateFactor24/<?= $new_ward ?>', 'newwindow', 'width=850, height=300'); return false;">Click here</a> to view circle rate.
                            </div>
                            <div class="col-md-12 mar-lft">
                                Occupancy Factor : <a href="#" class="text-bold text-dark" onclick="window.open('<?=base_url();?>/citizen_calc_factr/citizengetOccupancyFactor', 'newwindow', 'width=400, height=250'); return false;">Click here</a> here to view occupancy factors.
                            </div>
                                ...
                                <div class="table-responsive">
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td style="text-align: center;">Quarter : <?=($taxDtl["date_from"]."-01"<"2024-04-01")?1:$taxDtl['qtr'];?>   Financial Year : <?=($taxDtl["date_from"]."-01"<"2024-04-01")?"2024-2025":$taxDtl['fyear'];?> </td>
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td style="text-align: right;"><?=number_format($taxDtl["cv_2024_cal_method"]['resi_comm_type_rate']*100, 3);?>%</td>
                                                    <td style="text-align: right;"><?=number_format($taxDtl["cv_2024_cal_method"]['matrix_factor_rate'], 2);?></td>
                                                    <td style="text-align: center;">Quarter : <?=($taxDtl["date_from"]."-01"<"2022-04-01")?1:$taxDtl['qtr'];?> Financial Year : <?=($taxDtl["date_from"]."-01"<"2026-04-01")?"2024-2025":$taxDtl['fyear'];?> </td>
                                                    <td style="text-align: right;"><?=number_format($taxDtl['cv24'], 2);?></td>
                                                </tr>
                                        <?php
                                            }
