                        ...
                        <table class="table table-bordered" style="font-family:Arial, Helvetica, sans-serif; font-size:12px;">
                            <thead class="bg-trans-dark text-dark">
                                <tr>
                                    ...
                                    <th>Document</th>
                                    <th>Status</th>
                                    <?php if (isset($level_dtl['verification_status']) && $level_dtl['verification_status'] == 0) { ?>
                                    <th>Verify/Reject</th>
                                <?php } ?>
                                </tr>
                            </thead>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            if(isset($owner_document["owner_name"]))
                                            {
                                                ...
                                                <span class="text text-primary">(<?=$owner_document["owner_name"];?>)</span>
                                                <?php
                                            }elseif(isset($doc["doc_name"]) && in_array(strtoupper($doc["doc_name"]),["OTHER"])){
                                                ?>
                                                 <br>
                                                 <span class="text text-primary">(<?=$doc["other_doc"];?>)</span>
                                                 <?php 
                                             }
                                            ?>
                                        </td>
                                        ...
                                        <?php
                                            if($doc["verify_status"]==0)
                                            {
                                                ...
                                                $everyDocVerified=false; 
                                                if($doc['other_doc']=='trust_document' || $doc['other_doc']=='income_tax'){
                                                    $everyDocVerified=true; 
                                                }
                                                ?>
                                                ...
                                                <div class="modal fade" id="rejectModal<?=$i;?>" style="display: none;">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <h4 class="modal-title"> Mention Reason For Document Rejection - <?=$doc["doc_name"];?> </h4>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10" style="padding: 20px 20px 20px 10px;">
                                ...
                                if(!empty($memo) && $everyDocVerified==true)
                                {
                                    ...
                                    ?>
                                    <button type="submit" class="btn btn-primary" id="btn_forward" name="btn_generate_memo1">Forward</button>
                                    <!--button type="submit" class="btn btn-primary" id="btn_forward" name="btn_forward">Forward</button-->
                                    <?php
                                }
                                if(empty($memo) && $everyDocVerified==true)
                                {
                                    ...
                                    <!-- <button type="submit" class="btn btn-primary" id="btn_generate_memo1" name="btn_generate_memo1">Forward</button> -->
                                    <!-- <button type="button" class="btn btn-primary" id="btn_generate_memo1" name="btn_generate_memo1">Generate Memo</button> -->
                                    <button type="button" class="btn btn-primary hidden" id="btn_generate_memo2" name="btn_generate_memo2">Generating</button>
                                    <?php
                                }
                                ?>
                            </div>
...
<script>
    $("#btn_generate_memo1").click(function() {
        if ($("#remarks1").val()!="") {
            $("#btn_generate_memo1").addClass("hidden");
            $("#btn_generate_memo2").removeClass("hidden");
        }
    });
