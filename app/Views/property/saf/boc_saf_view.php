                ...
                <div id="page-content">
										...
										<div class="panel-body text-center">
                                            ...
                                            if($data['saf_dtl']['doc_upload_status']=='0')
                                             { 
                                            ?>
											<a href="<?php echo base_url('safdocument/index/'.$id);?>" type="button" class="btn btn-purple btn-labeled">Document Upload</a>
                                            <?php
                                            }
                                            else
                                            { 
                                            ?>
											<a href="<?php echo base_url('safdocument/view/'.$id);?>" type="button" class="btn btn-purple btn-labeled">Document Upload View</a>
                                            <?php
                                            }
                                            ?>
										</div>
