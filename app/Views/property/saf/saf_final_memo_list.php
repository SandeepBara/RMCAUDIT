...
<div id="content-container">
    <div id="page-head">
        <ol class="breadcrumb">
            ...
            <li><a href="#">SAF</a></li>
            <li class="active">FAM Memo List</li>
        </ol>
    </div>
    <div id="page-content">
        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-bordered panel-dark">
                    <div class="panel-heading">
                        <h5 class="panel-title">Final Memo List (Approved by Executive Officer)</h5>
                    </div>
                    <div class="panel-body">
                        <div class="row">
                        <div class="col-md-12">
                            <input type="hidden" id="encryptFrom" name="encryptFrom" value="<?=$sql??"";?>">
                            <form id="myForm" class="form-horizontal" method="get" action="<?php echo base_url('eo_saf/saf_final_memo_list'); ?>">
                            <div class="form-group">
                                ...
                                <div class="col-md-2">
                                    <label class="control-label" for="daId"><b>EMP List</b> </label>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-primary" onclick="window.open('<?= base_url('citizenPaymentReceipt/da_eng_memo_receipt'); ?>/<?= md5($ulb_mstr_id); ?>/<?= md5($value['memo_id']); ?>', 'newwindow', 'width=1000, height=1000'); return false;" role="button">View</a>
                                            </td>
                                        </tr>
                                    <?php
                                        }
...
<script>
    $("#btn_export").click(function() {
        ...
        try{
            ...
            $.ajax({
                type:"POST",
                url: "<?=base_url();?>/EO_SAF/saf_final_memo_list_excel",
                dataType: "json",
                processData: false,
                contentType: false,
