...
<div id="content-container">
    ...
    <div id="page-content">
                                                    ...
                                                    if ($owner_detail["gender"] == 'Female' || $owner_detail['gender'] == 'Other') { ?>
                                                        <td>
                                                            ...
                                                            ?>
                                                                    <a href="<?= base_url(); ?>/getImageLink.php?path=<?= $path; ?>" target="_blank">
                                                                        <img id="imageresource" src="<?= base_url(); ?>/public/assets/img/pdf_logo.png" class='img-lg' />
                                                                        <br><span class="text text-primary"><?= $owner_detail['gender_doc_dtl']["doc_name"]; ?><span>
                                                                    </a>
                                                            <?php
                                                                }
                                                            } else {
                                                    ...
                                                    if ($c_age > 60) { ?>
                                                        <td>
                                                            ...
                                                            ?>
                                                                    <a href="<?= base_url(); ?>/getImageLink.php?path=<?= $path; ?>" target="_blank">
                                                                        <img id="imageresource" src="<?= base_url(); ?>/public/assets/img/pdf_logo.png" class='img-lg' />
                                                                        <br><span class="text text-primary"><?= $owner_detail['dob_doc_dtl']["doc_name"]; ?><span>
                                                                    </a>
                                                            <?php
                                                                }
                                                            } else {
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                        ...
                                        <div class="modal fade" id="btn_upload_modal<?= $i; ?>" role="dialog">
                                            <div class="modal-dialog modal-lg">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form method="post" enctype="multipart/form-data">
                                                            <input type="hidden" name="other_doc" id="other_doc" value="<?= isset($row[0]["doc_type"]) ? $row[0]["doc_type"] : ''; ?>" />
                                                            <div class="table-responsive">
                                                                <form method="post" enctype="multipart/form-data">
                                                                    <table class="table table-bordered text-sm">
                                                                        <tr>
                                    ...
                                    <td><?= $docs_name; ?></td>
                                    <td><?= isset($row[0]["doc_type"]) ? implode(" ", explode("_", $row[0]["doc_type"])) : ''; ?></td>
                                </tr>
                            <?php
                            }
                            ?>

                            <!-- HARVESTING IMAGE UPLOAD -->
                            
                            <tr>
                                <td><?= ++$i; ?></td>
                                <td>
                                    <?php
                                    if (isset($additional_document[0]['other_doc'])) {
                                                            ...
                                                            <form method="post" enctype="multipart/form-data">
                                                                <table class="table table-bordered text-sm">
                                                                    <tr>
                                                                        <td><b>Document Name</b></td>
                                                                        <td>:</td>
                                                                        <td><select class="form-control checkDocType" name="doc_mstr_id" id="doc_mstr_id">
                                                                                <option value="">Select</option>
                                                                                <?php
                                                                                if (isset($additional_doc_list)) {
                                                                                    foreach ($additional_doc_list as $values) {
                                                                                ?>
                                                                                        <option value="<?= $values['id'] ?>"><?= $values['doc_name'] ?>
                                                                                        </option>
                                                                                <?php
                                                                            ...
                                                                            <input type="text" name="otherDocName" id="otherDocName" class="form-control otherDocName" style="display: none;">
                                                                        </td>
                                                                        <td>
                                                                            <input type="file" name="additional_doc_file" id="additional_doc_file" class="form-control" accept=".pdf" required />
                                                                            <span class="text text-danger">Only .pdf allowed</span>
                                                                        </td>
        ...
        // 1 Approved by EO
        // 2 Backtocitizen
        if ($everyDocUploaded == true && $payment_status == 1 && $saf_pending_status == 0) {
        ?>
            <div class="panel panel-dark">
                <div class="panel-body">
                    <div class="col-sm-2 col-sm-offset-5">
                        <a href="<?php echo base_url('safDoc/send_rmc/' . $saf_dtl_id); ?>" class="btn btn-info btn-md" id="btn_send_to_ulb">Send To ULB</a>
                    </div>
                </div>
            </div>
        <?php
        } else if (in_array($payment_status, [0,2])) {
        ?>
            <div class="panel panel-dark">
                <div class="panel-body">
...
<script>
    ...
    $(document).ready(function(){
        $(".checkDocType").on("change",function(event){
            const docId = (event.target.value);
            $(this).next(".otherDocName").hide().attr({required: false}).val("");
            if(docId==34){
                $(this).next(".otherDocName").show().attr({
                                                        required: true,
