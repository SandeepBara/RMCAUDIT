...
<div id="content-container">
	<div id="page-head">
        ...
        <li><a href="#">SAF</a></li>
		<li><a href="<?=base_url();?>/safdtl/full/<?=md5($tran_mode_dtl["prop_dtl_id"]);?>">SAF Details</a></li>
					...
					<div class="panel panel-dark">
						<div class="panel-body" id="print_watermark" style="width:90%;margin-left:5%;outline-style: dotted;padding:5px;color:black; ">
							...
							<div class="col-sm-10" style="text-align: center;">
								<img style="height:80px;width:80px;" src='<?php echo base_url("public/assets/$ulb[logo_path]");?>'>
							</div>
								...
								<tbody>
									...
									Account Description : Holding Tax &amp; Others</td>
										<td>
											...
											<div >Application No : &nbsp;<b><?=$saf_no;?></div>
										</td>
									</tr>
							...
							<table width="100%" border="0">
								<tbody>
									...
									<?php 
									$tran_mode_dtl["tran_mode"]=strtoupper($tran_mode_dtl["tran_mode"]);
									if(in_array(strtoupper($tran_mode_dtl["tran_mode"]),["CASH","ONLINE","CARD","UPI"]))
									{
										?>
										<tr>
											<td height="35">
