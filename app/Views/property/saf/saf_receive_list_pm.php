...
<div id="content-container">
	<div id="page-head">
		<ol class="breadcrumb">
			...
			<li><a href="#">SAF </a></li>
			<li class="active">Project Manager Inbox</li>
		</ol>
	</div>
	<div id="page-content">
		<div class="row">
			<div class="col-sm-12">
				<div class="panel panel-bordered panel-dark">
					<div class="panel-heading">
						<h5 class="panel-title">Project Manager Inbox List</h5>
					</div>
					<div class="panel-body">
						<div class="row">
							<div class="col-md-12">
								<form class="form-horizontal" method="get" action="<?=base_url('documentverification/inbox_list_pm');?>">
										...
										?>
												...
												?>
													<tr>
														...
														<td>
															<a class="btn btn-primary" href="<?php echo base_url('DocumentVerification/verifyPMDocument/' . md5($value['saf_dtl_id'])); ?>">View</a>
														</td>
													</tr>
												<?php endforeach; ?>
											<?php endif;  ?>
