    ...
    <div id="page-content">
        <div class="panel panel-mint">
            <div class="panel-heading">
                <h5 class="panel-title">SAF Collection Report</h5>
            </div>
				...
				<div class="col-md-12">
					...
					<div class="row">
						...
						<div class="col-md-3 has-success pad-btm">
							...
							?>
								<option value='<?=$list['id'];?>' <?=($list['status']==1)?"":"style='color:red'";?>><?=$list['emp_name']." (".$list['user_type'].")";?></option>
							<?php
								}
							}
							?>
        ...
        buttons: [
            'pageLength',
            {
                ...
                action: function ( e, dt, node, config ) {
                    ...
                    window.open('<?=base_url();?>/prop_report/SAFcollectionReportExcel/'+gerUrl).opener = null;
                }
            }
        ],
        'ajax': {
