    ...
    <div id="page-content">
        <div class="panel panel-mint">
            <div class="panel-heading">
                <h5 class="panel-title">Arrear And Current Collection Summary</h5>
            </div>
                        ...
                        <div class="table-responsive">
                            <table id="empTable" class="table table-striped table-bordered text-sm">
                                <thead>
                                    <tr>
                                        <th colspan="6"></th>
                                        <th colspan="2">Arrear Collection</th>
                                        <th colspan="2">Current Collection</th>
                                        <th colspan="5"></th>
                                    </tr>
                                    <tr>
                                        <th>#</th>
...
$(document).ready(function(){
    ...
    var dataTable = $('#empTable').DataTable({
        ...
        buttons: [
            'pageLength',
            {
                ...
                action: function ( e, dt, node, config ) {
                    ...
                    var gerUrl = search_from_date+'/'+search_upto_date+'/'+search_ward_mstr_id+'/'+search_collector_id;
                    window.open('<?=base_url();?>/prop_report/arrearAndCurrentCollectionSummeryExcel/'+gerUrl).opener = null;
                }
            }
        ],
        ...
        'ajax': {
            "type": "POST",
            'url':'<?=base_url('prop_report/arrearAndCurrentCollectionSummeryAjax');?>',
