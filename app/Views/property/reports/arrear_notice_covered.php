    ...
    <div id="page-content">
        <div class="panel panel-mint">
            <div class="panel-heading">
                <h5 class="panel-title">Arrear Other Then Covered In Traget</h5>
            </div>
        </div>
        ...
        <div class="panel panel-dark">
            <div class="panel-body">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="panel_header" align="center" style="font-wight:bold;">
                            <h5>PART 2 : ARREAR OTHER THAN COVERED IN TARGET 2 AND PART 1</h5>
                            <p>2.1 Residential</p>
                        </div>
                        <div class="table-responsive" style="overflow: hidden;">
                            <table id="empTable" class="table table-striped table-bordered text-sm">
                                <thead>
                                    <tr>
                                        <th rowspan="2">#</th>
                                        <th rowspan="2">Name of ULB</th>
                                        <th rowspan="2">No. of HH</th>
										<th rowspan="2">Demand <br/> (Rs. In Lakhs) </th>
                                        <th colspan="2">Notice Served</th>
                                        <th colspan="2">Notice Recovered</th>
                                    </tr>
                                    <tr>
                                        <th>No. of HH</th>
                                ...
                                <tbody>
                                    <?php
                                        $i=1;
                                        foreach($data['residential'] as $rdata){
                                    ?>

                                    <tr>
                                        <td><?=$i;?></td>
                                        <td>RANCHI MUNICIPAL CORPORATION</td>
                                        <td><?=$rdata['holding_hh']; ?></td>
                                        <td><?=round($rdata['arrear_demand']/100000); ?></td>
                                        <td><?=$rdata['notice_hh']; ?></td>
                                        <td><?=round($rdata['notice_demand']/100000); ?></td>
                                        <td><?=$rdata['recovered_hh']; ?></td>
                                        <td><?=round($rdata['recovered_demand']/100000); ?></td>
                                    </tr>
                        ...
                        <div class="table-responsive" style="overflow: hidden;">
                            <table id="empTable" class="table table-striped table-bordered text-sm">
                                ...
                                <tbody>
                                    <?php
                                        $i=1;
                                        foreach($data['non_residential'] as $ndata){
                                    ?>

                                    <tr>
                                        <td><?=$i;?></td>
                                        <td>RANCHI MUNICIPAL CORPORATION</td>
                                        <td><?=$ndata['holding_hh']; ?></td>
                                        <td><?=round($ndata['arrear_demand']/100000); ?></td>
                                        <td><?=$ndata['notice_hh']; ?></td>
                                        <td><?=round($ndata['notice_demand']/100000); ?></td>
                                        <td><?=$ndata['recovered_hh']; ?></td>
                                        <td><?=round($ndata['recovered_demand']/100000); ?></td>
                                    </tr>
                                    <tr style="font-weight:bold;">
                                        <td colspan="2" style="font-weight:bold;" align="right">Total:-</td>
                                        <td><?=$ndata['holding_hh']; ?></td>
                        ...
                        <div class="table-responsive" style="overflow: hidden;">
                            <table id="empTable" class="table table-striped table-bordered text-sm">
                                ...
                                <tbody>
                                    <?php
                                        $i=1;
                                        foreach($data['vacant_land'] as $vdata){
                                    ?>

                                    <tr>
                                        <td><?=$i;?></td>
                                        <td>RANCHI MUNICIPAL CORPORATION</td>
                                        <td><?=$vdata['holding_hh']; ?></td>
                                        <td><?=round($vdata['arrear_demand']/100000); ?></td>
                                        <td><?=$vdata['notice_hh']; ?></td>
                                        <td><?=round($vdata['notice_demand']/100000); ?></td>
                                        <td><?=$vdata['recovered_hh']; ?></td>
                                        <td><?=round($vdata['recovered_demand']/100000); ?></td>
                                    </tr>
                                    <tr style="font-weight:bold;">
                                        <td colspan="2" style="font-weight:bold;" align="right">Total:-</td>
                                        <td><?=$vdata['holding_hh']; ?></td>
