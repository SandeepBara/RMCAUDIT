    ...
    <div id="page-content">
        <div class="panel panel-mint">
            <div class="panel-heading">
                <h5 class="panel-title">Deactivated Holding</h5>
            </div>
        ...
        buttons: [
            'pageLength',
            {
                ...
                action: function ( e, dt, node, config ) {
                    ...
                    window.open('<?=base_url("/prop_report/deactivatedHoldingExcel/".$params??'');?>/'+gerUrl);//.opener = null;
                }
            }
        ],
        'ajax': {
            "type": "POST",
            'url':'<?=base_url('prop_report/deactivatedHoldingAjax/'.$params??'');?>',
            "deferRender": true,
            "dataType": "json",
            'data': function(data){
                // Append to data
