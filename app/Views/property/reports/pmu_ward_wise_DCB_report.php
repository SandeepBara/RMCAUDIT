                            ...
                            <table id="dataTableID" class="table table-striped table-bordered text-sm">
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <th colspan="2">Other Amount Collected</th>
                                        <th colspan="8">No of HH</th>
                                    </tr>
                                    <tr>
                                        ...
                                        <th rowspan="2">100% Residential</th>
                                        <th rowspan="2">100% Non-Residential</th>
                                        <th rowspan="2">Mix Holding</th>
                                        <th rowspan="2">State Govt Building</th>
                                        <th rowspan="2">Central Govt Building</th>
                                        <th rowspan="2">State PSU</th>
                                        <th rowspan="2">Central PSU</th>
                                        <th rowspan="2">Vacant Land</th>
                                    </tr>
                                    <tr>
                                ...
                                if (isset($report_list)) {
                                    ...
                                    foreach($report_list as $list)
                                    {
                                        ...
                                        <tr>
                                            ...
                                            <td><?=round($list["penalty"],2);?></td>
                                            <td><?=round(0,2);?></td>

                                            <td><?=round($list["res_100"],2);?></td>
                                            <td><?=round($list["non_res_100"],2);?></td>
                                            <td><?=round($list["mix_com"],2);?></td>
                                            <td><?=round($list["state_gov"],2);?></td>
                                            <td><?=round($list["central_gov"],2);?></td>
                                            <td><?=round($list["state_psu"],2);?></td>
                                            <td><?=round($list["central_psu"],2);?></td>
                                            <td><?=round($list["vacant_land"],2);?></td>
