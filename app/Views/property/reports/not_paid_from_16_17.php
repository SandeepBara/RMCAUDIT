    ...
    <div id="page-content">
        <div class="panel panel-mint">
            <div class="panel-heading">
                <h5 class="panel-title">Not Paid From 2016-2017</h5>
            </div>
        ...
        buttons: [
            'pageLength',
            {
                ...
                action: function ( e, dt, node, config ) {
                    ...
                    window.open('<?=base_url();?>/prop_report/notPaidFrom1617Excel/'+gerUrl);//.opener = null;
                }
            }
        ],
        'ajax': {
            "type": "POST",
            'url':'<?=base_url('prop_report/notPaidFrom1617Ajax');?>',
            "deferRender": true,
            "dataType": "json",
            'data': function(data){
                // Append to data
