    ...
    <div id="page-content">
        <div class="panel panel-mint">
            <div class="panel-heading">
                <h5 class="panel-title">HH which have paid only once at a time of SAF</h5>
            </div>
        </div>
                            ...
                            <table id="empTable" class="table table-striped table-bordered text-sm">
                                <thead>
                                    <tr>
                                        ...
                                        <th rowspan="2">No. of HH<br/>(<?=date('d.m.Y'); ?>)</th>
										<th rowspan="2">Demand <br/> (Rs. In Lakhs)<br/>(<?=date('d.m.Y'); ?>) </th>
                                        <th colspan="2" align="center">Untraceable</th>
                                        <th colspan="2" align="center">Traceable</th>
                                    </tr>
                                    <tr>
                                        <th>No. of HH</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?=$data['no_of_hh']; ?></td>
                                        <td><?=$data['demand']; ?></td>
                                        <td><?=$data['no_of_hh_untraced']; ?></td>
                                        <td><?=$data['demand_untraced']; ?></td>
                                        <td><?=$data['no_of_hh_traced']; ?></td>
                                        <td><?=$data['demand_traced']; ?></td>
                                    </tr>
