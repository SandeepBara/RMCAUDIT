    ...
    <div id="page-content">
        <div class="panel panel-mint">
            <div class="panel-heading">
                <h5 class="panel-title">Previous Year Paid But Not Paid Current Year</h5>
            </div>
        ...
        buttons: [
            'pageLength',
            {
                ...
                action: function ( e, dt, node, config ) {
                    ...
                    window.open('<?=base_url();?>/prop_report/prevYrPaidButNotPaidCurrentYrExcel/'+gerUrl);//.opener = null;
                }
            }
        ],
        'ajax': {
            "type": "POST",
            'url':'<?=base_url('prop_report/prevYrPaidButNotPaidCurrentYrAjax');?>',
            "deferRender": true,
            "dataType": "json",
            'data': function(data){
                // Append to data
