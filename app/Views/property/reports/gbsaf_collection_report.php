    ...
    <div id="page-content">
        <div class="panel panel-mint">
            <div class="panel-heading">
                <h5 class="panel-title">GBSAF Collection Report</h5>
            </div>
            <div class="panel-body">
				<div class="col-md-12">
					...
					<div class="row">
						...
						<div class="col-md-3 has-success pad-btm"></div>
                        ...
                        <div class="table-responsive">
                            <table id="empTable" class="table table-striped table-bordered text-sm">
                                ...
                                <tfoot>
                                    <tr class='bg-dark'>
                                        <th></th>
                                        <th style="color: white;">Total GBSAF</th>
...
$(document).ready(function(){
    ...
    var dataTable = $('#empTable').DataTable({
        ...
        buttons: [
            'pageLength',
            {
                ...
                action: function ( e, dt, node, config ) {
                    ...
                    window.open('<?=base_url();?>/prop_report/GBSAFcollectionReportExcel/'+gerUrl).opener = null;
                }
            }
        ],
        'ajax': {
            "type": "POST",
            'url':'<?=base_url('prop_report/GBSAFcollectionReportAjax');?>',
        ...
        'columns': [
            ...
            { 'data': 'ward_no' },
            { 'data': 'application_no' },
            { 'data': 'building_colony_name' },
            { 'data': 'office_name' },
            { 'data': 'building_colony_address' },
