                ...
                <div class="row">
                    ...
                    <div class="row">
                            ...
                            <div class="col-md-3 has-success pad-btm">
                                <select id='ward_mstr_id' disabled name="ward_mstr_id" class="form-control">
...
//                    $total_current_collection_amount = $total_current_collection_amount + $list['actual_collection_amount2'];
                ...
                $remain=$prop_collection-($total_arrear_collection_amount+$total_current_collection_amount);
                $total_current_collection_amount=$total_current_collection_amount+round($remain,2);
                    ...
                    <div class="col-sm-12">
                        <div class="table-responsive">
                            <table id="dataTableID" class="table table-striped table-bordered text-sm">
                                ...
                                if (isset($report_list)) {
                                    $i = 0;
                                    foreach($report_list as $k=>$list)
                                    {
                                        if($k==0)
                                        {
                                            $collectionsum=round($list['actual_collection_amount']+$list['actual_collection_amount2'],2)+($remain);
                                            $collectiontotal=round($list['total_collection_amount']+$list['total_collection_amount2'],2)+($remain);
                                        }else{
                                            $collectionsum=round($list['actual_collection_amount']+$list['actual_collection_amount2'],2);
                                            $collectiontotal=round($list['total_collection_amount']+$list['total_collection_amount2'],2);
                                        }
                                        ?>
                                        <tr>
                                            <td><?=++$i;?></td>
