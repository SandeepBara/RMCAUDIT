    ...
    <div id="page-content">
        <div class="panel panel-mint">
            <div class="panel-heading">
                <h5 class="panel-title">Holding Wise Demand Report</h5>
            </div>
            <div class="panel-body">
                <div class="row">
                    <div class="col-md-12">
                    <form method="post" action="<?php echo base_url('prop_report/exportdemandreport');?>">
                    <div class="row">
    ...
    $(document).ready(function(){
        function renderdataable(){
            ...
            var dataTable = $('#demandTable').DataTable({
                ...
                'ajax': {
                    "type": "POST",
                    'url':'<?=base_url('prop_report/demandreportAjax');?>',
                    "dataType": "json",
                    'data': function(data){
                        // Append to data
