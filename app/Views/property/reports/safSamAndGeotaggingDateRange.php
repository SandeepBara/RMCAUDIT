        ...
        <div class="panel panel-mint">
            ...
            <div class="panel-body">
                <div class="row">
                    ...
                    <form method="post">
                        <div class="row">
                            <label class="col-md-2 text-bold">Saf Apply From Date</label>
                            <div class="col-md-2 has-success pad-btm">
                                <input type="date" id='saf_apply_from_date' name='saf_apply_from_date' class="form-control" value="<?=$saf_apply_from_date??"";?>">
                            </div>
                            <label class="col-md-2 text-bold">Saf Apply Upto Date</label>
                            <div class="col-md-2 has-success pad-btm">
                                <input type="date" id='saf_apply_upto_date' name='saf_apply_upto_date' class="form-control" value="<?=$saf_apply_upto_date??"";?>">
                            </div>
                            ...
                            <table id="dataTableID" class="table table-striped table-bordered text-sm">
                                <thead>
                                    <tr>
                                        ...
                                        <th>No. of Geotagging<br>(4)</th>
                                        <th>No. of Back to Citizen<br>(5)</th>
                                        <th>No. of SAM Pending<br>(6)</th>
                                        <th>No. of FAM Pending<br>(7)</th>
                                    </tr>
                                </thead>
