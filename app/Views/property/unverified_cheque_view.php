										...
										<div class="panel panel-bordered panel-dark">
											<div class="panel-heading">
												<div class="panel-control">
													<a href="<?php echo base_url('UnverifiedCheque/detail')?>" class="btn btn-default">Back</a>
												</div>
											...
											<div class="panel-heading" style="background-color:#36a5d0;">
												<div class="col-md-6">
													<h3 class="panel-title">TC Name:<b>&nbsp;&nbsp;&nbsp;<?php echo $empDetails['emp_name']." ".$empDetails['last_name']; ?></b></h3>
												</div>
											
											<div class="col-md-6">
													<h3 class="panel-title" style="text-align: right;">Total Pending Amount:<b>&nbsp;&nbsp;&nbsp;<?php echo round($total,2); ?></b></h3>
												</div>
											</div>
