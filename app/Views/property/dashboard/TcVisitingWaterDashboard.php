                ...
                <div class="main_panel_container">
                    ...
                    <div class="right_box_main_container">
                        ...
                        <div class="right_box_main_container_1">
                            <h5>Month of Visit 
                                <span style="float: right;">
                                    ...
                                    <button id="module_3" data-role="module_3" onclick="setUrl(3)" class="btn btn-sm btn-primary" style="background: #007bff;">Water</button>
                        ...
                        <div class="right_box_main_container_2">
                            <div class="right_box_main_container_2_grid_container">
                                ...
                                <div class="card card-2">
                                    <div class="card-header">Total Water Connection</div>
                                    <div class="card-content">
                                        <div class="sub-div meter" >
                                            <p>Meter</p>
                                            <h2 id="total_meter_consumer">311897</h2>
                                        </div>
                                        <div class="sub-div fixed">
                                            <p>Non Meter</p>
                                            <h2 id="total_fixed_consumer">311897</h2>
                                        </div>
                                    </div>
                                </div>
                                <div class="card card-3">
                                    <div class="card-header">Bill Served</div>
                                    <div class="card-content">
                                        <div class="sub-div meter" >
                                            <p>Meter</p>
                                            <h2 id="total_meter_bill_served">311897</h2>
                                        </div>
                                        <div class="sub-div fixed">
                                            <p>Non Meter</p>
                                            <h2 id="total_fixed_bill_served">311897</h2>
                                        </div>
                                    </div>
                                </div>
                                <div class="card card-4">
                                    ...
                                    <div class="card-content">
                                        <div class="sub-div meter" >
                                            <p>Meter</p>
                                            <h2 id="total_meter_payment">311897</h2>
                                        </div>
                                        <div class="sub-div fixed">
                                            <p>Non Meter</p>
                                            <h2 id="total_fixed_payment">311897</h2>
                                        </div>
                                    </div>
                                </div>
                                <div class="card card-5 ">
                                    <div class="card-header">
                                        Bill Served Ratio
                                        <br />
                                        (Bill Served / Water Connection)

                                    </div>
                                    <div class="card-content card_5_content">
                                        <h2 id="bill_served_ratio" >0</h2>
                                        <div class="card-percentage">
                                            <small id="bill_served_ratio_per">0%</small>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="right_box_main_container_3">
                            ...
                            <div class="right_box_main_container_3_box_3 card content-area text-center">
...
<script type="text/javascript">
    ...
    var checkedValues = [];
    var fromDate ="";
    let cardUrl = "<?=base_url("NewDashboard/ajaxTcVisitingWaterDashboardHH");?>";
    let chartUrl = "<?=base_url("NewDashboard/ajaxTcVisitingWaterDashboard");?>";
    ...
    function callAjaxForDrawCards(data){
        $.ajax({
            ...
            beforeSend: function() {
                ...
                $("#total_meter_consumer").html('<div class="sk-three-bounce" style="margin:0;height:30px;"><div class="sk-child sk-bounce1"></div><div class="sk-child sk-bounce2"></div><div class="sk-child sk-bounce3"></div></div>');
                $("#total_fixed_consumer").html('<div class="sk-three-bounce" style="margin:0;height:30px;"><div class="sk-child sk-bounce1"></div><div class="sk-child sk-bounce2"></div><div class="sk-child sk-bounce3"></div></div>');
                $("#total_meter_bill_served").html('<div class="sk-three-bounce" style="margin:0;height:30px;"><div class="sk-child sk-bounce1"></div><div class="sk-child sk-bounce2"></div><div class="sk-child sk-bounce3"></div></div>');
                $("#total_fixed_bill_served").html('<div class="sk-three-bounce" style="margin:0;height:30px;"><div class="sk-child sk-bounce1"></div><div class="sk-child sk-bounce2"></div><div class="sk-child sk-bounce3"></div></div>');
                $("#total_meter_payment").html('<div class="sk-three-bounce" style="margin:0;height:30px;"><div class="sk-child sk-bounce1"></div><div class="sk-child sk-bounce2"></div><div class="sk-child sk-bounce3"></div></div>');
                $("#total_fixed_payment").html('<div class="sk-three-bounce" style="margin:0;height:30px;"><div class="sk-child sk-bounce1"></div><div class="sk-child sk-bounce2"></div><div class="sk-child sk-bounce3"></div></div>');
                $("#bill_served_ratio").html('<div class="sk-three-bounce" style="margin:0;height:30px;"><div class="sk-child sk-bounce1"></div><div class="sk-child sk-bounce2"></div><div class="sk-child sk-bounce3"></div></div>');
                $("#bill_served_ratio_per").html('<div class="sk-three-bounce" style="margin:0;height:30px;"><div class="sk-child sk-bounce1"></div><div class="sk-child sk-bounce2"></div><div class="sk-child sk-bounce3"></div></div>');
    ...
    function setCards(result){
        ...
        $("#total_meter_consumer").html(result?.total_meter_consumer??0);
        $("#total_fixed_consumer").html(result?.total_fixed_consumer??0);
        $("#total_meter_bill_served").html(result?.total_meter_bill_served??0);
        $("#total_fixed_bill_served").html((result?.total_fixed_bill_served??0));
        $("#total_meter_payment").html(result?.total_meter_payment??0);
        $("#total_fixed_payment").html((result?.total_fixed_payment??0));
        $("#bill_served_ratio_per").html(parseFloat((parseFloat(result?.total_meter_bill_served??0) + parseFloat(result?.total_fixed_bill_served??0) ) / ((parseFloat(result?.total_meter_consumer??0) + parseFloat(result?.total_fixed_consumer??0)) > 0 ? (parseFloat(result?.total_meter_consumer??0) + parseFloat(result?.total_fixed_consumer??0)) : 1)).toFixed(2) +" %");
        $("#bill_served_ratio").html(parseInt(result?.total_meter_bill_served??0) + parseInt(result?.total_fixed_bill_served??0));
    }
