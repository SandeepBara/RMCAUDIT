		...
		<div class="panel-heading">
			<h3 class="panel-title">
				...
				<ul class="nav nav-tabs pull-right">
					...
					<li id="trade_click_show">
						<a href="<?=base_url("NewDashboardTrade/index");?>">Trade</a>
					</li>
					<li id="water_click_show">
						<a href="<?=base_url("NewDashboard/Water_Dashbord_index");?>"  onclick="waterData();">Water</a>
					</li>
					<li class="prop_click_show active">
						<a href="<?=base_url("NewDashboard/index");?>" onclick="propertyData();">Property</a>
					</li>
				</ul>
			</h3>
		</div>
