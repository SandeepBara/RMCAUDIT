            ...
            <div id="content-container">
                ...
                <div id="page-content">
                    <div class="row" >
                        ...
                        <div class="panel panel-bordered panel-dark">
											<div class="panel-heading">
												<h3 class="panel-title">Demand Update</h3>
											</div>
                                            <div class="panel-body">
                                                <div class ="row">
                                                    <div class="col-md-12">
                                                        <form class="form-horizontal" method="post" action="">
                                                            <div class="form-group">
                                                                <div class="col-md-3">
                                                                    <label class="control-label" for="from_date"><b>New ARV <span class="text-danger">*</span></b> </label>
                                                                </div>
                                                                <div class="col-md-3">
                                                                    <input type="text" id="arv" name="arv" class="form-control" placeholder="ARV" value="" onkeypress="return isNumDot(event);" >                                                        
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <div class="col-md-3">
...
$(document).ready( function () {
    ...
    $("#arv").keyup(function(){$(this).css('border-color','');});
