                ...
                <div id="page-content">
					    ...
					    <div class="col-sm-12">
					        <div class="panel panel-bordered panel-dark">
					            <div class="panel-heading">
					                <h5 class="panel-title">Search Parameters</h5>
					            </div>
                                <div class="panel-body">
                                    <div class ="row">
                                        <div class="col-md-12">
                                            <form class="form-horizontal" method="post" action="<?php echo base_url('wh_Declaration/search_list');?>">
                                                <div class="form-group">
                                                    <div class="col-md-3">
                                                        <label class="control-label" for="from_date"><b>Holding No.</b> </label>
                                                    ...
                                                    <div class="col-md-3">
                                                        <label class="control-label" for="from_date"><b>Name</b> </label>
                                                    ...
                                                    <div class="col-md-3">
                                                        <label class="control-label" for="from_date"><b>Mobile No.</b> </label>
                                                        <input type="text" id="mobile_no" name="mobile_no" maxlength="10" class="form-control" placeholder="Mobile No." value="<?=(isset($mobile_no))?$mobile_no:"";?>" >                                                        
                                                    </div>
                                                    <div class="col-md-3">
                                                        <label class="control-label" for="from_date"><b>Ward No.</b> </label>
                    ...
                    <div class="row">
					    <div class="col-sm-12">
					        <div class="panel panel-bordered panel-dark">
					            <div class="panel-heading">
					                <h5 class="panel-title">Property List</h5>
					            </div>
                                <div class="panel-body">
                                    <div class="row">
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <?php
                                                    if($value["declaration_id"]=="")
                                                    {
                                                    ?>
                                                        <a class="btn btn-primary" href="<?php echo base_url('wh_Declaration/view/'.md5($value['id']));?>" role="button">View</a>
                                                    <?php 
                                                    }
                                                    else
                                                    {
                                                        ?>
                                                        <a class="btn btn-primary" href="<?php echo base_url('wh_Declaration/dlview/'.md5($value['id']));?>" role="button">View</a>
                                                        <?php
                                                    }
                                                    ?>
                                                </td>
