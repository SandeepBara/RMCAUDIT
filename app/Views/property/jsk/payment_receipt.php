...
<!--CONTENT CONTAINER-->
            ...
            <div id="content-container">
                <div id="page-head">
					...
					<li><a href="<?=base_url("propDtl/full/".md5($tran_mode_dtl["prop_dtl_id"]));?>">Property Details</a></li>
								...
								<div class="panel-body"  id="print_watermark" style="width:90%;margin-left:5%;outline-style: dotted;padding:5px;color:black; ">
											...
											<tbody>
												...
												Account Description : Holding Tax &amp; Others</td>
													<td>
														...
														<div >New Ward No : &nbsp;<b><?=$basic_details[0]["new_ward_no"];?></b> </div>
														<div >Holding No : &nbsp;<b><?=$holdingward["holding_no"];?></b></div>
										...
										<table width="100%" border="0">
											<tbody>
												...
												<?php if(in_array(strtoupper($payMode["transaction_mode"]),["CASH","ONLINE","CARD","UPI"])){ ?>
												<tr>
													<td height="35">
										...
										<div style="width: 99%; margin: auto; line-height: 35px; border-bottom: #000000 double 2px;"><strong style="font-size: 14px;">HOLDING TAX DETAILS </strong>
											...
											<table width="99%" border="1" align="center" cellpadding="0" cellspacing="0" style="font-family: Arial, Helvetica, sans-serif; font-size: 12px; text-align:center;">
												<tbody>
													...
													<td colspan="5" style="text-align:right;">
                                                            <?php if($penalty_dtl["head_name"]=="1% Monthly Penalty"){
                                                                echo "1% Monthly Interest";
                                                                }else{
                                                                  echo $penalty_dtl["head_name"];
                                                                }
                                                                ?>
                                                        </td>
													...
													<?php if(isset($advance_amt) && $advance_amt>0){?>
													<tr>
														<td colspan="5" style="text-align:right;"><b>Advance Amount</b></td>
														<td><b><?php echo round($advance_amt, 2);?></b></td>
													</tr>
													<?php } ?>
												</tbody>
											</table><br>
											...
											<table width="100%" border="0">
												<tr>
													<td align="right"><b>*Note:- The advance amount shall be adjusted in the next financial year demand</b></td>
												</tr>
											</table>
											<?php } ?>
											<table width="100%" border="0">
											...
											<table width="100%" border="0">
												<tbody>
													<tr>
														<!-- <td colspan="2" style="font-size:13px;">For Details Please Visit : <?=receipt_url();?></td> -->
														<td colspan="2" style="font-size:13px;"><?=receipt_url();?></td>
														</td>
