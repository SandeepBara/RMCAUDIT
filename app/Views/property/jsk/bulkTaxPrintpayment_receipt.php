...
<div id="content-container">
	...
	<form action="<?= base_url(); ?>/BulkTaxPrint/bulkTaxPrint" method="get">
		<div id="page-content" class="form_content">
			<div class="panel panel-mint">
				...
				<div class="panel-body">
					<div class="col-md-12">
						<div class="row">
							<label class="col-md-2 text-bold">From Transaction Date</label>
							<div class="col-md-3 has-success pad-btm">
								<input type="date" name="start_tran_date" id="start_tran_date" class="form-control" value="<?=$start_tran_date??date('Y-m-d');?>" />
							</div>
							<label class="col-md-2 text-bold">Upto Transaction Date</label>
							<div class="col-md-3 has-success pad-btm">
								<input type="date" name="end_tran_date" id="end_tran_date" class="form-control" value="<?=$end_tran_date??date('Y-m-d');?>" />
							</div>
						</div>
						<div class="row">
										...
										<tbody>
											...
											<tr>
												...
												<td>
													...
													<div><?=($data["tran_type"]=="Saf")?"Application No.":"Holding No.";?> : &nbsp;<b><?=$data["holding_no"];?></b></div>
