...
<div id="page-content">
                ...
                <div class="panel-body">
                    <form action="<?php echo base_url('jsk/jsk_Property_Tax');?>" method="post" role="form" class="form-horizontal">
                        <div class="col-md-7">
                            
                            <div class="row">
                                <div class="col-md-4">
                                    <label for="new_ward">Select Ward No.</label>
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <label for="holding_no">Enter Holding No.</label>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input type="text" id="holding_no" name="holding_no" class="form-control" value="" placeholder="Enter Old Holding No.">
                                    </div>
                                </div>
                            </div>
