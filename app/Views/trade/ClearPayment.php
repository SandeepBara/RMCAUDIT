                ...
                <div class="col-sm-12">
                    <div class="panel panel-bordered panel-dark">
                        <div class="panel-heading">
                            <h5 class="panel-title">Trade Online Payment Clear</h5>
                        </div>
                                ...
                                <div class="col-md-12">
                                    <form class="form-horizontal" method="get">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <label class="control-label" for="team_leader"><b>Application No</b> </label>
                                        ...
                                        else
                                        {
                                            ...
                                            foreach ($result as $value)
                                            {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a onClick="myPopup('<?=base_url('OnlineRequest/testApi/'.$value['id']);?>','xtf','900','700');" class='btn btn-primary'>
                                                            Clear
                                                        </a>
                                                    </td>
