    ...
    <div id="page-content">
        <div class="panel panel-mint">
            <div class="panel-heading">
                <h5 class="panel-title">Counter Reports</h5>
            </div>
        ...
        <div class="panel panel-dark">
            <div class="panel-heading ">
                <h5 class="panel-title">Application List</h5>
            </div>
            <div class="panel-body">
                <div class="row">
                    <div class="col-sm-12">                        
                            ...
                            <table id="empTable" class="table table-striped table-bordered text-sm">
                                <thead>
                                    <tr>
                                       ...
                                       <th>Pan No.</th>
                                       <th>Holding No.</th>
                                       <th>Occupancy type (Self/Tenanted)</th>
                                       <th>Name Of Owner in Case of Tenanted</th>
                                       <th>Owner Mobile No.</th>
                                       <th>Code of Trade Licence</th>
                                       <th>License year(time period)</th>
                                       <th>Applied Date</th>
                                       <th>Valid up to</th>
                                       <th>Active Status(Expire/Valid)</th>
                                       <th>Area as per TL Form</th>
                                       <th>Build up area as per SAF</th>
                                       <th>Tran.Date</th>
                                       <th>Tran. No.</th>
                                       <th>Payment Mode</th>
                                       <th>Payment status(online/c Cheque/if any cancellation of Cheque)</th>
                                       ...
                                       <th>File Status</th>
                                       <th>Whether inspection done or normalizer_get_raw_decomposition</th>
...
$(document).ready(function(){
    ...
    var dataTable = $('#empTable').DataTable({
        ...
        buttons: [
            'pageLength',
            {
                ...
                action: function ( e, dt, node, config ) {
                    ...
                    // if(entry_type!='')
                    // {
                    //     search_entry_type = entry_type=='1'?" isnull " :(entry_type=='2'?" notnull":'All');
                    // }                    
                    // var gerUrl = search_from_date+'/'+search_upto_date+'/'+search_ward_mstr_id+'/'+search_collector_id+'/'+search_entry_type ;
                    var gerUrl = search_ward_mstr_id;
                    window.open('<?=base_url();?>/Trade_report/counter_reportExcel/'+gerUrl).opener = null;
                }
            }
        ],
        ...
        'ajax': {
            "type": "POST",
            'url':'<?=base_url('Trade_report/counter_report');?>',
            //'url':'<?php //base_url('Trade_report/entry_detail_reportAjax');?>',
        ...
        'columns': [
            ...
            { 'data': 'holding_no' },
            { 'data': 'ownership_type' },
            { 'data': 'uper_owner_name' },
            { 'data': '' },
			{ 'data': 'nature_of_bussiness' },
            { 'data': 'licence_for_years' },
            { 'data': 'apply_date' },
            { 'data': 'valid_upto' },
            { 'data': 'active_status' },
            { 'data': 'area_in_sqft' },
