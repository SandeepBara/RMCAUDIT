        ...
        <div class="panel panel-dark">
            <div class="panel-heading "> 
                <div class="panel-title">
                    ...
                    <div class="col-md-3">
                        apply
                        <span id='apply' class=" text-info"></span>
                    </div>
                    <div class="col-md-3">
                        not apply
                        <span id='not_apply' class=" text-danger"></span>                        
                    </div>
                </div>               
            </div>
            <div class="panel-body">
...
$(document).ready(function(){
    ...
    var dataTable = $('#empTable').DataTable({
        ...
        'ajax': {
            "type": "POST",
            'url':'<?=base_url('Trade_report/total_notice_apply');?>',            
