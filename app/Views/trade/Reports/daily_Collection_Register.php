...
<!--CONTENT CONTAINER-->
            ...
            <div id="content-container">
                <div id="page-head">
                    ...
                    <li class="active">Daily Collection <?=$menu!=null?"Clear ":''?>Register</li>
                    </ol>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End breadcrumb-->
                </div>
                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-bordered panel-dark">
                                <div class="panel-heading">
                                    <h5 class="panel-title">Collection <?=$menu!=null?"Clear ":''?>Register</h5>
                                </div>
                                <div class="panel-body">
                                    <div class ="row">
                                        <div class="col-md-12">
                                            <form class="form-horizontal" method="post" action="<?=base_url("Trade_report/daily_Collection_Register".($menu!=null?"/$menu":""))?>" >
                                                <div class="form-group">
                                                    <div class="col-md-3">
														<label class="control-label" for="from_date"><b>Date</b> <span class="text-danger">*</span></label>
                                                    ...
                                                    <div class="col-md-3">
														...
														<input type="date" id="to_date" name="to_date" class="form-control" placeholder="From Date" value="<?=(isset($to_date))?$to_date:date('Y-m-d');?>" max="<?=date('Y-m-d');?>">
													</div>
                                                    <div class="col-md-2 ">
														...
														<select id="ward_id" name="ward_id" class="form-control" >
                                                            ...
                                                            if(isset($ward))
                                                            {
                                                                ...
                                                                {
                                                                    ?>
                                                                        <option value="<?=$val['id']?>" <?=isset($ward_id) && $ward_id==$val['id']?"selected":''?>><?=$val['ward_no']?></option>
                                                                    <?php
                                                                }
                                                            }
                                                            ?>
                                    ...
                                    <div class="panel panel-bordered panel-dark">
                                        ...
                                        <div class="panel-body " id="printable">
                                            <div class ="row panel panel-bordered panel-dark">
                                                <div class="panel-heading">
                                                    <h5 class="panel-title">Collection Register</h5>                                           
                                                </div>
                                                <div class="col-md-12 ">
                                                            ...
                                                            <tbody>
                                                                <?php 
                                                                    if(empty($records_application))
                                                                    {
                                                                        ?>
                                                                            <tr>
                                                                                <td colspan=<?=$menu!=null?14:13?> class="text-center text-danger">! NO DATA</td>
                                                                            </tr>
                                                                        <?php
                                                                    }
                                                                    else
                                                                    {
                                                                        $i=0;
                                                                        foreach($records_application as $val)
                                                                        {
                                                                            ?>
                                                                                <tr>
                                                                                    <td><?=++$i?></td>
                                                                                    <td><?=!empty($val['transaction_date'])?$val['transaction_date']:'N/A'?></td>
                                                                                    ...
                                                                                    <td><?=!empty($val['owner_name'])?$val['owner_name']:'N/A'?></td>
                                                                                    <td><?=!empty($val['ward_no'])?$val['ward_no']:'N/A'?></td>
                                                                                    <td><?=!empty($val['transaction_no'])?$val['transaction_no']:'N/A'?></td>
                                                                                    <td><?=!empty($val['mobile'])?$val['mobile']:'N/A'?></td>
                                                                                    <td><?=!empty($val['payment_mode'])?$val['payment_mode']:'N/A'?></td>
                                                                                    <td><?=!empty($val['paid_amount'])?$val['paid_amount']:'00.00'?></td>
                                                                                    <td><?=!empty($val['cheque_no'])?$val['cheque_no']:''?></td>
                                                                                    <td><?=!empty($val['emp_name'])?$val['emp_name']:'N/A'?></td>
                                                                                    <?=$menu!=null?("<td>".(!empty($val['verified_on'])?$val['verified_on']:'N/A')."</td> "):''?>
                                                                                </tr>
                                                                            <?php
                                                                         }
                                                                    }
                                            ...
                                            <br>
                                            <br>
                                            <div class="row panel-bordered panel-dark">
                                                <div class="panel-heading">
                                                    <h5 class="panel-title">TC Wise Collection Register</h5>                                           
                                                </div>
                                                <div class="col-md-12 ">
                                                    <table class="table table-striped table-responsive table-bordered ">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th rowspan="2" class="text-center">Tax Collector Name</th>
                                                                <th colspan="<?=count($payment_mode)?>" class="text-center">Payment Mode</th>
                                                            ...
                                                            <tr>
                                                                <?php 
                                                                    ...
                                                                    {
                                                                        ?>
                                                                            <th class="text-center"><?=$val['payment_mode']?></th>
                                                                        <?php
                                                                    }
                                                                ?>
                                                            </tr>
                                                                    ...
                                                                    ?>
                                                                        <tr>
                                                                            ...
                                                                            <?php
                                                                                ...
                                                                                {
                                                                                    ?>
                                                                                        <td class="text-center"><?=$val[$mode['payment_mode']]?></td>
                                                                                    <?php
                                                                                }
                                                                            ?>
                                            ...
                                            <div class="row panel-bordered panel-dark">
                                                <div class="panel-heading">
                                                    <h5 class="panel-title">Mode Wise Collection Register</h5>                                           
                                                </div>
                                                <div class="col-md-12 ">
                                                    <table class="table table-striped table-responsive table-bordered ">
                                                        <thead>
                                                        ...
                                                        <tbody>
                                                           <?php
                                                                $j=0; //print_var($pement_mode_collection);
                                                                foreach($payment_mode as $mode)
                                                                {
                                                                    $payment_mode=$mode['payment_mode'];
                                                                    $collection_data = array_filter($pement_mode_collection, function ($var) use ($payment_mode) {
                                                                        return ($var['payment_mode'] == $payment_mode);
                                                                    });
                                                                    $collection_data = array_values($collection_data)[0] ?? [];
                                                                    ?>
                                                                    <tr>
                                                                        <td><?=++$j?></td>
                                                                        <td><?=strtoupper($mode['payment_mode']);?></td>
                                                                        <td><?=$collection_data["count"] ?? 0;?></td>
                                                                        <td><?=$collection_data["amount"] ?? 0;?></td>
                                                                    </tr>
                                                                <?php
                                                                }
                                                           ?>
