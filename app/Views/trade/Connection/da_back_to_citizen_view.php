		...
		<div class="panel panel-bordered panel-dark">
			<div class="panel-heading">
				<div class="panel-control">
					<a href="<?php echo base_url('trade_da/da_back_to_citizen_list') ?>" class="btn btn-default">Back</a>
				</div>
						...
						else 
						{
							...
							else
							{
								...
								{ 
									?>
										<tr>
											<td><span class="text-danger"><?= $imgval['doc_for']; ?></span></td>
											<td>
												<?php
													$exp_ow_doc = explode('.', $imgval['document_path']);
												...
												{
													?>
													<a href="<?= base_url(); ?>/writable/uploads/<?= $imgval["document_path"]; ?>" target="_blank"><img id="imageresource" src="<?= base_url(); ?>/public/assets/img/pdf_logo.png" style="width: 40px; height: 40px;"></a>
													<?php
												}	
												else 
												{
													?>
													<a href="<?= base_url(); ?>/writable/uploads/<?= $docval['document_path']; ?>" target="_blank"><img id="imageresource" src="<?= base_url(); ?>/writable/uploads/<?= $docval['document_path']; ?>" style="width: 40px; height: 40px;"></img></a>
													<?php
												}
												?>
											</td>
							...
							else
							{
								foreach ($owner_details['saf_owner_doc_list'] as $docval) 
								{
									?>
									<tr>
										<td>Photo Id Proof (<span class="text-danger"><?= $docval['doc_name']; ?></span>)</td>
										<?php
