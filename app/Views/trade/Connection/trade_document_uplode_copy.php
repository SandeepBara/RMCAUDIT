           ...
           if($application_type["application_type"] == "NEW LICENSE"){?>
            <div class="panel panel-bordered panel-dark">
                ...
                <div class="panel-body" style="padding-bottom: 0px;">
                    <div class="table-responsive">
								...
								<tr>									
									<td id="ownername<?=$i?>" class="text-center"><?=$value['owner_name'];?>&nbsp;(ID Proof&nbsp;)<span style="color: #f00">*</span></td>
                                     <td style="text-align:center">
                                        ...
                                        {
                                            ?>
                                                <a href="<?=base_url();?>/writable/uploads/<?=$value['document_path'];?>" target="_blank"><img id="imageresource" src="<?=base_url();?>/public/assets/img/pdf_logo.png" style="width: 60px; height: 60px;"></a>
                        ...
                        <?php  $i=0; foreach($owner_list as $value){  $i++;?><br>
                                                        ...
                                                        <select  id="idproof<?=$i?>" name="idproof<?=$i?>" class="form-control idproof">
                                                            ...
                                                            <?php 
                                                                if($idprooflist)
                                                                {
                                                                    ...
                                                                    {
                                                                        ?>
                                                                        <option value="<?php echo $proofval['id'];?>" <?php if($proofval['id'] == $value['doc_document_id']){ echo 'selected="selected"'; } ?> ><?=$proofval["doc_name"]?></option>                                           
                                                                        <?php 
                                                                    }
                                                                }
                                                            ?>
                                    ...
                                    foreach($doc_details as $docvalue)
                                    {
                                        ...
                                        <tr> 
                                            ...
                                            <td style="text-align: left">
                                                ...
                                                {
                                                    ?>
                                                    <a href="<?=base_url();?>/writable/uploads/<?=$docvalue['docexists']['document_path'] ?? NULL;?>" target="_blank"><img id="imageresource" src="<?=base_url();?>/public/assets/img/pdf_logo.png" style="width: 60px; height: 60px;"></a>
                                                    <?php 
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="table-responsive">
                                                                    <table class="table table-bordered table-hover" >
                                                                        ...
                                                                        <td class="col-sm-4"><strong><?php echo $docvalue["doc_for"]; ?><?php $abc=str_replace(" ","_",$docvalue['doc_for'])?> &nbsp;</strong> ( pdf only)</td>
                                                                            <?php endif;?>	
                                                                            <input type="hidden" name="doc_for<?=$cnt?>" value="<?=$docvalue["doc_for"]?>" id="doc_for<?=$cnt?>">												<td colspan="3">
            ...
            if( $and_or  || $edit=='y')
            {
                ...
                <div class="panel panel-bordered panel-dark">
                    ...
                    <?php endif;?>
                            <?php 
                            if(($payment_mode=="CASH") || ($trade_conn_dtl['payment_status']==1 && $trade_conn_dtl['application_type_id']==4))
                            {
                                ?>
                                <a class="btn btn-primary" href="<?php echo base_url('TradeDocument/send_rmc/'.$apply_licence_id);?>" role="button" style="display:<?=$display?>">Send To Level</a>
                                <?php 
                            }
                            else
                            {
                                if(isset($cheque_details))
                                {
                                    ...
                                    {
                                        ?>
                                        <a class="btn btn-primary" href="<?php echo base_url('TradeDocument/send_rmc/'.$apply_licence_id);?>" role="button" style="display:<?=$display?>" >Send To RMC</a>
                                        <?php
                                    }
...
$(document).ready( function () { 
    ...
    $("#btn_agreement").click(function() {
        ...
        if (agreement_doc_path == '') {
            $("#agreement_doc_path").css({"border-color":"red"});
    ...
    $("#btn_registration_certificate").click(function() {
        ...
        if (registration_certificate_doc_path == '') {
            $("#registration_certificate_doc_path").css({"border-color":"red"});
    ...
    $("#btn_firm_agreement").click(function() {
        ...
        if (firm_agreement_doc_path == '') {
            $("#firm_agreement_doc_path").css({"border-color":"red"});
    ...
    $("#photo_id_proof_doc_path").change(function(){$(this).css('border-color','');});
    $("#registration_certificate_doc_path").change(function(){$(this).css('border-color','');});
    $("#firm_agreement_doc_path").change(function(){$(this).css('border-color','');});
    $("#agreement_doc_path").change(function(){$(this).css('border-color','');});
