					    ...
					    <div class="col-sm-12">
					        <div class="panel panel-bordered panel-dark">
					            <div class="panel-heading">
					                <h5 class="panel-title">DA Approved List</h5>
					            </div>
                                <div class="panel-body">
                                    <div class ="row">
                                        <div class="col-md-12">
                                            <form class="form-horizontal" method="post" action="<?php echo base_url('trade_da/da_approved_list');?>">
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-primary" href="<?php echo base_url('trade_da/da_approved_view/'.md5($value['id']));?>" role="button">View</a>
