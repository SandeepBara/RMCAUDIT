...
<div id="content-container">
    <div id="page-head">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="#" class="active">Nature Of Business Update </a></li>
        </ol><!--End breadcrumb-->
    </div>
    <!--Page content-->
    <div id="page-content">
            ...
            <table class="table ">
                ...
                <tbody>
                    <?php if(isset($license_data)){ ?>
                        ...
                        <tr>
                            <td><?= $license_data['license_no'] ?? 'NA' ?></td>
                            <td style="overflow: hidden;"><?= $license_data['firm_name'] ?? 'NA' ?></td>
                            <td><?= $license_data['application_no'] ?? 'NA' ?></td>
                            <td><?= $license_data['valid_from'] ?? 'NA' ?></td>
                            <td><?= $license_data['valid_upto'] ?? 'NA' ?></td>
                            <td>
                  ...
                  <?php }else{echo '<tr><td style="color:red;" colspan="6">No Result Found Please Enter Correct Application No </td></tr>';} ?>
              </tbody>
          </table>
