...
<div id="content-container">
    <div id="page-head">
        ...
        <li class="active">Trade Transaction Deactivate</li>
        </ol>
        <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
        <!--End breadcrumb-->
    </div>
    ...
    <div id="page-content">
        <div class="panel panel-bordered panel-dark">
            <div class="panel-heading">
                <h5 class="panel-title">Trade Transaction Deactivate</h5>
            </div>
            <div class="panel-body">
                <div class ="row">
                    <div class="col-md-12">
                        <form class="form-horizontal" method="post" action="<?=base_url('');?>/TradeTransactionDeactivate/detail">
                            <div class="form-group">
								<div class="row">
                                    <label class="control-label col-md-2" for="transaction_no">Transation No<span class="text-danger">*</span> </label>
                                    <div class="col-md-3">
                    ...
                    <div class="panel-body">
                        ...
                        <table id="demo_dt_basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <?php else:
                                        $i=0;
                                        foreach ($tradeTransactionList as $value):
                                ?>
                                    <tr>
                                        <td><?=++$i;?></td>
                                        ...
                                        <td><?=isset($value['branch_name'])?$value['branch_name']:"";?></td>
                                        <td>
                                            <a class="btn btn-primary" href="<?php echo base_url('TradeTransactionDeactivate/view/'.md5($value['id']));?>" role="button">View</a>
                                        </td>
                                    </tr>
                                <?php endforeach;  ?>
                                <?php endif;  ?>
