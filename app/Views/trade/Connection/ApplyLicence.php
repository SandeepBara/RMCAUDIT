                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-md-3 pad-btm">
                                <select name="applyWith" id="applyWith" class="form-control">
                    ...
                    <label class="col-md-4"><input type="checkbox" id="chk">&nbsp;Find with 16 digit holding number </label>                 
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8 pad-btm">
                                <input type="text" name="firm_name" id="firm_name" class="form-control" value="<?php echo isset($firm_name) ? $firm_name : ""; ?>" onkeypress="return isAlphaNumCommaSlashAmperstandApos(event);" style="text-transform: uppercase;">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 pad-btm">
                                <input name="firmaddress" id="firmaddress" class="form-control" onkeypress="return isAlphaNumCommaSlash(event);" value="<?php echo isset($address) ? $address : ""; ?>">
                            </div>
                        </div>
                ...
                <?php } else { ?>
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <label class="col-md-2">Business Description<span class="text-danger">*</span></label>
                            <div class="col-md-3 pad-btm">
                                <textarea name="brife_desp_firm" id="brife_desp_firm" style="width: 80%;" required <?=isset( $licencedet["brife_desp_firm"]) && trim( $licencedet["brife_desp_firm"])!=''?"readonly ":' onkeypress="return isAlphaNum(event);"'?>><?php echo $licencedet["brife_desp_firm"]; ?></textarea>
                            </div>
                        </div>
                    </div>
                <?php } ?>
                                            ...
                                            <select id="tade_item<?= $ti ?>" name="tade_item[]" class="form-control tade_item demo-select2-multiple-selects" required="required" onchange="borderNormal(this.id);" multiple="multiple" readonly disabled>
                                                ...
                                                ?>
                                                        <option value="<?php echo $valit['id']; ?>" <?php if (in_array($valit['id'], $tradeitemdet)) {
                                                                                                        echo "selected";
                                                                                                    } ?>><?php echo "(" . $valit['id'] . ") " . $valit['trade_item']; ?></option>
                                                <?php
                                                    }
                                                }
                                                ?>
...
<script>
    ...
    function trade_item_append_fun() {
        ...
        // }
        var tappendData = '<tr><td><select id="tade_item' + ti + '" name="tade_item[]" required="required" class="form-control tade_item"  onchange="show_charge()"><option value="">SELECT</option><?php if ($tradeitemlist) {
