            ...
            <div id="content-container">
                <div id="page-head">
                    ...
                    <ol class="breadcrumb">
						...
						<li><a href="<?=base_url('tradeapplylicence/trade_licence_view/'.md5($applicant_details['id']));?>">View Application</a></li>
				...
				<!-- ======= Cta Section ======= -->
							<div class="panel panel-bordered panel-dark">
								...
								<div class="col-sm-12 noprint text-right mar-top">
									<button class="btn btn-mint btn-icon" onclick="printDiv1('print_watermark')" style="height:40px;width:60px;">PRINT</button>
								</div>
								...
								<style type="text/css" media="print">
									...
									<!-- <div class="col-sm-1 noprint text-right">
										<button class="btn btn-mint btn-icon" onclick="printDiv1('print_watermark')"><i class="demo-pli-printer icon-lg"></i></button>
									</div> -->
										...
										<tbody>
											...
											<tr>
												<td height="35">
													...
													<div style="float: left;">
														towards :<strong style="font-size: 14px;"> Municipal License Fee </strong>&nbsp;&nbsp; vide Cheque No
													</div>
													<?php } else{ ?>
													<div style="float: left;">
														towards :<strong style="font-size: 14px;"> Municipal License Fee </strong>&nbsp;&nbsp; vide DD No
													</div>
													<?php } ?>
											...
											<tr>
												<td height="35">
													...
													<div style="border-bottom: #333333 dotted 2px; width: 180px; height: 20px; float: left; margin-left: 2px; padding-bottom: 3px; font-weight: 700;">
														&nbsp;&nbsp; <?=$cheque_details["cheque_date"] ?? NULL;?>
													</div>
											...
											<tr>
												<td height="35">
													<div style="border-bottom: #333333 dotted 2px; width: 499px; height: 20px; float: left; margin-left: 2px; padding-bottom: 3px; font-weight: 700;">
														&nbsp;&nbsp; <?=$cheque_details["branch_name"] ?? NULL;?>
													</div>
									...
									<div style="width: 99%; margin: auto; line-height: 35px; border-bottom: #000000 double 2px;"><strong style="font-size: 14px;">MUNICIPAL LICENSE FEE DETAILS </strong>
										...
										<table width="100%" border="0">
											<tbody>
												<tr>
													<td colspan="2" style="font-size:13px;">For Details Please Visit : <a href="udhd.jharkhand.gov.in">udhd.jharkhand.gov.in</a>
														<br>
									...
									<div class="water_mark"><img src="<?=base_url();?>/public/assets/img/logo/<?=$ulb_mstr_name["ulb_mstr_id"];?>.png"/></div>
								</div>
							</div>
						</div>
					</div>
