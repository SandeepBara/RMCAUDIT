...
<!--CONTENT CONTAINER-->
            ...
            <div id="content-container">
                <div id="page-head">
					...
					<li class="active">Trade Transaction Deactivation</li>
                    </ol>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End breadcrumb-->
                </div>
                ...
                <div id="page-content">
	                <div class="panel panel-bordered panel-dark">
						<div class="panel-heading">
							<div class="panel-control">
								<a class="btn btn-default" href="<?php echo base_url('TradeTransactionDeactivate/detail/'.md5($basic_details['transaction_no']));?>" role="button">Back</a>
							</div>
						...
						<div class="panel-body">
							...
							<div class="row">
								...
								<div class="col-md-3">
									<?=(isset($licenceDetails['application_no']))?$licenceDetails['application_no']:"";?>
								</div>
								<div class="col-md-1">
								</div>
								<div class="col-md-3">
								...
								<div class="col-md-3">
									<?=(isset($licenceDetails['firm_name']))?$licenceDetails['firm_name']:"";?>
								</div>
							</div>
							<div class="row">
								<div class="col-md-2">
								...
								<div class="col-md-3">
									<?=(isset($licenceDetails['apply_date']))?date('d-m-Y',strtotime($licenceDetails['apply_date'])):"";?>
								</div>
								<div class="col-md-1">
								</div>
								<div class="col-md-3">
									<b>Licence For Years:</b>
								</div>
								<div class="col-md-3">
									<?=(isset($licenceDetails['licence_for_years']))?$licenceDetails['licence_for_years']:"";?>
								</div>
							</div>
							<div class="row">
								<div class="col-md-2">
								...
								<div class="col-md-3">
									<?=(isset($licenceDetails['establishment_date']))?date('d-m-Y',strtotime($licenceDetails['establishment_date'])):"";?>
								</div>
								<div class="col-md-1">
								</div>
								<div class="col-md-3">
							...
							<div class="row">
								...
								<div class="col-md-3">
									<?=(isset($licenceDetails['area_in_sqft']))?$licenceDetails['area_in_sqft']." "."(sqft)":"";?>
								</div>
								<div class="col-md-1">
								</div>
								<div class="col-md-3">
								...
								<div class="col-md-3">
									<?=(isset($licenceDetails['address']))?$licenceDetails['address']:"";?>
								</div>
							</div>
							<div class="row">
								<div class="col-md-2">
								...
								<div class="col-md-3">
									<?=(isset($licenceDetails['pin_code']))?$licenceDetails['pin_code']:"";?>
								</div>
								<div class="col-md-1">
								</div>
								<div class="col-md-3">
								...
								<div class="col-md-3">
									<?=(isset($licenceDetails['landmark']))?$licenceDetails['landmark']:"";?>
								</div>
							</div>
						</div>
					...
					<div class="panel panel-bordered panel-dark">
	                    ...
	                    <div class="panel-body">
	                        <div class ="row">
	                            <div class="col-md-12">
	                                <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?=base_url('');?>/TradeTransactionDeactivate/create">
	                                    <div class="form-group">
	                                        <div class="col-md-3">
	                                        	<input type="hidden" id="transaction_id" name="transaction_id" value="<?=(isset($basic_details['id']))?$basic_details['id']:"";?>">
	                                        	<input type="hidden" name="licence_id" value="<?= $licenceDetails['id']; ?>">
