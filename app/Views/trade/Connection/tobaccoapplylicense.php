<?php $session = session();
// print_var($session->get('emp_details.user_type_mstr_id'));die();   ?>
<?= ($session->get('emp_details.user_type_mstr_id') ==5)?$this->include('layout_mobi/header'):$this->include('layout_vertical/header');?>
<style type="text/css">
    .error {
        color: red;
    }
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 pad-btm"><?php if($application_type["id"]==1 or $application_type["id"]==3){?>
							<select name="firmtype_id" id="firmtype_id" onchange="forother(this.value),validate_holding()" class="form-control" >
								...
								if(isset($firmtypelist))
								{   
									foreach($firmtypelist as $val)
									{

										?>
										<option value="<?php echo $val['id'];?>" <?php if($firm_type_id??null==$val['id']){echo "selected"; }?>><?php echo $val['firm_type'];?></option>
										<?php
									}
								}
								?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 pad-btm"><?php if($application_type["id"]==1 or $application_type["id"]==3){?>
                          <select name="ownership_type_id" id="ownership_type_id" onchange="validate_holding()" class="form-control">
							...
							<option value="<?php echo $val['id'];?>" <?php if($ownership_type_id??null==$val['id']){ echo "selected";}?>><?php echo $val['ownership_type'];?></option>
                          		<?php
                          	}
                          	}
                          	?>
                ...
                <div class="panel-body">                  
                    ...
                    <label class="col-md-2">Ward No. <span class="text-danger">*</span></label>
                            ...
                            <select name="old_ward_id" id="old_ward_id"  class="form-control">
                                ...
                                <?php
                                  if($ward_list)
                                  {
                                    ...
                                    {
                                ?>
                                <option value="<?php echo $val['id'];?>" <?php if($ward_id??null==$val['id']){echo "selected";} ?>><?php echo $val['ward_no'];?></option>
                                <?php 
                                    } 
                                  }
                                ?>
						...
						<div class="col-md-3 pad-btm" id="holding_div" >
                            ...
                            <span class="text-warning" id="holding_error"></span>
            ...
            <div class="panel panel-bordered panel-dark">
                ...
                <div class="panel-body">                                
                  ...
                  <label class="col-md-2">Total Charge<span class="text-danger">*</span></label>
                    <div class="col-md-3 pad-btm">
                    <input type="text"  id="total_charge"  disabled="disabled" class="form-control" value="<?php echo $total_charge??null ?>"  onkeypress="return isNum(event);">
                    </div>
       ...
       <?php //}?>
            ...
            <div class="panel panel-bordered panel-dark">
                ...
                <div class="panel-body demo-nifty-btn text-center">
                  <?php if(isset($debarredDetails) && $debarredDetails!=""){?>
...
<?= ($session->get('emp_details.user_type_mstr_id') ==5)?$this->include('layout_mobi/footer'):$this->include('layout_vertical/footer');?>
...
function forother(str){
  ...
  if(str==5){
    ...
    function validate_holding()
    {
         ...
         if(ward_id == ''){
            $("#holding_no").val('');
            alert("Select ward to check holding no..");
            return;
   ...
   var zo = <?=$zo;?>;
    ...
    { var timefor = $("#licence_for").val();
      ...
      if(str!="" && timefor!=""){
          $.ajax({
            type:"POST",
            url: '<?php echo base_url("tradeapplylicence/tobaccogetcharge");?>',
            dataType: "json",
            data: {
