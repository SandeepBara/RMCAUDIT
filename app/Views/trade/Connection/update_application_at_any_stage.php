...
<?php $session = session();
        ...
        if(isset($_SESSION['msgColseWindow']) && $_SESSION['msgColseWindow'] == "yes"){?>

            <script>
                alert("Application updated successfully!\n Click OK to reflect changes!");
                window.opener.location.reload(true);
                window.close();
            </script>

        <?php unset($_SESSION['msgColseWindow']);} ?>
            ...
            <div class="panel panel-bordered panel-dark">
                <div class="panel-heading">
                  <div class="panel-control">
                    <!-- <a class="btn btn-default" href="<?php echo base_url('trade_da/track_and_update_application');?>" role="button"><i class="fa fa-arrow-left" aria-hidden="true"></i>&nbsp;Back</a> -->
                </div>
...
<div class="panel panel-bordered panel-dark">
    ...
    if($application_type_id==1)
    {
        ...
        <div class="row">
            ...
            <div class="col-md-3 pad-btm">
                <input type="text" name="firm_name" id="firm_name" class="form-control" value="<?php echo isset($firm_name)?$firm_name:""; ?>"  onkeypress="return isAlphaNumCommaSlashAmperstandApos(event);">                       
            </div>
...
<!-- readonly="readonly" -->
        ...
        <div class="row">
            ...
            <div class="col-md-3 pad-btm">
                <input type="text" name="pin_code" id="pin_code"  maxlength="6" class="form-control" value="<?php echo isset($pin_code)?$pin_code:""; ?>" onkeypress="return isNum(event);">
            </div>
        </div>
        ...
        <div class="row">                        
            ...
            <div class="col-md-3 pad-btm">
                <input type="text"  name="owner_business_premises" id="owner_business_premises"  class="form-control" value="<?php echo isset($premises_owner_name)?$premises_owner_name:""; ?>" onkeypress="return isAlphaNumCommaSlash(event);">
            </div>
                                        ...
                                        <td>
                                            ...
                                            else
                                            {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" id="mobile_no<?=$zo;?>" name="mobile_no[]" class="form-control mobile_no" placeholder="Mobile No." value="<?=$value['mobile']!=""?$value['mobile']:"";?>" onkeypress="return isNum(event);" onkeyup="borderNormal(this.id);" maxlength="10" /><?php //echo $value['mobile']!=""?$value['mobile']:"";?>
                                                    </td>
                                                    <td>
                                                        <input type="text" id="emailid<?=$zo;?>" name="emailid[]" class="form-control address" placeholder="Email Id" value="<?=$value['emailid']!=""?$value['emailid']:"";?>" onkeyup="borderNormal(this.id);"  />
                                                        <?php //echo $value['emailid']!=""?$value['emailid']:"";?>
                                                    </td>
                                                    <td><?= $value['address']; ?></td>
                                            ...
                                            if(!empty($tradeitemdet)){
                                                /*if(!empty($tradeitemdet)){*/
                                                    foreach ($tradeitemdet as  $itemvalue) {
                                                        ...
                                                        <tr>                                            
                                                            <td>
                                                                <select id="tade_item<?=$ti?>" name="tade_item[]" class="form-control tade_item" required="required" readonly  onchange="borderNormal(this.id);">
                                                                    <option value="">SELECT</option>
                                                                    <?php
                                                                    if($tradeitemlist)
                                                                    {
                                                                ...
                                                                <?php $display_plus ='none'; ?>
                                                            <td class="text-2x">
                                                                <i class="fa fa-plus-square" id="my_plus" style="cursor: pointer; display: <?= $display_plus; ?>" onclick="trade_item_append_fun();"></i>
                                                                &nbsp; 
                                                                <?php if($ti>1){?>
                                                                    <i class="fa fa-window-close remove_trade_item" id="my_minus" style="cursor: pointer; display: none;"></i>
                                                                <?php }?>
                                                            </td>
                                                        </tr>
                                                        <?php 
            ...
            <div class="panel panel-bordered panel-dark">
                <div class="row">
                   <div class="col-md-12" style="margin:10px;">
                        <input type="checkbox" name="btn_confirmation" id="btn_confirmation">
                        <label for="btn_confirmation">I am fully aware of the legal provisions contained in this form and other rules and sections of Jharkhand Muncipal Holding Tax Rule 2013 and Jharkhand Muncipal Act 2011 and above information is correct to best of my knowledge & belief.!</label>
                    </div>
                </div>
...
<script>
    $(document).ready(function(){
        ...
        if(nobs_val.length ==1 && nobs_val[0]==198){
            ...
            // alert("This field can\'t be chnaged!");
        }else{

            $('#my_plus').css('display','block');
            $('#my_minus').css('display','block');

            // alert("This field can be changed !");
        }
...
$( document ).ready(function() {
    ...
    if(firmtype_id == 2 || firmtype_id == 3){
        ...
        // alert("This is a partnership firm");    
    }else{
...
function validate_holding()
{
    ...
    var holding_no=$("#holding_no").val();
        ...
        if(holding_no !="" && ward_id =='')
        {
            ...
            alert('First Select Your Ward No.');
            return;
        }
        if(holding_no==""){
               $("#holding_no").val("");
            ...
            success:function(data){
                 ...
                 if (data.response==true) {
                    ...
                    for(var k in data.dd) {
                        ...
                        tbody+='<td><input type="text" id="address'+i+'" name="address[]" class="form-control address" placeholder="Address" value="" onkeypress="return isAlphaNumCommaSlash(event);" onkeyup="borderNormal(this.id);" maxlength="30" /></td>';
