					    ...
					    <div class="col-sm-12">
					        <div class="panel panel-bordered panel-dark">
                                ...
                                <div class="panel-body">
                                    <div class ="row">
                                        <div class="col-md-12">
                                            <form class="form-horizontal" method="post" action="<?php echo base_url('TradeDocument/index');?>">
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td>
													<?php if($value['document_upload_status']==0 ){?> 
														<a class="btn btn-primary" href="<?=base_url('');?>/Trade_Apply_Licence/applynewlicence/<?=md5($value["id"]);?>" role="button">Update</a>
													<?php } else if($value['document_upload_status']==2){?>												
														<a class="btn btn-primary" href="<?php echo base_url('TradeDocument/doc_upload/'.md5($value['id']));?>" role="button">Upload</a>
													<?php }else{?>
														<a class="btn btn-primary" href="<?php echo base_url('TradeDocument/view/'.md5($value['id']));?>" role="button">View</a>
													<?php } ?>
                                                </td>
                                            </tr>
                                        <?php endforeach;?>
