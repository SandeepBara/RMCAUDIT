                 ...
                 <form method="POST"> 
                    ...
                    <?php if($application_type["id"]>1){?> 
                        <div class="row">
                            ...
                            <div class="col-md-3 has-primary pad-btm">
                                <input type="text" id="Searchlicense" name="Searchlicense" value="<?php echo isset($Searchlicense)?$Searchlicense:'';?>" class="form-control" />
                            </div>

                            <div class="col-md-3 has-primary pad-btm">
                               <input type="Submit" id="btn_search" class="btn btn-primary col-md-12" value="SEARCH" />
                            </div>
                        </div> 
                        <div class="row">
                            <div class="col-md-12 has-primary pad-btm text-info">
                                <?php echo $msg; ?>
                            </div>
                        </div>
                    <?php }?>                      
