...
<div id="content-container">
    <div id="page-head">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="#" class="active">Update Application Details</a></li>
        </ol><!--End breadcrumb-->
    </div>
    <div id="page-content">
        <form name="searchApplication" method="post">
                <?php if(isset($error)){ ?>
                    <?php echo $error; ?>
                <?php } ?>
            ...
            <h3 class="panel-title">Search Application Details</h3>
                </div>
                <div class="panel-body">
                    <div class="row">
                        <label class="col-md-2">Application No.<span class="text-danger">*</span></label>
                        <div class="col-md-3 pad-btm">
                        <input type="text" name="applicationNo" id="applicationNo" class="form-control"  placeholder="Enter Application Number" value="<?php echo isset($applicationNo)?$applicationNo:"";?>">       
						</div>
                        <div class="col-md-2 pad-btm">
                        <button  type="submit" id="btn_searchApplin" name="btn_searchApplin"   class="btn btn-success">Search</button>
                        </div>
                    </div>
                </div>
               </div>
            ...
            <div class="panel panel-bordered panel-dark">
                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <input   readonly type="text" name="applicationType" id="applicationType" class="form-control" value="<?php echo isset($application_type['application_type'])?$application_type['application_type']:"N/A"; ?>"  onkeypress="return isAlphaNum(event);">                                                 
                        </div>
                        ...
                        <select name="firmtype_id" id="firmtype_id" onchange="forother(this.value),validate_holding()" class="form-control" >
          								...
          								if($firmtypelist)
          								{
          									...
          									{
          								?>
          										<option value="<?php echo $val['id'];?>" <?php if($applicationDetails['firm_type_id']==$val['id']){echo "selected"; }?>><?php echo $val['firm_type'];?></option>
          								<?php	}}?>
          				</select>	
                    	</div>
                    </div>
                    <div class="row">
                        ...
                        <select name="ownership_type_id" id="ownership_type_id" onchange="validate_holding()" class="form-control">
                          	...
                          	if($ownershiptypelist)
                          	{
                          		...
                          		{
              							?>
              							<option value="<?php echo $val['id'];?>" <?php if($applicationDetails['ownership_type_id']==$val['id']){ echo "selected";}?>><?php echo $val['ownership_type'];?></option>
                          		<?php
                          	}
                          	}
                          	?>
                        ...
                        <div class="col-md-3 control-label text-semibold">
                        <input  readonly type="text" name="firm_name" id="firm_name" class="form-control" value="<?php echo isset($applicationDetails['license_no'])?$applicationDetails['license_no']:"N/A"; ?>"  onkeypress="return isAlphaNum(event);">                                                 
                        </div> 
                    </div>
                        ...
                        <select name="category_type_id" id="category_type_id"  class="form-control">
                            ...
                            if($categoryTypeDetails){
                              foreach($categoryTypeDetails as $vdata){?>
                                <option value="<?php echo $vdata['id'];?>" <?php if($applicationDetails['category_type_id']==$vdata['id']){ echo "selected";}?>><?php echo $vdata['category_type'];?>
                                </option>
                              <?php }
                            }
                            ?>
                   ...
                   <?php if($applicationDetails['otherfirmtype']!=""){ ?>
                    <div class="row">
                         <label class="col-md-2 classother">For Other Firm type<span class="text-danger">*</span></label>
                        <div class="col-md-3 pad-btm classother">
                          <input type="text" name="firmtype_other" id="firmtype_other" class="form-control" value="<?php echo isset($applicationDetails['otherfirmtype'])?$applicationDetails['otherfirmtype']:""; ?>" placeholder="Other Firm type"  onkeypress="return isAlphaNum(event);">  
                        </div>
                    </div>
                    <?php } ?>
                </div>
            ...
            <div class="panel panel-bordered panel-dark">
                ...
                <div class="panel-body"> 
                    ...
                    <label class="col-md-2">Ward No. <span class="text-danger">*</span></label>
                        <div class="col-md-3 pad-btm">
                            <select name="ward_mstr_id" id="ward_mstr_id"  class="form-control" onchange="validate_holding(),onkeyup=openModel()">
                                <option value="">Select</option>
                                <?php
                                  if($ward_list)
                                  {
                                    ...
                                    {
                                ?>
                                <option value="<?php echo $val['id'];?>" <?php if($applicationDetails['ward_mstr_id']==$val['id']){echo "selected";} ?>><?php echo $val['ward_no'];?></option>
                                <?php 
                                    } 
                                  }
                                ?>
						...
						<div class="col-md-3 pad-btm" id="holding_div" >
                            <input type="text" readonly name="holding_no" id="holding_no" class="form-control" onchange="validate_holding()" value="<?php echo isset($applicationDetails['holding_no'])?$applicationDetails['holding_no']:""; ?>"  onkeypress="return isAlphaNum(event);">
                            <input type="hidden" name="prop_id" id="prop_id">
						</div>
					</div>  

                    <input type="hidden" id="id" name="id" value="<?=$applicationDetails['id']?>">

					<div class="row">
						<label class="col-md-2">Firm Name<span class="text-danger">*</span></label>
						<div class="col-md-3 pad-btm">
							<input   type="text" name="firm_name" id="firm_name" class="form-control" value="<?php echo isset($applicationDetails['firm_name'])?$applicationDetails['firm_name']:""; ?>"  onkeypress="return isAlphaNum(event);">                                                 
                        </div>

						<label class="col-md-2">Total Area(in Sq. Ft) <span class="text-danger">*</span></label>
						<div class="col-md-3 pad-btm"> 
							<input readonly type="text" name="area_in_sqft" id="area_in_sqft" class="form-control" onblur="show_charge()" value="<?php echo isset($applicationDetails['area_in_sqft'])?$applicationDetails['area_in_sqft']:""; ?>" onkeypress="return isNumDot(event);">
						</div>                    
					</div>
					...
					<div class="row">
						...
						<div class="col-md-3 pad-btm">
							<input type="date" name="firm_date" id="firm_date" class="form-control" value="<?php echo isset($applicationDetails['establishment_date'])?$applicationDetails['establishment_date']:date('Y-m-d'); ?>" onchange="show_charge(); checkDOB()"  onkeypress="return isNum(event);"> 

						</div>
						<label class="col-md-2">Business Address<span class="text-danger">*</span></label>
						<div class="col-md-3 pad-btm">
							<input name="firmaddress" id="firmaddress" class="form-control"  onkeypress="return isAlphaNum(event);" value="<?php echo isset($applicationDetails['address'])?$applicationDetails['address']:"";?>" >                         
						</div>
					</div>
					...
					<div class="row">  
						...
						<div class="col-md-3 pad-btm">
							<input name="landmark" id="landmark" class="form-control"  value="<?php echo isset($applicationDetails['landmark'])?$applicationDetails['landmark']:"N/A";?>" >                         
						</div>

						<label class="col-md-2">Pin Code<span class="text-danger">*</span></label>
						<div class="col-md-3 pad-btm">
							<input type="text" name="pin_code" id="pin_code"  maxlength="6" minlength="6" class="form-control" value="<?php echo isset($applicationDetails['pin_code'])?$applicationDetails['pin_code']:""; ?>" onkeypress="return isNum(event);">
						</div>
                    </div>
                    <div class="row"> 
                        ...
                        <div class="col-md-3 pad-btm">
                            <select name="new_ward_mstr_id" id="new_ward_mstr_id"  class="form-control">
                             <option value="">Select</option>
                                <?php
                                  if($ward_list)
                                  {
                                    ...
                                    {
                                ?>
                                <option value="<?php echo $val['id'];?>" <?php if($applicationDetails['new_ward_mstr_id']==$val['id']){echo "selected";} ?>><?php echo $val['ward_no'];?></option>
                                <?php 
                                    } 
                                  }
                                ?>
                        ...
                        <label class="col-md-2">Nature Of Business</label>
                        <div class="col-md-3 pad-btm">
                            <input readonly type="text"  name="natureOfBusiness" id="natureOfBusiness"  class="form-control" value="<?php echo isset($applicationDetails['nature_of_bussiness'])?$applicationDetails['nature_of_bussiness']:"N/A"; ?>" />
                        </div>
					</div>
                    <div class="row">                        
                        <label class="col-md-2">Owner of Business Premises</label>
                        <div class="col-md-3 pad-btm">
                            <input type="text"  name="owner_business_premises" id="owner_business_premises"  class="form-control" value="<?php echo isset($applicationDetails['premises_owner_name'])?$applicationDetails['premises_owner_name']:"N/A"; ?>" />
                        </div>
                    </div>
			   </div>
            </div>
            ...
            <div class="panel panel-bordered panel-dark" >
                    <div class="panel-heading">
                        <h3 class="panel-title">Add More Nature Of Business </h3>
                    </div>
                    <div class="panel-body">
                        <div class="row" >
                            <div class="col-md-12">
                            <table class="table table-bordered text-sm">
                                    ...
                                    ?>
                                            <tr>                                            
                                                <td>
                                                    <select id="tade_item<?=$ti?>" name="tade_item[]" class="form-control tade_item"   onchange="borderNormal(this.id);">
                                                        <option value="">SELECT</option>
                                                        <?php
                                                if($tradeitemlist)
                                                {
                ...
                <div class="panel-body" style="padding-bottom: 0px;">
                    <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <table class="table table-bordered text-sm" id="ownertable">
                                                        ...
                                                        <tbody id="">
                                                            <?php  $zo = 0; foreach($ownerDetails as $value){?>
                                                        <tr>
                                                        <input type="hidden" name="owner_name_id[]" value="<?=$value['id']!=""?$value['id']:"";?>">

                                                            <td>
                                                                <input value="<?= $value['owner_name']?>" type="text" id="owner_name<?=$zo;?>" name="owner_name[]" class="form-control owner_name" placeholder="Owner Name"  onkeypress="return isAlpha(event);"  />
                                                            </td>
                                                            <td>
                                                                <input value="<?= $value['guardian_name']?>" type="text" id="guardian_name<?=$zo;?>" name="guardian_name[]" class="form-control guardian_name" placeholder="Guardian Name"  onkeypress="return isAlpha(event);"  />
                                                            </td>                                            
                                                            <td>
                                                                <input value="<?= $value['mobile']?>" type="text" id="mobile_no<?=$zo;?>" name="mobile_no[]" class="form-control mobile_no" placeholder="Mobile No."  onkeypress="return isNum(event);"  maxlength="10" />
                                                            </td>
                                                            <td>
                                                                <input value="<?= $value['emailid']?>" type="email" id="emailid<?=$zo;?>" name="emailid[]" class="form-control address" placeholder="Email Id"    maxlength="30" />
                                                            </td> 
                        ...
                        <div class="panel-body demo-nifty-btn text-center">
                            <button type="submit" id="btn_submit" name="btn_submit" onclick="return confirmsubmit()" class="btn btn-primary">Update</button>
                        </div>
                       </div> 
                            </div>
                        </div>
      ...
      if(<?=$application_type['id']?>==1)
      {
        ...
        if(str!="" && timefor!=""){
          $.ajax({
            ...
            dataType: "json",
            data: {
                    "areasqft":str,"applytypeid":<?=$application_type["id"]?>,"estdate":edate, "licensefor":timefor, "tobacco_status":0
            },
...
<script>
    ...
    {  
        sn++;
        var appendData = '<tr><td><input type="text" id="owner_name1'+sn+'" name="owner_name1[]" class="form-control owner_name" placeholder="Owner Name" value="" onkeypress="return isAlpha(event);" onkeyup="borderNormal(this.id);" /></td><td><input type="text" id="guardian_name1'+sn+'" name="guardian_name1[]" class="form-control guardian_name" placeholder="Guardian Name" value="" onkeypress="return isAlpha(event);" onkeyup="borderNormal(this.id);" /></td><td><input type="text" id="mobile_no1'+sn+'" name="mobile_no1[]" class="form-control mobile_no" placeholder="Mobile No." value="" onkeypress="return isNum(event);" onkeyup="borderNormal(this.id);" maxlength="10" /></td><td><input type="text" id="emailid1'+sn+'" name="emailid1[]" class="form-control address" placeholder="Email Id" value="" onkeypress="return isAlphaNum(event);" onkeyup="borderNormal(this.id);"  /></td><td class="text-2x"><i class="fa fa-plus-square" style="cursor: pointer;" onclick="owner_dtl_append_fun();"></i> &nbsp; <i class="fa fa-window-close remove_owner_dtl" style="cursor: pointer;"></i></td></tr>';
    ...
    { 
        ...
        if(firmtype_id==2)
        {
            var rowCount = $("#ownertable tbody tr").length; 
            if(rowCount!=2){
    ...
    <script>
        ...
        {  
            if($("#formname").valid())
            {
             var res=confirm("Are you sure you want to submit the form");
            return res;
            }
            else
            {
