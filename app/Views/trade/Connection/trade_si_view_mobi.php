                                    ...
                                    foreach ($doc_exists as  $value)
                                    {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            	...
                                            	<!-- <a class="btn btn-danger btn-rounded btn-labeled" role="button" data-toggle="modal" data-target="#view_documents">
                                                    view document
                                                </a> -->
                                                <a role="button" data-toggle="modal" data-target="#view_documents" > <img id="imageresource" src="<?=base_url();?>/public/assets/img/pdf_logo.png" style="width: 40px; height: 40px;"></a>

                                                <!-- new model for image viewing area -->
                                                        <div class="modal fade" id="view_documents">
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                    	<embed src="<?=base_url();?>/writable/uploads/<?=$value['document_path'];?>" frameborder="0" width="100%" height="400px">
                                                                        <!-- <img src="<?=base_url();?>/writable/uploads/<?=$value['document_path'];?>"> -->
                                                                    </div>
