...
<!--CONTENT CONTAINER-->
            ...
            <div id="content-container">
                <div id="page-head">
					...
					<li class="active">Trade EO Denial <?=$listName?> List</li>
                    </ol>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End breadcrumb-->
                </div>
					    ...
					    <div class="col-sm-12">
					        <div class="panel panel-bordered panel-dark">
					            <div class="panel-heading">
					                <h5 class="panel-title">Trade EO Denial <?=$listName?> List</h5>
					            </div>
                                <div class="panel-body">
                                    <div class ="row">
                                        <div class="col-md-12">
                                            <form class="form-horizontal" method="post" action="<?php if($mailStatus==1){echo base_url("Trade_EO/denialInbox/$mailStatus");} else{echo base_url("Trade_EO/denial/$mailStatus");}?>">
                                    ...
                                    ?>
                                            <tr>
												...
												<td><?=$value["created_on"]?$value["created_on"]:"N/A";?></td>
                                                 <td>
                                                    <a class="btn btn-primary" href="<?php echo base_url('Trade_EO/denialview/'.md5($value['denial_id']).'/'.md5($value['id']));?>" role="button">View</a>
                                                </td>
                                            </tr>
                                        <?php endforeach;?>
                                         <?php endif;  ?>
