            ...
            <div id="content-container">
                ...
                <div class="panel-heading">
                    <div class="panel-control">
                        <a href="<?php echo base_url(substr($_SESSION["url"], strpos($_SESSION["url"], "RMCDMC") + 7)) ?>" class="btn btn-default">Back</a>
                    </div>
                    ...
                    <div class="row">
						 ...
						 <div id="watermarklogo">
                             ...
                             <table style="width:100%;color:#B9290A;">
                                 ...
                                 <tr>
                                     <td width="900px">Nature of Entity : <span style="font-weight:bold;" >
                                         <?php
                                                 ...
                                                 <?php echo  wordwrap($tradeitem,40, "<br>\n"); ?>
                                                 
                                         </span></td>
                                     <td>Street Address : <span style="font-weight:bold;" ><?=strtoupper($prop_dtl['prop_address']).', '.$prop_dtl['prop_city'];?></span></td>
                                 </tr>
                                 <tr>
                                 ...
                                 <tr>
                                     <td>&nbsp;&nbsp;
										...
										<p >This is to declare that <b><?=$licence_dtl['firm_name'];?></b> having application number <b><?=$licence_dtl['application_no'];?></b> has been successfully registered with us 
                                            with satisfactory compliance of registration criteria and to certify that trade licence number <b><?=$licence_dtl['licence_no'];?></b>
