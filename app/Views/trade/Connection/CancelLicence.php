...
<!--CONTENT CONTAINER-->
            ...
            <div id="content-container">
                <div id="page-head">
					...
					<li class="active">Rejected Licence</li>
                    </ol>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End breadcrumb-->
                </div>
					    ...
					    <div class="col-sm-12">
					        <div class="panel panel-bordered panel-dark">
					            <div class="panel-heading">
					                <h5 class="panel-title">Rejected Licence</h5>
					            </div>
                                <div class="panel-body">
                                    <div class ="row">
                                        <div class="col-md-12">
                                            <form class="form-horizontal" method="post" action="<?php echo base_url('Trade_EO/licenceCancel');?>">
                                                <div class="form-group">
													...
													<div class="col-md-3">
													 ...
													 <div class="col-md-3">
														...
														<input type="text" id="keyword" name="keyword" class="form-control" placeholder="Enter Keyword" value="<?=$keyword ?? NULL;?>">
													</div>
													<div class="col-md-3">
									...
									?>
										<tr>
											...
											<td>
												<a href="<?php echo base_url('TradeDocument/view/'.md5($value['id']));?>" class="btn btn-primary"> View </a>
											</td>
										</tr>
                                        <?php endforeach;?>
                                        <?php endif;  ?>
...
<script type="text/javascript">
	...
	// {
	// 	var result = confirm("Do You Want To Cancel Licence");
	// 	if(result)
	// 	 window.location.replace("<?=base_url();?>/Trade_EO/licenceCancel/"+ID);
	// }
 </script>
