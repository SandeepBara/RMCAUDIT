	...
	<div id="page-content">
		<div class="panel panel-bordered panel-dark">
			...
			<div class="panel-heading flex" style="display: flex;">
				<div style="flex:1;">
					<h3 class="panel-title"><b style="color:white;">List Of School Run By Trust</b></h3>
				</div>
								...
								<div class="panel-body">
									...
									<div class="row">
										<div class="col-sm-4 col-xs-4 text-center">
												<a href="viewDetails/<?= $value["saf_dtl_id"] ?>"><span class="btn btn-sm btn-info btn_wait_load">Click To Upload Trust Certificate</span></a>
										</div>
									</div>
								</div>
							</div>
