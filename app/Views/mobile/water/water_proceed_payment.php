...
<div id="content-container">
    ...
    <div id="page-content">
            <div class="panel panel-bordered panel-dark">
                ...
                else
                {
                    $link='WaterSearchApplicantsMobile/search_applicants_tc';
						...
						?>
						<span class="btn btn-info btn_wait_load"><a href="<?php echo base_url($link);?>"  style="color: white;">Back</a></span>
					</div>
              ...
              <table class="table table-bordered" style="font-size:12px;">
                ...
                <tr>
                  ...
                  <tr>
                        ...
                        <td><a href="<?php echo base_url('WaterPaymentConnectionMobile/view_transaction_receipt/'.$water_conn_id.'/'.md5($val['id']));?>" style="color: #1919bd;">View</a></td>
                  </tr>
      ...
      if($consumer_details['payment_status']==0 or isset($conn_fee_charge) || $penalty>0)
			{
        ?>
        ...
        {
          ?>
          <form method="post" action="<?php echo base_url('WaterPaymentConnectionMobile/proceed_payment');?>" id="myform">
            <div class="panel panel-bordered panel-dark">
              <div class="panel-heading">
              ...
              <div class="table-responsive">
                ...
                <table class="table table-bordered" style="font-size:14px;">
                  ...
                  <tr  id="cheque_details" style="display: none;">
                    <td>Cheque/DD No: <span style="color:red;">*</span></td>
                    <td>
                      <input type="text" name="cheque_no" id="cheque_no" class="form-control">
                    </td>
                    <td>Cheque/DD Date: <span style="color:red;">*</span></td>
