    ...
    <div id="page-content">
        ...
        <div class="panel panel-bordered panel-dark">
            <div class="panel-heading">                    
                ...
                {
                    ?>
                        <a class="panel-control pull-right btn btn-info btn-sm" href="#" onclick="history.back();">
        ...
        <div class="panel">
                ...
                if(($dues ||$pay) and ($user_type==1 or $user_type==8 or $user_type==5 or $user_type==4))
                {
                    ?>
