        ...
        <div class="panel panel-bordered panel-dark">
            <div class="panel-heading">
                <div class="panel-control">
                    <a class="pull-right btn btn-info btn_wait_load"
                        href="<?= base_url() . '/WaterViewConsumerMobile/view/' . $consumer_dtls['id'] ?>">
                    ...
                    <form method="post" id="myform">
                        ...
                        <div class="row">
                            ...
                            if (isset($connection_dtls['connection_type']) && $connection_dtls['connection_type'] == 3 || isset($from_month)) {
                                ...
                                <div class="col-md-3 pad-btm">
                                    <select name="from_month" id="from_month" class="form-control" onchange="getAmountPayable()"
                                        required disabled>
                                        <?php
                                        $demand_list1 = $connection_dtls['connection_type'] == 3 ? (isset($from_month) && !empty($from_month) ? $from_month : $demand_list) : $from_month;
                                        $demand_list1 = array_reverse($demand_list1);
                                        if ($demand_list1) {
                                            foreach ($demand_list1 as $val) {
                                                ?>
                                                <option value="<?php echo $val['demand_from']; ?>">
                            ...
                            <label class="col-md-2">Select
                                Month<?= isset($connection_dtls['connection_type']) && ($connection_dtls['connection_type'] == 3 || isset($from_month)) ? " Upto" : '' ?></label>
                            <div class="col-md-3 pad-btm">
                                <select name="month" id="month" class="form-control" onchange="getAmountPayable()" required
                                    <?= isset($from_month) ? "" : ''; ?>>
                                    <?php
                        ...
                        <div class='row'>
                            ...
                            <div class="col-md-3 pad-btm">
                                <input type="text" name="penalty" id="penalty" class="form-control" value="" readonly
                                    required />
                            </div>
                            <label class="col-md-2">Other Penalty</label>
                            <div class="col-md-3 pad-btm">
                                <input type="text" name="other_penalty" id="other_penalty" class="form-control" value=""
                                    readonly required />
                            </div>
                        </div>
                        <div class='row'>
                            ...
                            <div class="col-md-3 pad-btm">
                                <input type="text" name="rebate" id="rebate" class="form-control" value="0.00" readonly
                                    required />
                            </div>
                            <label class="col-md-2">Advance</label>
                            <div class="col-md-3 pad-btm">
                                <input type="text" name="advance" id="advance" class="form-control" value="0.00" readonly
                                    required />
                            </div>
                        </div>
                        <div class='row'>
                            <label class="col-md-2"><span class="remain_advance_block">Remain Advance( in
                                    Rs.)</span></label>
                            <div class="col-md-3 pad-btm"><span class="remain_advance_block text-warning"
                                    id="remain_advance" style="font-weight: bold; font-size:17px;"></span></div>
                        ...
                        <div class="row" id="chq_dtls1" style="display: none;">
                            ...
                            <div class="col-md-3 pad-btm">
                                <input type="text" name="cheque_no" id="cheque_no" class="form-control"
                                    onkeypress="return isAlphaNum(event);" placeholder="Enter Cheque No.">
                            </div>
                        ...
                        <div class="row" id="chq_dtls3" style="display: none;">
                            ...
                            <div class="col-md-3 pad-btm">
                                <input type="text" name="bank_name" id="bank_name" class="form-control"
                                    onkeypress="return isAlpha(event);" placeholder="Enter Bank Name">
                            </div>
                            <label class="col-md-2">Branch Name</label>
                            <div class="col-md-3 pad-btm">
                                <input type="text" name="branch_name" id="branch_name" class="form-control"
                                    onkeypress="return isAlpha(event);" placeholder="Enter Branch Name">
                            </div>
                        ...
                        <div class="row">
                            <div class="text-center">
                                <input type="submit" name="pay" id="pay" value="Pay Now" class="btn btn-primary">
                            </div>
                        </div>
