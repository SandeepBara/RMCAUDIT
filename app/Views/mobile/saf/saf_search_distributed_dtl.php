...
<div id="content-container">
    <!--Page content-->
    <div id="page-content">
        <form id="search_form" method="post" action="<?= base_url('MobiSaf/searchDistributedDtl'); ?>">
            <?php
            if (isset($validation)) {
            ?>
            ...
            <div class="panel panel-bordered panel-dark">
                <div class="panel-heading">
                    <div class="panel-control">
                        <button type="button" id="saf_form_btn" class="btn btn-mint btn_wait_load" data-target="#existing_holding_details-lg-modal" data-toggle="modal" value="<?= md5(1); ?>">Apply</button>
                        <a href="<?=base_url('Mobi/mobileMenu/property');?>" class="btn btn-info btn_wait_load">Back</a>
                    </div>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                ?>
                                                                    ...
                                                                    <button type="button" id="saf_form_btn" class="btn btn-mint btn_wait_load" data-target="#existing_holding_details-lg-modal" data-toggle="modal" value="<?= md5($row['id']); ?>">Apply</button>
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a id="link_without" href="<?= base_url('MobiSaf/searchDistributedDtl/New-Assessment'); ?>" type="button" class="btn btn-primary">No</a>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="fixed_width_table">
                    <div class="col-md-12 hidden table-responsive" id="searchResultTableHideShow">
...
<script type="text/javascript">
    $("#saf_form_btn").click(function() {
        ...
        $('#link_with_form_id').attr('href', `<?= base_url('MobiSaf/searchDistributedDtl/New-Assessment'); ?>/${saf_form_id}`)
    });
                        ...
                        if (data.response == true) {
                            ...
                            $.each(data.data.prop_dtl, function(k, v) {
                                ...
                                if(v.saf_no && v.saf_pending_status != 1)
                                {
                                    ...
                                    tbody += '<span class="text-danger" >Tran No <b>'+v?.tranVerificationPending?.tran_no+'</b> Is Not Clear By Account. Please Wait For Clarence</span>';
