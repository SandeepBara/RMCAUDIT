	...
	<div id="page-content">
		<div class="panel panel-bordered panel-dark">
			...
			<div class="panel-body">
				<form action="<?= base_url(); ?>/SafVerification/atc_missing_geotag" id="field_verification" method="get">
					<div class="row">
						<div class="col-sm-1">
			...
			if (!empty($leveldetails)) : ?>
				<div class="panel panel-bordered panel-dark">
					<div class="panel-heading" style="background-color: #64ab4d;">
						<h3 class="panel-title" style="color: white;"><b>Missing Application List</b></h3>
					</div>
					<div class="panel-body">
								...
								<div class="panel-body">
									...
									<div class="row">
										<div class="col-sm-4 col-xs-4 text-center">
												<a href="<?=base_url();?>/SafVerification/verificationUpload/<?= $value["saf_dtl_id"] ?>/<?= $value["level_pending_dtl_id"] ?>"><span class="btn btn-sm btn-info btn_wait_load">Click To Upload Geitagging</span></a>
										</div>
									</div>
								</div>
							</div>
