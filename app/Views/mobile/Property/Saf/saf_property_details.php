			...
			<div id="page-content">
													...
													<tbody>
													  ...
													  ?>
														<tr>
															...
															<td><a href="<?php echo base_url('mobisafDemandPayment/saf_payment_receipt/'.md5($payment_detail['id']));?>" type="button" id="customer_view_detail" class="btn btn-primary" style="color:white;">View</a></td>
														</tr>
													  <?php endforeach; ?>
													  <?php else: ?>
															<tr>
									...
									<div class="panel">
										<div class="panel-body text-center">
											...
											{
												?>
												<a href="<?php echo base_url('mobisafDemandPayment/saf_due_details/'.$id);?>" class="btn btn-primary btn-labeled">View Demand Details</a>
												<a href="<?php echo base_url('mobisafDemandPayment/saf_confirm_payment/'.$id);?>" class="btn btn-primary btn-labeled">Pay Property Tax</a>
												<?php 
											}
											
											if(empty($payment_detail_saf))
											{
												?>
												<a href="<?php echo base_url('mobisafDemandPayment/saf_payment_details/'.$id);?>" class="btn btn-primary btn-labeled">View Payment Details</a>
												<?php 
											}
											?>
