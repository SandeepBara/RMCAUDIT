			...
			if (!empty($posts)) : ?>
				<div class="panel panel-bordered panel-dark">
					<div class="panel-heading" style="background-color: #64ab4d;">
						<h3 class="panel-title" style="color: white;"><b>Notice List</b></h3>
					</div>
					<div class="panel-body">
						<?php foreach ($posts as  $value) : ?>
							<div class="panel panel-bordered panel-dark">
								...
								<div class="panel-body">
									...
									<div class="row">
										<div class="col-sm-2">
											<label for="exampleInputEmail1">Notice No.</label>
										</div>
										<div class="col-sm-2">
											<label for="exampleInputEmail1"><strong><?= $value["notice_no"] ?></strong></label>
										</div>
										<div class="col-sm-2">
											<label for="exampleInputEmail1">Holding No.</label>
										</div>
										<div class="col-sm-2">
											<label for="exampleInputEmail1"><strong><?php echo $value["holding_no"] ?></strong></label>
										</div>
									</div>
									<div class="row">
										<div class="col-sm-2">
									...
									<div class="row">
										...
										<div class="col-sm-2">
											<label><strong><?= $value["notice_date"] ?></strong></label>
										</div>
									</div>

									<div class="row">
										<div class="col-sm-4 col-xs-4 text-center">
												<a href="<?=base_url('propDtl/noticeDtl/'.$value["id"]); ?>"><span class="btn btn-sm btn-info btn_wait_load">Click To Served</span></a>
										</div>
									</div>
								</div>
							</div>
