				...
				<div id="page-content">
									...
									<div class="panel">
										<div class="panel-body text-center">
											...
											<a href="<?php echo base_url('mobi/property_details/'.$id);?>" type="button" class="btn btn-warning btn-labeled" id="prop_details" name="prop_details">View Property Details</a>
										</div>
									</div>
