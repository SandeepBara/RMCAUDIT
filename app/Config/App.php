...
class App extends BaseConfig
{
	...
	*/
	...
	//public $ark_root  = "http://".$_SERVER['HTTP_HOST'].str_replace(basename($_SERVER['SCRIPT_NAME']),"",$_SERVER['SCRIPT_NAME']);

	//public $baseURL = 'http://smartulb.co.in/RMCDMC';
	...
	*/
	...
	public $sessionTimeToUpdate      = 500;
	public $sessionRegenerateDestroy = false;

	//public $sessionDBGroup 			 = 'db_system';
	...
	public $sessionMatchIP           = false;
	public $sessionTimeToUpdate      = 288;
	public $sessionRegenerateDestroy = false;*/
