...
class WaterUnderSiteInspectionReport extends AlphaController
{   
    protected $db;
    protected $dbSystem;
    protected $ulb_id;
    ...
    {   
        ...
        {   
            ...
            $data['under_inspection_list']=$this->water_report_model->underSiteInspection($where);
        ...
        {    
             ...
             $data['date_upto']=isset($inputs['date_upto'])?$inputs['date_upto']:date('Y-m-d');
             $data['ward_id']='';
             $data['under_inspection_list']=null;
             
        }

      
        return view('water/report/under_inspection_details_report',$data);
