...
class WaterBacktoCitizenListReport extends AlphaController
{
    protected $db;
    protected $dbSystem;
    protected $ulb_id;
    ...
    public function index()
    {
        ...
        if($this->request->getMethod()=='post')
        {
            ...
            $data['backtocitizen_list']=$this->water_report_model->backtocitizenListReport($where);
        ...
        //print_var($data['backtocitizen_list']);
        return view('water/report/backtocitizen_list_report', $data);
