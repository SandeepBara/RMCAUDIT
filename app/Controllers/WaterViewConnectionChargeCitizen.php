...
class WaterViewConnectionChargeCitizen extends HomeController
{
    protected $db;
    ...
    public function fee_charge($water_conn_id)
    {
        ...
        //print_r($get_rate_id);
         ...
         //print_var($data['conn_fee_charge']);die;
        ...
        //  $data['conn_fee_charge']["amount"] += $data['other_penalty'];
         $data['conn_fee_charge']["penalty"] = ($data['conn_fee_charge']["penalty"]??0)+$data['other_penalty'];
         $data['conn_fee_charge']["amount"] =  ($data['conn_fee_charge']["amount"]??0)+$data['other_penalty'];
        // print_r($data);
        ...
        //print_r($data['conn_fee_charge_details']);die;
