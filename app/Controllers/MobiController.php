...
class MobiController extends Controller
{
	...
	public function __construct(){
		...
		$controller_arr = ['Login', 'Prop_report', 'AllModuleDCBReport', 'Dashboard', 'test', 'AllModuleCollection', 'AllmoduleCollectionSummary_TCwise', 'MiniDashboard', 'water_report', 'WaterConsumerWiseDCBReport', 'Trade_report'];		$cr_date = strtotime(date('d-m-Y'));
