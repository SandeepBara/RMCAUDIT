                    ...
                    if (isset($field_mstr_id))
                    {
                        ...
                        for ($i = 1; $i < $ctr; $i++)
                        {
                            ...
                            $insertfloor = [
                                ...
                                'date_from' => $inputs["completion_date" . $i],
                                'date_upto' => $date_upto,
                        ...
                        if ($updatelevelpending = $this->model_level_pending_dtl->updatelevelpendingById($leveldata))
                        {
                            ...
                            if ($insrtlevelpending = $this->model_level_pending_dtl->insrtlevelpendingdtl($leveldata))
                            {
                                ...
                                else
                                {
                                    ...
                                    {
                                        return $this->response->redirect(base_url('SafVerification/verificationUpload/' . $id . '/' . $levelid));
                                    }
