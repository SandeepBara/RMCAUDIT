...
class WaterRejectedListReport extends AlphaController
{   
    protected $db;
    protected $dbSystem;
    protected $ulb_id;
    ...
    {   
        ...
        {   
            ...
            $data['rejected_list']=$this->water_report_model->rejectedListReport($where);
        ...
        return view('water/report/rejected_list_report',$data);
