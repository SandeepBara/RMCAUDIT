...
class CollectionModuleModeWise extends AlphaController
{
    protected $db;
    protected $dbSystem;
    protected $trade;
        ...
        if($this->request->getMethod()=='post')
        {
            ...
            if($data['module']=="PROPERTY"){
                    ...
                    if($data['tran_mode_mstr_id']!=""){
                        $data['transactionList'] = $this->model_transaction->getModeWiseCollectionByOneMode($data);
                    }else{
                        $data['transactionList'] = $this->model_transaction->getModeWiseCollectionForAll($data);
                    }
                   ...
                   return view('report/collection_module_mode_wise',$data);
