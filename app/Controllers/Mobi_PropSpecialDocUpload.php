...
class Mobi_PropSpecialDocUpload extends MobiController
{
    protected $db;
    protected $dbSystem;
    ...
    public function Mobi_PropSpecialDocUpload($prop_dtl_id = null)
    {
        $_SESSION['heading_title'] = 'Consession Category Details Update';
        ...
        if ($this->request->getMethod() == 'post') {
            ...
            echo $gender_status = $this->request->getvar('gender_status');
            echo $dob_status = $this->request->getvar('dob_status');
            echo $handicapped_status = $this->request->getvar('handicapped_status');
            echo $armed_status = $this->request->getvar('armed_status');
            // die;
        ...
        //   print_var($data);
        //   return;
        return view('property/mobi_prop_special_doc_update2', $data);
    }
