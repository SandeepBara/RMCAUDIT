...
class WaterWardWiseCollectionReport extends AlphaController
{   
    protected $db;
    protected $dbSystem;
    protected $ulb_id;
    ...
    {   
        ...
        {   
            ...
            if($data['ward_id']!="")
            {
            	$where=" transaction_date between '".$data['date_from']."' and '".$data['date_upto']."' and ward_mstr_id=".$data['ward_id'];
                $data['ward_wise_collection']=$this->water_report_model->wardWiseCollection($where, "right");
            }
            else
            {
            	$where=" transaction_date between '".$data['date_from']."' and '".$data['date_upto']."'";
                $data['ward_wise_collection']=$this->water_report_model->wardWiseCollection($where, "right");
            }
        ...
        return view('water/report/ward_wise_collection_report', $data);
