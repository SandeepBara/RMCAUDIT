            ...
            <div class="col-sm-12">
                <div class="panel panel-bordered panel-dark">
                    ...
                    <div class="panel-body">
                        <div class ="row">
                            <div class="col-md-12">
                                <form class="" method="post" action="<?php echo base_url('propDtl/search');?>">
                            ...
                            <table class="table table-striped table-bordered text-sm">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><a href="<?=base_url();?>/propDtl/full/<?=md5($list['id']);?>"><i class="fa fa-street-view" style="font-size: 22px"></i></a></td>
                                    </tr>
                                <?php
                                }
                                ?>
