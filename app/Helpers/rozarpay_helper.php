...
if(!function_exists('rozarpayGenerateOrderId'))
{
	function rozarpayGenerateOrderId($input)
	{
...
if(!function_exists('includeRazorLibrary'))
{
function includeRazorLibrary()
{
	include(APPPATH.'/Views/razor_php/razor/vendor/autoload.php');
	//echo APPPATH.'/Views/razor_php/razor/vendor/autoload.php';
}
}
