(function() {
    ...
    var Ha = !1,
        ...
        Fa = t ? "Impact, Charcoal, sans-serif" :
        "Arial",
        za = {
    ...
    w = Pa.Chart = function() {
        ...
        l.prototype.renderElements = function() {
            ...
            if ("normal" ===
                this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) E.render(this.axisX, this.axisX2, this.axisY, this.axisY2, this.plotInfo.axisPlacement);
            ...
            if (0 < c.length) r.disableToolTip = !0, r._animator.animate(200, r.animationDuration, function(a) {
                ...
                if (r._breaksCanvas)
                    if (t) r.plotArea.ctx.drawImage(r._breaksCanvas, 0, 0, this.width, this.height);
                        ...
                        for (h = 0; h < r._axes.length; h++) r._axes[h].createMask();
        ...
        l.prototype.calculateAutoBreaks = function() {
            ...
            function d(a) {
                if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                    ...
                    if (b || c)
                        for (var d = a.axisY.dataInfo, f = a.axisX.dataInfo, g, h = f.min, n = f.max, m = d.min, r = d.max, f = f._dataRanges, d = d._dataRanges, p, q = 0, A = 0; A < a.dataSeriesIndexes.length; A++) {
                            ...
                            if (!(4 > k.dataPoints.length))
                                for (q = 0; q < k.dataPoints.length; q++)
                                    if (b && (p = (n + 1 - h) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100, g = k.dataPoints[q].x.getTime ? k.dataPoints[q].x.getTime() : k.dataPoints[q].x, p = Math.floor((g - h) / p), g < f[p].min && (f[p].min = g), g > f[p].max && (f[p].max = g)), c) {
                                        ...
                                        if ((g = "waterfall" === a.type ? k.dataPointEOs[q].cumulativeSum : k.dataPoints[q].y) && g.length)
                                            for (var t = 0; t < g.length; t++) p =
                                                Math.floor((g[t] - m) / l), g[t] < d[p].min && (d[p].min = g[t]), g[t] > d[p].max && (d[p].max = g[t]);
            ...
            function c(a) {
                if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length) && a.axisX.scaleBreaks && a.axisX.scaleBreaks.autoCalculate && 1 <= a.axisX.scaleBreaks.maxNumberOfAutoBreaks)
                    for (var b = a.axisX.dataInfo, c = b.min, d = b.max, f = b._dataRanges, g, h = 0, n = 0; n < a.dataSeriesIndexes.length; n++) {
        ...
        l.prototype._mouseEventHandler = function(a) {
            ...
            if (this.interactivityEnabled)
                ...
                else if (a.preventManipulation && a.preventManipulation(), a.preventDefault && a.preventDefault(), Ha && window.console && (window.console.log(c + " --\x3e x: " + d.x + "; y:" + d.y), e && window.console.log(a.which), "mouseup" === c && window.console.log("mouseup")), !e) {
        ...
        l.prototype.validateRegion = function(a, d, c, b, e) {
            ...
            for (n = 0; n < h.length; n++) {
                ...
                if (isFinite(q.dataInfo.minDiff))
                    if (C = q.getApparentDifference(p, g, null, !0), !(f || !(this.panEnabled && q.scaleBreaks && q.scaleBreaks._appliedBreaks.length) && (q.logarithmic && C < Math.pow(q.dataInfo.minDiff, 3) || !q.logarithmic && C < 3 * Math.abs(q.dataInfo.minDiff)) || p < q.minimum || g > q.maximum)) A.push(q), r.push({
                        val1: p,
                        val2: g
                    }), m = !0;
                    else if (!e) {
        ...
        l.prototype.renderIndexLabels = function(a) {
            ...
            for (a = 0; a < this._indexLabels.length; a++) {
                var h = this._indexLabels[a],
                    ...
                    q, p, m = la("indexLabelFontColor", h.dataPoint, h.dataSeries),
                ...
                for (var f = [], n, m = 0; m < a.dataSeriesIndexes.length; m++) {
                    ...
                    if (0 < r.length) {
                        for (var D = !1, u = 0; u < r.length; u++)
                            if (x = r[u].x.getTime ? r[u].x.getTime() : r[u].x, !(x < a.axisX.dataInfo.viewPortMin || x > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !D)))
                                if ("number" !== typeof r[u].y) 0 < u && !(h.connectNullData || D || l) && (c.stroke(), t && b.stroke()), D = !0;
                                else {
        ...
        l.prototype.renderStepLine = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var f = [], n, m = 0; m < a.dataSeriesIndexes.length; m++) {
                    ...
                    b.lineWidth = 0 < h.lineThickness ? Math.max(h.lineThickness, 4) : 0;
                    var C = h._colorSet,
                        k = C = h.lineColor = h.options.lineColor ? h.options.lineColor :
                        C[0];
                    c.strokeStyle = C;
                    var l = !0,
                        u = 0,
                    ...
                    if (0 < r.length) {
                        for (var D = !1, u = 0; u < r.length; u++)
                            if (x = r[u].getTime ? r[u].x.getTime() : r[u].x, !(x < a.axisX.dataInfo.viewPortMin || x > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !D)))
                                if ("number" !== typeof r[u].y) 0 < u && !(h.connectNullData || D || l) && (c.stroke(), t && b.stroke()), D = !0;
                                else {
                                    var y = s;
                                    x = a.axisX.convertValueToPixel(x);
                    ...
                    if (0 < r.length)
                        for (s = !1, l = 0; l < r.length; l++)
                            if (u = r[l].getTime ? r[l].x.getTime() : r[l].x,
                                !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !s)))
                                if ("number" !== typeof r[l].y) 0 < l && !s && (h.connectNullData ? b.setLineDash && (0 < z.length && (h.options.nullDataLineDashType || !r[l - 1].lineDashType)) && (z[z.length - 1].newLineDashArray = p, q = h.nullDataLineDashType) : (d(z), z = [])), s = !0;
                                else {
        ...
        l.prototype.renderColumn = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null,
                    e = this.plotArea,
                    f = 0,
                    n, m, A, h = a.axisY.convertValueToPixel(a.axisY.logarithmic ?
                ...
                for (r = 0; r < a.dataSeriesIndexes.length; r++) {
                    var p = a.dataSeriesIndexes[r],
                        ...
                        C = g.dataPoints;
                    if (0 < C.length)
                        for (var k = 5 < q && g.bevelEnabled ? !0 : !1, f = 0; f < C.length; f++)
                ...
                for (var C = 0; C < a.dataSeriesIndexes.length; C++) {
                    ...
                    if (0 < u.length) {
                        ...
                        for (h = 0; h < u.length; h++)
                            if (b = u[h].x.getTime ? u[h].x.getTime() : u[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) &&
                                "number" === typeof u[h].y) {
                                r = a.axisX.convertValueToPixel(b);
                                var z = r - a.plotType.plotUnits.length * g / 2 + a.index * g << 0,
                                    D = z + g << 0,
                                    y;
                                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[h].y) m[b] = u[h].y + (m[b] ? m[b] : 0), 0 < m[b] && (q = a.axisY.convertValueToPixel(m[b]), y = "undefined" !== typeof f[b] ? f[b] : p, f[b] = q);
                                else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[h].y) A[b] = u[h].y + (A[b] ? A[b] : 0), y = a.axisY.convertValueToPixel(A[b]), q = "undefined" !== typeof n[b] ?
                                    n[b] : p, n[b] = y;
                                else if (q = a.axisY.convertValueToPixel(u[h].y), 0 <= u[h].y) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var C = 0; C < a.dataSeriesIndexes.length; C++) {
                    var k = a.dataSeriesIndexes[C],
                        ...
                        u = l.dataPoints;
                    if (0 < u.length)
                        for (var s = 5 < g && l.bevelEnabled ? !0 : !1, h = 0; h < u.length; h++)
        ...
        l.prototype.renderBar = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null,
                    e = this.plotArea,
                    f = 0,
                    n, m, A, h = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
                    f = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1,
                    ...
                    if (0 < u.length) {
                        ...
                        for (h = 0; h < u.length; h++)
                            if (b = u[h].x.getTime ? u[h].x.getTime() : u[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[h].y) {
                                ...
                                else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[h].y) A[b] = u[h].y + (A[b] ? A[b] : 0), r = n[b] ? n[b] : p, n[b] = y = a.axisY.convertValueToPixel(A[b]);
                                else if (r = a.axisY.convertValueToPixel(u[h].y), 0 <= u[h].y) {
                                    var B = f[b] ? f[b] : 0;
                                    y = p + B;
                                    r += B;
                                    f[b] = B + (r - y)
                        ...
                        for (h = 0; h < u.length; h++)
                            if (b = u[h].x.getTime ? u[h].x.getTime() : u[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[h].y) {
                                ...
                                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[h].y) {
                                    ...
                                    0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[h].y) A[b] = z + (A[b] ? A[b] : 0), r = n[b] ? n[b] : p, n[b] = z = a.axisY.convertValueToPixel(A[b]);
                ...
                for (var q = 0; q < a.dataSeriesIndexes.length; q++) {
                    ...
                    if (0 < C.length) {
                        ...
                        for (var ka = !0; k < C.length; k++)
                            if (s = C[k].x.getTime ? C[k].x.getTime() : C[k].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !ka)))
                                if ("number" !== typeof C[k].y) g.connectNullData || (ka || d) || b(), ka = !0;
                                else {
        ...
        l.prototype.renderSplineArea = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var A = 0; A < a.dataSeriesIndexes.length; A++) {
                    ...
                    var n = [],
                        p = 0,
                        g, C, k = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum :
                            0),
                        l, u = null,
                        s = [];
                    if (0 < q.length) {
                        ...
                        for (C = !1; p < q.length; p++)
                            if (g = q[p].x.getTime ? q[p].x.getTime() : q[p].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax && (!r.connectNullData || !C)))
        ...
        l.prototype.renderStackedArea = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null,
                    ...
                    q = [],
                    p = 0,
                    g, k, l = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
                    ...
                    if (0 < r.length) {
                        ...
                        for (var Z = !0, p = 0; p < r.length; p++) {
                            ...
                            if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!B.connectNullData || !Z)))
                                if ("number" !== typeof ga.y) B.connectNullData || (Z || x) || d(), Z = !0;
                                else {
        ...
        l.prototype.renderStackedArea100 = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null,
                    ...
                    q = [],
                    p = 0,
                    g, l, s, da, u, x = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
        ...
        l.prototype.renderBubble = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var m = -Infinity, k = Infinity, h = 0; h < a.dataSeriesIndexes.length; h++)
                    for (var r = a.dataSeriesIndexes[h], q = this.data[r], p = q.dataPoints,
                ...
                for (var l = 25 * Math.PI, s = Math.max(Math.pow(0.25 * Math.min(b.height, b.width) / 2, 2) * Math.PI, l), h = 0; h < a.dataSeriesIndexes.length; h++)
                    if (r = a.dataSeriesIndexes[h], q = this.data[r], p = q.dataPoints, 0 < p.length)
        ...
        l.prototype.renderCandlestick = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null,
                    ...
                    n = this.plotArea,
                    m = 0,
                    k, h, r, q, p, g, e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1,
                ...
                for (var fa = 0; fa < a.dataSeriesIndexes.length; fa++) {
                    ...
                    if (0 < x.length)
                        for (var z = 5 < l && u.bevelEnabled ? !0 : !1, m = 0; m < x.length; m++)
                            if (x[m].getTime ? g = x[m].x.getTime() : g = x[m].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !s(x[m].y) && x[m].y.length && "number" === typeof x[m].y[0] &&
        ...
        l.prototype.renderBoxAndWhisker = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null,
                    f = this.plotArea,
                    n = 0,
                    m, k, h, r, q, p, g, e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1,
                        ...
                        for (var v = 5 < l && x.bevelEnabled ? !0 : !1, n = 0; n < z.length; n++)
                            if (z[n].getTime ? g = z[n].x.getTime() : g = z[n].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !s(z[n].y) && z[n].y.length && "number" === typeof z[n].y[0] && "number" === typeof z[n].y[1] && "number" === typeof z[n].y[2] && "number" === typeof z[n].y[3] && "number" === typeof z[n].y[4] && 5 === z[n].y.length) {
                                ...
                                var y = m - l / 2 << 0,
                                    ...
                                    J = z[n].stemDashType ? z[n].stemDashType :
                                    x.stemDashType,
        ...
        l.prototype.renderRangeColumn = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var r = 0; r < a.dataSeriesIndexes.length; r++) {
                    ...
                    if (0 < g.length)
                        for (var l =
                                5 < h && p.bevelEnabled ? !0 : !1, f = 0; f < g.length; f++)
            ...
            function(a) {
                ...
                if (!(0 >= a.dataSeriesIndexes.length)) {
                    var e = null,
                        ...
                        n = this.plotArea,
                        m = 0,
                        k, h, r, q, p, g, l, fa = a.axisX.dataInfo.minDiff;
                    ...
                    for (var x = 0; x < a.dataSeriesIndexes.length; x++) {
                        var z = a.dataSeriesIndexes[x],
                            ...
                            E = 0;
                        if (B)
                            for (e = D._linkedSeries.id, u = 0; u < e; u++) !this.data[u].type.match(/(bar|column)/ig) ||
        ...
        l.prototype.renderRangeBar = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null,
                    e = this.plotArea,
                    f = 0,
                    n, m, k, h, f = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
                    ...
                    if (0 < q.length) {
                        ...
                        for (var T = !0; g <
                            q.length; g++)
                            if (u = q[g].x.getTime ? q[g].x.getTime() : q[g].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!r.connectNullData || !T)))
                ...
                for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
                    ...
                    if (0 < r.length) {
                        ...
                        for (g = !1; q < r.length; q++)
                            if (p = r[q].x.getTime ? r[q].x.getTime() : r[q].x, !(p < a.axisX.dataInfo.viewPortMin || p > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !g)))
        ...
        l.prototype.renderWaterfall = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = this._eventManager.ghostCtx,
                    ...
                    f = this.plotArea,
                    n = 0,
                    m, k, h, r, q = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
                ...
                for (var g = 0; g < a.dataSeriesIndexes.length; g++) {
                    ...
                    if (0 < v.length)
                        for (var z = 5 < p && s.bevelEnabled ? !0 : !1, D = !1, y = null, B = null, n = 0; n < v.length; n++)
            ...
            function f(a, c, d) {
                ...
                if (0 <= a && a < r.length) {
                    ...
                    for (n = 1; n < r.length; n++)
                        ...
                        g[m].hemisphere === g[a].hemisphere && m !== a && (0 > b(g[m], g[a]) || ("right" === g[a].hemisphere ? g[m].indexLabelTextBlock.y <= g[a].indexLabelTextBlock.y : g[m].indexLabelTextBlock.y >= g[a].indexLabelTextBlock.y))) break;
                    else m = null;
                    q = m;
                    p = e(a);
                    n = m = 0;
            ...
            function n() {
                ...
                for (var c = a = 0, d = 0, m = !0, c = 0; 10 > c && (1 > c || 0 < d); c++) {
                    ...
                    if ("inside" !== h.indexLabelPlacement) {
                        ...
                        for (a = 0; a < r.length; a++) n = g[a], t = "pie" === h.type ? 0.7 * B : 0.8 * B, y = z.x + t * Math.cos(n.midAngle), s = z.y + t * Math.sin(n.midAngle), n.indexLabelTextBlock.x = y, n.indexLabelTextBlock.y = s;
                    for (a = 0; a < r.length; a++)
                        if (n = g[a], y = n.indexLabelTextBlock.measureText(), 0 !== y.height && 0 !== y.width) y = y = 0, "right" === n.hemisphere ? (y = p.x2 - (n.indexLabelTextBlock.x + n.indexLabelTextBlock.width +
        ...
        l.prototype.renderFunnel = function(a) {
            ...
            function e() {
                ...
                if (e)
                    for (m = H.length - 1; 0 <= m; m--) a = O[m], H[m].textBlock.maxWidth =
            ...
            function f() {
                ...
                if ("inside" !== u.indexLabelPlacement)
                    for (var e = 0; e < O.length; e++) 0 == H[e].textBlock.text.length ? H[e].isDirty = !0 : (a = O[e], c = "undefined" !== typeof a.x5 ? (a.y2 + a.y4) / 2 : (a.y2 + a.y3) / 2, b = u.reversed ? "undefined" !== typeof a.x5 ? c > xa ? g(c).x2 + 1 : (a.x2 + a.x3) / 2 + 1 : (a.x2 + a.x3) / 2 + 1 : "undefined" !== typeof a.x5 ? c < xa ? g(c).x2 + 1 : (a.x4 + a.x3) / 2 + 1 : (a.x2 + a.x3) / 2 + 1, H[e].textBlock.x = b + V, H[e].textBlock.y =
                        c - H[e].height / 2, u.reversed ? (H[e].textBlock.y + H[e].height > na + D && (H[e].textBlock.y = na + D - H[e].height), H[e].textBlock.y < sa - D && (H[e].textBlock.y = sa - D)) : (H[e].textBlock.y < na - D && (H[e].textBlock.y = na - D), H[e].textBlock.y + H[e].height > sa + D && (H[e].textBlock.y = sa + D - H[e].height)));
                else
                    for (e = 0; e < O.length; e++) 0 == H[e].textBlock.text.length ? H[e].isDirty = !0 : (a = O[e], b = a.height, c = H[e].height, d = H[e].width, b >= c ? (b = e != ba ? (a.x4 + a.x3) / 2 - d / 2 : (a.x5 + a.x4) / 2 - d / 2, c = e != ba ? (a.y1 + a.y3) / 2 - c / 2 : (a.y1 + a.y4) / 2 - c / 2, H[e].textBlock.x = b,
            ...
            function n() {
                ...
                function c(a, b, d) {
                    ...
                    for (d = 0; d < e.length; d++)
                        if (b = e[d], f < a) g++, f += H[b.id].height + ca, H[b.id].textBlock.text = "", H[b.id].indexLabelText = "", H[b.id].isDirty = !0, H[b.id].textBlock.measureText();
                        else break;
                    return g
                }
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                for (var u = this.data[a.dataSeriesIndexes[0]], x = u.dataPoints, z = this.plotArea, D = 0.025 * z.width, y = 0.01 * z.width, B = 0, E = z.height - 2 * D, F = Math.min(z.width - 2 * y, 2.8 * z.height), I = !1, S = 0; S < x.length; S++)
                    if (!I && ("undefined" !== typeof x[S].indexLabel && null !== x[S].indexLabel &&
                ...
                if (0 != u.length && (u.dataPoints &&
                    ...
                    if (-1 !== S) {
                        if (u.reversed)
                            for (F.push(U), G = S.length - 1; 0 < G; G--) U += S[G], F.push(U);
                        else
                            for (G = 0; G < S.length; G++) U += S[G], F.push(U);
                        if (u.reversed)
                            for (G = 0; G < S.length; G++) F[G] < xa ? (a.push(K), y.push(W), ba = G) : (a.push((F[G] - na + aa * X) / aa), y.push((F[G] - na + ea * $) / ea));
                        else
                            for (G = 0; G < S.length; G++) F[G] < xa ? (a.push((F[G] - na + aa * X) / aa), y.push((F[G] - na + ea * $) / ea), ba = G) : (a.push(K), y.push(W));
                        ...
                        if (!I)
                            for (G = 0; G < x.length; G++) B = u.dataPointIds[G], a = {
                                id: B,
                                objectType: "dataPoint",
                                dataPointIndex: G,
                                dataSeriesIndex: 0,
                                ...
                                if (s(this.options.labelAngle) && isNaN(this.options.labelAngle) && 0 !== this.options.labelAngle)
                                    if (this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? n : Math.min((b - f * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)), b), l = (h - (k + a.fontSize / 2) * Math.cos(Math.PI / 180 * Math.abs(-25))) / Math.sin(Math.PI / 180 * Math.abs(-25)), !s(this.options.labelWrap)) this.labelWrap ? s(this.options.labelMaxWidth) ?
                                        ...
                                        if (s(this.options.labelWrap))
                                            ...
                                            if (b = C.width + d.width >> 0, g = this.labelFontSize, p < f) b - 2 * f > q && (q = b - 2 * f, b >= 2 * f && b < 2.2 * f ? (this.sessionVariables.labelMaxWidth = f, s(this.options.labelFontSize) && 12 < g && (g = Math.floor(12 / 13 * g), a.measureText()), this.sessionVariables.labelFontSize = s(this.options.labelFontSize) ?
                                                ...
                                                g : this.options.labelFontSize, this.sessionVariables.labelAngle = this.labelAngle) : b >= 3.2 * f && b < 3.6 * f ? (this.sessionVariables.labelAngle = -25, this.sessionVariables.labelWrap = !0, this.sessionVariables.labelMaxWidth = l, this.sessionVariables.labelFontSize = this.labelFontSize) : b > 3.6 * f && b < 5 * f ? (s(this.options.labelFontSize) && 12 < g && (g = Math.floor(12 / 13 * g), a.measureText()), this.sessionVariables.labelFontSize = s(this.options.labelFontSize) ? g : this.options.labelFontSize, this.sessionVariables.labelWrap = !0, this.sessionVariables.labelAngle = -25, this.sessionVariables.labelMaxWidth = l) : b > 5 * f && (this.sessionVariables.labelWrap = !0, this.sessionVariables.labelMaxWidth = f, this.sessionVariables.labelFontSize = g, this.sessionVariables.labelMaxHeight = n, this.sessionVariables.labelAngle = this.labelAngle));
                                                ...
                                                p + this._labels[v - 1].textBlock.measureText().width - 2 * f > q)) q = 0 === v ? p + this._labels[v + 1].textBlock.measureText().width - 2 * f : p + this._labels[v - 1].textBlock.measureText().width - 2 * f, this.sessionVariables.labelFontSize = s(this.options.labelFontSize) ? g : this.options.labelFontSize, this.sessionVariables.labelWrap = !0, this.sessionVariables.labelAngle = -25, this.sessionVariables.labelMaxWidth = l;
                                        else if (0 === q)
        ...
        E.setLayout = function(a, d, c, b, e, f) {
            var n, m, k, h, l = a[0] ? a[0].chart : d[0].chart,
            ...
            for (g = 0; g < p.length; g++)
                if (p[g] && p[g].scaleBreaks && p[g].scaleBreaks._appliedBreaks.length)
                    for (var t = p[g].scaleBreaks._appliedBreaks, v = 0; v < t.length && !(t[v].startValue > p[g].viewportMaximum); v++) t[v].endValue < p[g].viewportMinimum || (s(p[g].scaleBreaks.firstBreakIndex) && (p[g].scaleBreaks.firstBreakIndex =
            ...
            if ("normal" === e) {
                for (var x = [], z = [], D = [], y = [], M = [], N = [], P = [], Q = []; 4 > v;) {
                    var G = 0,
                        ...
                        aa = 0;
                    if (c && 0 < c.length)
                        for (D = [], g = O = 0; g < c.length; g++) D.push(Math.ceil(c[g] ? c[g].createLabelsAndCalculateWidth() : 0)), O += D[g], K += c[g] && !l.isNavigator ? c[g].margin : 0;
                    else D.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateWidth() : 0));
                    P.push(D);
                    if (b &&
                        0 < b.length)
                        for (y = [], g = aa = 0; g < b.length; g++) y.push(Math.ceil(b[g] ? b[g].createLabelsAndCalculateWidth() : 0)), aa += y[g], $ += b[g] ? b[g].margin : 0;
                    ...
                    if (a && 0 < a.length)
                        for (x = [], g = U = 0; g < a.length; g++) a[g] && (a[g].lineCoordinates = {}), a[g].lineCoordinates.width = Math.abs(k - n), a[g].title && (a[g]._titleTextBlock.maxWidth = 0 < a[g].titleMaxWidth && a[g].titleMaxWidth < a[g].lineCoordinates.width ?
                            a[g].titleMaxWidth : a[g].lineCoordinates.width), x.push(Math.ceil(a[g] ? a[g].createLabelsAndCalculateHeight() : 0)), U += x[g], e += a[g] && !l.isNavigator ? a[g].margin : 0;
                    else x.push(Math.ceil(a[0] ? a[0].createLabelsAndCalculateHeight() : 0));
                    M.push(x);
                    if (d && 0 < d.length)
                        for (z = [], g = W = 0; g < d.length; g++) d[g] && (d[g].lineCoordinates = {}), d[g].lineCoordinates.width = Math.abs(k - n), d[g].title && (d[g]._titleTextBlock.maxWidth = 0 < d[g].titleMaxWidth && d[g].titleMaxWidth < d[g].lineCoordinates.width ? d[g].titleMaxWidth : d[g].lineCoordinates.width),
                            z.push(Math.ceil(d[g] ? d[g].createLabelsAndCalculateHeight() : 0)), W += z[g], X += d[g] && !l.isNavigator ? d[g].margin : 0;
                    else z.push(Math.ceil(d[0] ? d[0].createLabelsAndCalculateHeight() : 0));
                    N.push(z);
                    if (a && 0 < a.length)
                        for (g = 0; g < a.length; g++) a[g] && (a[g].lineCoordinates.x1 = n, k = Math.round(f.x2 - aa - $ > l.width - q ? l.width - q : f.x2 - aa - $), a[g]._labels && 1 < a[g]._labels.length && (m = h = 0, h = a[g]._labels[1], m = "dateTime" === a[g].valueType ? a[g]._labels[a[g]._labels.length - 2] : a[g]._labels[a[g]._labels.length - 1], w = h.textBlock.width * Math.cos(Math.PI /
                    ...
                    if (d && 0 < d.length)
                        for (g = 0; g < d.length; g++) d[g].lineCoordinates.x1 = Math.round(f.x1 + O + K), d[g].lineCoordinates.x2 = Math.round(f.x2 - aa - $ > l.width - q ? l.width - q : f.x2 - aa - $), d[g].lineCoordinates.width = Math.abs(k - n), d[g]._labels && 1 < d[g]._labels.length && (h = d[g]._labels[1], m = "dateTime" === d[g].valueType ? d[g]._labels[d[g]._labels.length - 2] : d[g]._labels[d[g]._labels.length - 1], w = h.textBlock.width * Math.cos(Math.PI /
                    ...
                    if (c && 0 < c.length)
                        for (g = 0; g < c.length; g++) K = l.isNavigator ? 0 : 10, c[g] && (n = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1), K = c[g]._labels && 0 < c[g]._labels.length ? c[g]._labels[c[g]._labels.length - 1].textBlock.height / 2 : q, m = Math.round(f.y1 +
                    ...
                    if (b && 0 < b.length)
                        for (g = 0; g < b.length; g++) b[g] && (n = Math.round(a[0] ? a[0].lineCoordinates.x2 : d[0].lineCoordinates.x2), k = Math.round(n), K = b[g]._labels && 0 < b[g]._labels.length ? b[g]._labels[b[g]._labels.length - 1].textBlock.height /
                    ...
                    if (a && 0 < a.length)
                        for (g = 0; g < a.length; g++) a[g] && (a[g].calculateValueToPixelConversionParameters(), a[g].calculateBreaksSizeInValues(), a[g]._labels && 1 < a[g]._labels.length && (B = (a[g].logarithmic ? Math.log(a[g]._labels[1].position / a[g].viewportMinimum) / a[g].conversionParameters.lnLogarithmBase :
                    ...
                    if (0 < v) {
                        if (a && 0 < a.length)
                            for (g = 0; g < a.length; g++) t = M[v - 1][g] === M[v][g] ? !0 : !1;
                        else t = !0;
                        if (d && 0 < d.length)
                            for (g = 0; g < d.length; g++) I = N[v -
                                1][g] === N[v][g] ? !0 : !1;
                        else I = !0;
                        if (c && 0 < c.length)
                            for (g = 0; g < c.length; g++) J = P[v - 1][g] === P[v][g] ? !0 : !1;
                        else J = !0;
                        if (b && 0 < b.length)
                ...
                if (c && 0 < c.length)
                    for (g = 0; g < c.length; g++) c[g].calculateStripLinesThicknessInValues(),
                ...
                for (N = []; 4 > v;) {
                    ...
                    if (a && 0 < a.length)
                        for (F = [], g = Y = 0; g < a.length; g++) F.push(Math.ceil(a[g] ? a[g].createLabelsAndCalculateWidth() : 0)), Y += F[g], e += a[g] && !l.isNavigator ? a[g].margin : 0;
                    else F.push(Math.ceil(a[0] ? a[0].createLabelsAndCalculateWidth() : 0));
                    M.push(F);
                    if (d && 0 < d.length)
                        for (w = [], g = U = 0; g < d.length; g++) w.push(Math.ceil(d[g] ?
                    ...
                    if (b && 0 < b.length)
                        for (g = 0; g < b.length; g++) b[g].lineCoordinates = {}, n = Math.round(f.x1 + Y + e), k = Math.round(f.x2 - U - X > b[g].chart.width - 10 ? b[g].chart.width - 10 : f.x2 - U - X), b[g] && b[g].labelAutoFit && !s(D) && (0 < !a.length && (n = 0 < b[g].labelAngle ? Math.max(n, D) : 0 === b[g].labelAngle ? Math.max(n, D / 2) : n), 0 < !d.length && (k -= y / 2)),
                    ...
                    if (c && 0 < c.length)
                        for (q = [], g = V = 0; g < c.length; g++) q.push(Math.ceil(c[g] ? c[g].createLabelsAndCalculateHeight() : 0)), V += q[g] + c[g].margin, K += c[g].margin;
                    else q.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateHeight() : 0));
                    E.push(q);
                    if (b && 0 < b.length)
                        for (B = [],
                            g = R = 0; g < b.length; g++) B.push(Math.ceil(b[g] ? b[g].createLabelsAndCalculateHeight() : 0)), R += B[g], $ += b[g].margin;
                    else B.push(Math.ceil(b[0] ? b[0].createLabelsAndCalculateHeight() : 0));
                    u.push(B);
                    if (c && 0 < c.length)
                        for (g = 0; g < c.length; g++) 0 < c[g]._labels.length && (h = c[g]._labels[0], m = c[g]._labels[c[g]._labels.length - 1], x = h.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(h.textBlock.angle)) + (h.textBlock.height - m.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(h.textBlock.angle)), z = m.textBlock.width * Math.cos(Math.PI /
                            180 * Math.abs(m.textBlock.angle)) + (m.textBlock.height - m.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(m.textBlock.angle)));
                    if (b && 0 < b.length)
                        for (g = 0; g < b.length; g++) b[g] && 0 < b[g]._labels.length && (h = b[g]._labels[0], m = b[g]._labels[b[g]._labels.length - 1], D = h.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(h.textBlock.angle)) + (h.textBlock.height - m.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(h.textBlock.angle)), y = m.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(m.textBlock.angle)) + (m.textBlock.height -
                            m.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(m.textBlock.angle)));
                    if (l.panEnabled)
                        for (g = 0; g < c.length; g++) q[g] = s(l.sessionVariables.axisY.height) ? l.sessionVariables.axisY.height = q[g] : l.sessionVariables.axisY.height;
                    else
                        for (g = 0; g < c.length; g++) l.sessionVariables.axisY.height = q[g];
                    if (c && 0 < c.length)
                        for (g = c.length - 1; 0 <= g; g--) m = Math.round(f.y2), h = Math.round(f.y2 > c[g].chart.height ? c[g].chart.height : f.y2), c[g].lineCoordinates.y1 = m - (q[g] + c[g].margin + W), c[g].lineCoordinates.y2 = m - (q[g] + c[g].margin +
                            ...
                            W += q[g] + c[g].margin;
                    if (b && 0 < b.length)
                        for (g = b.length - 1; 0 <= g; g--) b[g] && (m = Math.round(f.y1), h = Math.round(f.y1 + (B[g] + b[g].margin + G)), b[g].lineCoordinates.y1 = h, b[g].lineCoordinates.y2 = h, "inside" === b[g].labelPlacement && 0 < g && (b[g].lineCoordinates.y1 = h - B[g] + (b[g]._titleTextBlock ? b[g]._titleTextBlock.height : 0)), b[g].bounds = {
                            x1: n,
                            y1: m + (b[g].margin + G),
                            x2: k,
                            y2: h,
                    ...
                    if (a && 0 < a.length)
                        for (g = 0; g < a.length; g++) {
                            ...
                            h = c && 0 < c.length ? Math.round(c[0] ? c[0].lineCoordinates.y1 : f.y2 - V > l.height - Math.max(K, 10) ? l.height - Math.max(K, 10) : f.y2 - V) : f.y2 > l.height - Math.max(K, 10) ? l.height -
                                Math.max(K, 10) : f.y2;
                            if (c && 0 < c.length)
                                for (K = 0; K < c.length; K++) c[K] && c[K].labelAutoFit && (k = 0 > c[K].labelAngle ? Math.max(k, x) : 0 === c[K].labelAngle ? Math.max(k, x / 2) : k, n = 0 > c[K].labelAngle || 0 === c[K].labelAngle ? k - Y : n);
                            if (b && 0 < b.length)
                                for (K = 0; K < b.length; K++) b[K] && b[K].labelAutoFit && (k = b[K].lineCoordinates.x1, n = k - Y);
                            a[g].lineCoordinates = {
                                x1: k - P,
                                y1: m,
                                x2: k - P,
                    ...
                    if (d && 0 < d.length)
                        for (g = 0; g < d.length; g++) {
                            ...
                            if (c && 0 < c.length)
                                for (K = 0; K < c.length; K++) c[K] && c[K].labelAutoFit && (k = 0 > c[K].labelAngle ?
                    ...
                    if (0 <
                        ...
                        if (b && 0 < b.length)
                            for (g = 0; g < b.length; g++) L = u[v - 1][g] === u[v][g] ? !0 : !1;
                        else L = !0
                    }
                    if (t && I && J && L) break;
                    v++
        ...
        E.render = function(a, d, c, b, e) {
            ...
            if (b && 0 < b.length)
                for (m = 0; m < b.length; m++) b[m].renderGrid(),
        ...
        E.prototype.renderLabelsTicksAndTitle = function() {
            ...
            if ("bottom" === this._position) {
                ...
                "inside" === this.tickPlacement && this.chart.addEventListener("dataAnimationEnd", function() {
                    for (h = 0; h < a._labels.length; h++)
                        if (q = a._labels[h], !(q.position < a.viewportMinimum || q.position > a.viewportMaximum) &&
                ...
                "inside" === this.tickPlacement && this.chart.addEventListener("dataAnimationEnd", function() {
                    for (h = 0; h < a._labels.length; h++)
                        if (q = a._labels[h], !(q.position < a.viewportMinimum ||
        ...
        E.prototype.renderInterlacedColors = function() {
            ...
            if (("bottom" === this._position || "top" === this._position) && this.interlacedColor)
                for (a.fillStyle = this.interlacedColor, e = 0; e < this._labels.length; e++) d ? (d = this.getPixelCoordinatesOnAxis(this._labels[e].position), c = e + 1 > this._labels.length - 1 ? this.getPixelCoordinatesOnAxis(this.viewportMaximum) :
                    this.getPixelCoordinatesOnAxis(this._labels[e + 1].position), a.fillRect(Math.min(c.x, d.x), b.y1, Math.abs(c.x - d.x), Math.abs(b.y1 - b.y2)), d = !1) : d = !0;
            else if (("left" === this._position || "right" === this._position) && this.interlacedColor)
                for (a.fillStyle = this.interlacedColor, e = 0; e < this._labels.length; e++) d ? (c = this.getPixelCoordinatesOnAxis(this._labels[e].position), d = e + 1 > this._labels.length - 1 ? this.getPixelCoordinatesOnAxis(this.viewportMaximum) : this.getPixelCoordinatesOnAxis(this._labels[e + 1].position), a.fillRect(b.x1,
            ...
            if (this.stripLines && 0 < this.stripLines.length && a) {
                ...
                for (b = 0; b < this._stripLineLabels.length; b++)
                    if (h = this.stripLines[b],
                        ...
                        else c.textBlock.angle = -90, "bottom" === this._position ? (c.textBlock.maxWidth =
        ...
        E.prototype.renderAxisLine = function() {
            ...
            if ("bottom" === this._position || "top" === this._position) {
                if (this.lineThickness) {
                    ...
                    if (this.scaleBreaks && !s(this.scaleBreaks.firstBreakIndex))
                        if (s(this.scaleBreaks.lastBreakIndex)) e = this.scaleBreaks._appliedBreaks[this.scaleBreaks.firstBreakIndex].endPixel + b;
                            ...
                            for (var m = this.scaleBreaks.firstBreakIndex; m <= this.scaleBreaks.lastBreakIndex; m++) d.moveTo(e, k), d.lineTo(this.scaleBreaks._appliedBreaks[m].startPixel + c, k), e = this.scaleBreaks._appliedBreaks[m].endPixel + b;
                ...
                d.beginPath();
                if (this.scaleBreaks && !s(this.scaleBreaks.firstBreakIndex))
                    if (s(this.scaleBreaks.lastBreakIndex)) e = this.scaleBreaks._appliedBreaks[this.scaleBreaks.firstBreakIndex].endPixel +
                        c;
                    else
        ...
        E.prototype.getApparentDifference = function(a, d, c, b) {
            ...
            if (this.logarithmic) {
                ...
                for (c = s(c) ? Math.abs(d - a) : c, f = 0; f < e.length && !(d < e[f].startValue); f++) a > e[f].endValue || (a <= e[f].startValue && d >= e[f].endValue ? c = c - e[f].endValue + e[f].startValue + e[f].size : a > e[f].startValue &&
        ...
        E.prototype.calculateValueToPixelConversionParameters = function(a) {
            ...
            if (this.logarithmic)
                for (var e = 0; e < a.length && !(this.viewportMaximum < a[e].startValue); e++) this.viewportMinimum > a[e].endValue || (this.viewportMinimum >= a[e].startValue && this.viewportMaximum <= a[e].endValue ? c = 0 : this.viewportMinimum <= a[e].startValue && this.viewportMaximum >= a[e].endValue ? (b = b / a[e].endValue * a[e].startValue, c = 0 < a[e].spacing.toString().indexOf("%") ? c * (1 - parseFloat(a[e].spacing) / 100) : c - Math.min(a[e].spacing, 0.1 * c)) : this.viewportMinimum > a[e].startValue && this.viewportMaximum >= a[e].endValue ? (b = b /
                    ...
                    100 * Math.log(this.viewportMaximum / a[e].startValue) / Math.log(a[e].endValue / a[e].startValue)) : c - Math.min(a[e].spacing, 0.1 * c) * Math.log(this.viewportMaximum / a[e].startValue) / Math.log(a[e].endValue / a[e].startValue)));
            else
                for (e = 0; e < a.length && !(this.viewportMaximum < a[e].startValue); e++) this.viewportMinimum > a[e].endValue || (this.viewportMinimum >= a[e].startValue && this.viewportMaximum <= a[e].endValue ? c = 0 : this.viewportMinimum <= a[e].startValue && this.viewportMaximum >= a[e].endValue ? (b = b - a[e].endValue + a[e].startValue,
        ...
        E.prototype.calculateAxisParameters = function() {
            if (this.logarithmic) this.calculateLogarithmicAxisParameters();
                ...
                else if (null === this.viewportMinimum || isNaN(this.viewportMinimum)) this.viewportMinimum =
                    this.minimum;
                ...
                if (this.scaleBreaks)
                    for (b = 0; b < this.scaleBreaks._appliedBreaks.length; b++)
                        if ((!s(this.sessionVariables.newViewportMinimum) && this.sessionVariables.newViewportMinimum >= this.scaleBreaks._appliedBreaks[b].startValue ||
        ...
        E.prototype.calculateLogarithmicAxisParameters = function() {
            ...
            if (this.scaleBreaks)
                for (k = 0; k < this.scaleBreaks._appliedBreaks.length; k++)
                    if ((!s(this.sessionVariables.newViewportMinimum) && this.sessionVariables.newViewportMinimum >=
        ...
        E.prototype.getLabelStartPoint = function() {
            ...
            if ("millisecond" !== this.intervalType)
                if ("second" ===
                    this.intervalType) 0 < a.getMilliseconds() && (a.setSeconds(a.getSeconds() + 1), a.setMilliseconds(0));
            ...
            if (0 !== this.spacing || 0 !== this.options.lineThickness && ("undefined" !== typeof this.options.lineThickness || 0 !== this.parent.lineThickness)) {
                ...
                if ("bottom" === this.scaleBreaks.parent._position || "top" === this.scaleBreaks.parent._position)
                    if (b = 1 === q % 2 ? (b.x << 0) + 0.5 : b.x << 0, k = 1 === q % 2 ? (e.x << 0) + 0.5 : e.x << 0, "top" === this.scaleBreaks.parent._position ? (e = this.chart.plotArea.y1, m = this.chart.plotArea.y2 + q / 2 + 0.5 << 0) : (e = this.chart.plotArea.y2, m = this.chart.plotArea.y1 - q / 2 + 0.5 << 0, a *= -1), this.bounds = {
                        ...
                        0 >= a || "bottom" === this.scaleBreaks.parent._position && 0 <= a) this.ctx.lineTo(b, m), this.ctx.lineTo(k, m), this.ctx.lineTo(k, e);
                    ...
                    if (e = 1 === q % 2 ? (e.y << 0) + 0.5 : e.y << 0, m = 1 === q % 2 ? (b.y << 0) + 0.5 : b.y << 0, "left" === this.scaleBreaks.parent._position ? (b = this.chart.plotArea.x1, k = this.chart.plotArea.x2 + q / 2 + 0.5 << 0) : (b = this.chart.plotArea.x2, k = this.chart.plotArea.x1 - q / 2 + 0.5 << 0, a *= -1), this.bounds = {
                            x1: b,
                            y1: e - q /
                                2,
                            x2: k,
        ...
        aa.prototype.render = function(a, d, c) {
            ...
            if (this.snapToDataPoint) {
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                    ...
                    else if ("left" === this.parent._position || "right" === this.parent._position) t =
                    ...
                    if ("rangeBar" === r[0].dataSeries.type || "error" === r[0].dataSeries.type)
                        for (var v = Math.abs(a - this.parent.convertValueToPixel(r[w].dataPoint.y[0])),
                                u = 0, t = 0; t < r.length; t++)
                        ...
                        for (var v = Math.abs(a - this.parent.convertValueToPixel(r[0].dataPoint.y)), D = z = u = 0, t = 0; t < r.length; t++)
                            if (r[t].dataPoint.y && r[t].dataPoint.y.length)
                                for (x = 0; x < r[t].dataPoint.y.length; x++) u = Math.abs(a - this.parent.convertValueToPixel(r[t].dataPoint.y[x])), u < v && (v = u, w = t);
                            else z += r[t].dataPoint.y,
                                D = r[t].dataPoint.x.getTime ? r[t].dataPoint.x.getTime() : r[t].dataPoint.x, D = 100 * (z / r[t].dataSeries.plotUnit.dataPointYSums[D]), u = Math.abs(a - this.parent.convertValueToPixel(D)), u < v && (v = u, w = t);
                    else
                        for (v = Math.abs(a - this.parent.convertValueToPixel(r[0].dataPoint.y)), t = w = u = 0; t < r.length; t++)
                            if (r[t].dataPoint.y && r[t].dataPoint.y.length)
                                for (x = 0; x < r[t].dataPoint.y.length; x++) u = Math.abs(a - this.parent.convertValueToPixel(r[t].dataPoint.y[x])), u < v && (v = u, w = t);
                            else u = Math.abs(a - this.parent.convertValueToPixel(r[t].dataPoint.y)),
                                u < v && (v = u, w = t);
                    x = r[w];
                    if ("bottom" === this.parent._position || "top" === this.parent._position) {
                        ...
                        if (this.parent.labels)
                            for (r =
                                Math.ceil(this.parent.interval), t = 0; t < this.parent.viewportMaximum; t += r)
                    ...
                    !s(this.parent.dataSeries) &&
                        0 < this.parent.dataSeries.length && (t = this.parent.dataSeries[0].axisX.convertPixelToValue({
                            x: a
                        }));
                    for (w = 0; w < this.parent.dataSeries.length; w++)(v = this.parent.dataSeries[w].getDataPointAtX(t, !0)) && 0 <= v.index && (v.dataSeries = this.parent.dataSeries[w], null !== v.dataPoint.y && r.push(v));
                    if (0 === r.length) return;
                    ...
                    if ("rangeColumn" === r[0].dataSeries.type || "rangeArea" === r[0].dataSeries.type || "error" === r[0].dataSeries.type || "rangeSplineArea" === r[0].dataSeries.type ||
                        "candlestick" === r[0].dataSeries.type || "ohlc" === r[0].dataSeries.type || "boxAndWhisker" === r[0].dataSeries.type)
                    ...
                    else if ("stackedColumn" === r[0].dataSeries.type || "stackedArea" ===
                        r[0].dataSeries.type)
                        ...
                        for (v = Math.abs(d - this.parent.convertValueToPixel(r[0].dataPoint.y)), t = u = 0; t < r.length; t++)
                            if (r[t].dataPoint.y &&
                                r[t].dataPoint.y.length)
                                for (x = 0; x < r[t].dataPoint.y.length; x++) u = Math.abs(d - this.parent.convertValueToPixel(r[t].dataPoint.y[x])), u < v && (v = u, w = t);
                            else u = Math.abs(d - this.parent.convertValueToPixel(r[t].dataPoint.y)), u < v && (v = u, w = t);
                    x = r[w];
                    b = 0;
